...
static DaoFuncItem dao__Funcs[] = 
{
  ...
  { dao__glClearDepth, "glClearDepth( depth: float )" },
  { dao__glClearIndex, "glClearIndex( c: float )" },
  { dao__glClearStencil, "glClearStencil( s: int )" },
  { dao__glClipPlane, "glClipPlane( plane: int, equation: array<float> )" },
  { dao__glColor3b, "glColor3b( red: int, green: int, blue: int )" },
  { dao__glColor3bv, "glColor3bv( v: array<int> )" },
  { dao__glColor3d, "glColor3d( red: float, green: float, blue: float )" },
  { dao__glColor3dv, "glColor3dv( v: array<float> )" },
  ...
  { dao__glColor4d, "glColor4d( red: float, green: float, blue: float, alpha: float )" },
  { dao__glColor4dv, "glColor4dv( v: array<float> )" },
  ...
  { dao__glDepthRange, "glDepthRange( zNear: float, zFar: float )" },
  ...
  { dao__glEvalCoord1d, "glEvalCoord1d( u: float )" },
  { dao__glEvalCoord1dv, "glEvalCoord1dv( u: array<float> )" },
  { dao__glEvalCoord1f, "glEvalCoord1f( u: float )" },
  { dao__glEvalCoord1fv, "glEvalCoord1fv( u: array<float> )" },
  { dao__glEvalCoord2d, "glEvalCoord2d( u: float, v: float )" },
  { dao__glEvalCoord2dv, "glEvalCoord2dv( u: array<float> )" },
  ...
  { dao__glFrustum, "glFrustum( left: float, right: float, bottom: float, top: float, zNear: float, zFar: float )" },
  ...
  { dao__glGetClipPlane, "glGetClipPlane( plane: int, equation: float )=>float" },
  ...
  { dao__glGetDoublev, "glGetDoublev( pname: int, params: float )=>float" },
  ...
  { dao__glGetMapdv, "glGetMapdv( target: int, query: int, v: float )=>float" },
  ...
  { dao__glGetTexGendv, "glGetTexGendv( coord: int, pname: int, params: float )=>float" },
  ...
  { dao__glIndexd, "glIndexd( c: float )" },
  { dao__glIndexdv, "glIndexdv( c: array<float> )" },
  ...
  { dao__glLoadMatrixd, "glLoadMatrixd( m: array<float> )" },
  { dao__glLoadMatrixf, "glLoadMatrixf( m: array<float> )" },
  { dao__glLoadName, "glLoadName( name: int )" },
  { dao__glLogicOp, "glLogicOp( opcode: int )" },
  { dao__glMap1d, "glMap1d( target: int, u1: float, u2: float, stride: int, order: int, points: array<float> )" },
  { dao__glMap1f, "glMap1f( target: int, u1: float, u2: float, stride: int, order: int, points: array<float> )" },
  { dao__glMap2d, "glMap2d( target: int, u1: float, u2: float, ustride: int, uorder: int, v1: float, v2: float, vstride: int, vorder: int, points: array<float> )" },
  ...
  { dao__glMapGrid1d, "glMapGrid1d( un: int, u1: float, u2: float )" },
  { dao__glMapGrid1f, "glMapGrid1f( un: int, u1: float, u2: float )" },
  { dao__glMapGrid2d, "glMapGrid2d( un: int, u1: float, u2: float, vn: int, v1: float, v2: float )" },
  ...
  { dao__glMultMatrixd, "glMultMatrixd( m: array<float> )" },
  ...
  { dao__glNormal3d, "glNormal3d( nx: float, ny: float, nz: float )" },
  { dao__glNormal3dv, "glNormal3dv( v: array<float> )" },
  ...
  { dao__glOrtho, "glOrtho( left: float, right: float, bottom: float, top: float, zNear: float, zFar: float )" },
  ...
  { dao__glRasterPos2d, "glRasterPos2d( x: float, y: float )" },
  { dao__glRasterPos2dv, "glRasterPos2dv( v: array<float> )" },
  ...
  { dao__glRasterPos3d, "glRasterPos3d( x: float, y: float, z: float )" },
  { dao__glRasterPos3dv, "glRasterPos3dv( v: array<float> )" },
  ...
  { dao__glRasterPos4d, "glRasterPos4d( x: float, y: float, z: float, w: float )" },
  { dao__glRasterPos4dv, "glRasterPos4dv( v: array<float> )" },
  ...
  { dao__glRectd, "glRectd( x1: float, y1: float, x2: float, y2: float )" },
  { dao__glRectdv, "glRectdv( v1: array<float>, v2: array<float> )" },
  ...
  { dao__glRotated, "glRotated( angle: float, x: float, y: float, z: float )" },
  { dao__glRotatef, "glRotatef( angle: float, x: float, y: float, z: float )" },
  { dao__glScaled, "glScaled( x: float, y: float, z: float )" },
  ...
  { dao__glTexCoord1d, "glTexCoord1d( s: float )" },
  { dao__glTexCoord1dv, "glTexCoord1dv( v: array<float> )" },
  ...
  { dao__glTexCoord2d, "glTexCoord2d( s: float, t: float )" },
  { dao__glTexCoord2dv, "glTexCoord2dv( v: array<float> )" },
  ...
  { dao__glTexCoord3d, "glTexCoord3d( s: float, t: float, r: float )" },
  { dao__glTexCoord3dv, "glTexCoord3dv( v: array<float> )" },
  ...
  { dao__glTexCoord4d, "glTexCoord4d( s: float, t: float, r: float, q: float )" },
  { dao__glTexCoord4dv, "glTexCoord4dv( v: array<float> )" },
  ...
  { dao__glTexGend, "glTexGend( coord: int, pname: int, param: float )" },
  { dao__glTexGendv, "glTexGendv( coord: int, pname: int, params: array<float> )" },
  ...
  { dao__glTranslated, "glTranslated( x: float, y: float, z: float )" },
  { dao__glTranslatef, "glTranslatef( x: float, y: float, z: float )" },
  { dao__glVertex2d, "glVertex2d( x: float, y: float )" },
  { dao__glVertex2dv, "glVertex2dv( v: array<float> )" },
  ...
  { dao__glVertex3d, "glVertex3d( x: float, y: float, z: float )" },
  { dao__glVertex3dv, "glVertex3dv( v: array<float> )" },
  ...
  { dao__glVertex4d, "glVertex4d( x: float, y: float, z: float, w: float )" },
  { dao__glVertex4dv, "glVertex4dv( v: array<float> )" },
  ...
  { dao__glLoadTransposeMatrixd, "glLoadTransposeMatrixd( m: array<float> )" },
  { dao__glMultTransposeMatrixf, "glMultTransposeMatrixf( m: array<float> )" },
  { dao__glMultTransposeMatrixd, "glMultTransposeMatrixd( m: array<float> )" },
  ...
  { dao__glMultiTexCoord1d, "glMultiTexCoord1d( target: int, s: float )" },
  { dao__glMultiTexCoord1dv, "glMultiTexCoord1dv( target: int, v: array<float> )" },
  ...
  { dao__glMultiTexCoord2d, "glMultiTexCoord2d( target: int, s: float, t: float )" },
  { dao__glMultiTexCoord2dv, "glMultiTexCoord2dv( target: int, v: array<float> )" },
  ...
  { dao__glMultiTexCoord3d, "glMultiTexCoord3d( target: int, s: float, t: float, r: float )" },
  { dao__glMultiTexCoord3dv, "glMultiTexCoord3dv( target: int, v: array<float> )" },
  ...
  { dao__glMultiTexCoord4d, "glMultiTexCoord4d( target: int, s: float, t: float, r: float, q: float )" },
  { dao__glMultiTexCoord4dv, "glMultiTexCoord4dv( target: int, v: array<float> )" },
  ...
  { dao__glFogCoordd, "glFogCoordd( coord: float )" },
  { dao__glFogCoorddv, "glFogCoorddv( coord: array<float> )" },
  ...
  { dao__glSecondaryColor3d, "glSecondaryColor3d( red: float, green: float, blue: float )" },
  { dao__glSecondaryColor3dv, "glSecondaryColor3dv( v: array<float> )" },
  ...
  { dao__glWindowPos2d, "glWindowPos2d( x: float, y: float )" },
  { dao__glWindowPos2dv, "glWindowPos2dv( v: array<float> )" },
  ...
  { dao__glWindowPos3d, "glWindowPos3d( x: float, y: float, z: float )" },
  { dao__glWindowPos3dv, "glWindowPos3dv( v: array<float> )" },
  ...
  { dao__glVertexAttrib1d, "glVertexAttrib1d( index: int, x: float )" },
  { dao__glVertexAttrib1dv, "glVertexAttrib1dv( index: int, v: array<float> )" },
  ...
  { dao__glVertexAttrib2d, "glVertexAttrib2d( index: int, x: float, y: float )" },
  { dao__glVertexAttrib2dv, "glVertexAttrib2dv( index: int, v: array<float> )" },
  ...
  { dao__glVertexAttrib3d, "glVertexAttrib3d( index: int, x: float, y: float, z: float )" },
  { dao__glVertexAttrib3dv, "glVertexAttrib3dv( index: int, v: array<float> )" },
  ...
  { dao__glVertexAttrib4d, "glVertexAttrib4d( index: int, x: float, y: float, z: float, w: float )" },
  { dao__glVertexAttrib4dv, "glVertexAttrib4dv( index: int, v: array<float> )" },
  ...
  { dao__glGetVertexAttribdv, "glGetVertexAttribdv( index: int, pname: int, params: float )=>float" },
...
static void dao__glAreTexturesResident( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const unsigned int* textures = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[1] );

  GLboolean _glAreTexturesResident = glAreTexturesResident( n, textures, residences );
  DaoArray_FromUInt32( (DaoArray*)_p[1] );
  DaoProcess_PutInteger( _proc, (dao_integer) _glAreTexturesResident );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glArrayElement( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glClearDepth( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double depth = (double) DaoValue_TryGetFloat( _p[0] );
...
static void dao__glClipPlane( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const double* equation = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
...
static void dao__glColor3bv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const signed char* v = (const signed char*) DaoArray_ToSInt8( (DaoArray*)_p[0] );

  glColor3bv( v );
  DaoArray_FromSInt8( (DaoArray*)_p[0] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glColor3d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double red = (double) DaoValue_TryGetFloat( _p[0] );
  double green = (double) DaoValue_TryGetFloat( _p[1] );
  double blue = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glColor3dv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const double* v = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[0] );

  glColor3dv( v );
  DaoArray_FromFloat64( (DaoArray*)_p[0] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glColor3f( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glColor3fv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const float* v = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[0] );
...
static void dao__glColor3iv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int* v = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[0] );
...
static void dao__glColor3sv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const short* v = (const short*) DaoArray_ToSInt16( (DaoArray*)_p[0] );

  glColor3sv( v );
  DaoArray_FromSInt16( (DaoArray*)_p[0] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glColor3ub( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glColor3ubv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const unsigned char* v = (const unsigned char*) DaoArray_ToUInt8( (DaoArray*)_p[0] );

  glColor3ubv( v );
  DaoArray_FromUInt8( (DaoArray*)_p[0] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glColor3ui( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glColor3uiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const unsigned int* v = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[0] );

  glColor3uiv( v );
  DaoArray_FromUInt32( (DaoArray*)_p[0] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glColor3us( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glColor3usv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const unsigned short* v = (const unsigned short*) DaoArray_ToUInt16( (DaoArray*)_p[0] );

  glColor3usv( v );
  DaoArray_FromUInt16( (DaoArray*)_p[0] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glColor4b( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glColor4d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double green = (double) DaoValue_TryGetFloat( _p[1] );
  double blue = (double) DaoValue_TryGetFloat( _p[2] );
  double alpha = (double) DaoValue_TryGetFloat( _p[3] );
...
static void dao__glColorTableParameterfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float* params = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
...
static void dao__glColorTableParameteriv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[1] );
  const int* params = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[2] );

  glColorTableParameteriv( target, pname, params );
  DaoArray_FromSInt32( (DaoArray*)_p[2] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glConvolutionFilter1D( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glDepthRange( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double zNear = (double) DaoValue_TryGetFloat( _p[0] );
  double zFar = (double) DaoValue_TryGetFloat( _p[1] );
...
static void dao__glEvalCoord1d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double u = (double) DaoValue_TryGetFloat( _p[0] );
...
static void dao__glEvalCoord1dv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const double* u = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[0] );
...
static void dao__glEvalCoord1fv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const float* u = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[0] );
...
{
  double u = (double) DaoValue_TryGetFloat( _p[0] );
  double v = (double) DaoValue_TryGetFloat( _p[1] );
...
static void dao__glFeedbackBuffer( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutFloat( _proc, (dao_float) buffer );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glFinish( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const float* params = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
...
{
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const int* params = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[1] );
...
static void dao__glFrustum( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double left = (double) DaoValue_TryGetFloat( _p[0] );
  double right = (double) DaoValue_TryGetFloat( _p[1] );
  double bottom = (double) DaoValue_TryGetFloat( _p[2] );
  double top = (double) DaoValue_TryGetFloat( _p[3] );
  double zNear = (double) DaoValue_TryGetFloat( _p[4] );
  double zFar = (double) DaoValue_TryGetFloat( _p[5] );
...
static void dao__glGenLists( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glGenLists );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGenTextures( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) textures );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetBooleanv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  unsigned int plane = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  double equation = (double) DaoValue_TryGetFloat( _p[1] );

  glGetClipPlane( plane, &equation );
  DaoProcess_PutFloat( _proc, (dao_float) equation );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetColorTable( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetColorTableParameterfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutFloat( _proc, (dao_float) params );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetColorTableParameteriv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) params );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetConvolutionFilter( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  double params = (double) DaoValue_TryGetFloat( _p[1] );
...
static void dao__glGetError( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glGetError );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetFloatv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetMapdv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double v = (double) DaoValue_TryGetFloat( _p[2] );

  glGetMapdv( target, query, &v );
  DaoProcess_PutFloat( _proc, (dao_float) v );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetMapfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetMapiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) v );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetMaterialfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetPixelMapfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutFloat( _proc, (dao_float) values );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetPixelMapuiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) values );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetPixelMapusv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetTexGendv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[1] );
  double params = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glIndexd( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double c = (double) DaoValue_TryGetFloat( _p[0] );
...
static void dao__glIndexdv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const double* c = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[0] );
...
static void dao__glIndexfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const float* c = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[0] );
...
static void dao__glIndexiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int* c = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[0] );
...
static void dao__glIndexsv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const short* c = (const short*) DaoArray_ToSInt16( (DaoArray*)_p[0] );
...
static void dao__glIndexubv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const unsigned char* c = (const unsigned char*) DaoArray_ToUInt8( (DaoArray*)_p[0] );
...
static void dao__glIsEnabled( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsEnabled );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glIsList( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsList );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glIsTexture( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsTexture );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glLightModelf( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glLoadMatrixd( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const double* m = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[0] );
...
static void dao__glLoadMatrixf( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const float* m = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[0] );
...
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  double u1 = (double) DaoValue_TryGetFloat( _p[1] );
  double u2 = (double) DaoValue_TryGetFloat( _p[2] );
  int stride = (int) DaoValue_TryGetInteger( _p[3] );
  int order = (int) DaoValue_TryGetInteger( _p[4] );
  const double* points = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[5] );
...
static void dao__glMap1f( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  int stride = (int) DaoValue_TryGetInteger( _p[3] );
  int order = (int) DaoValue_TryGetInteger( _p[4] );
  const float* points = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[5] );
...
static void dao__glMap2d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double v1 = (double) DaoValue_TryGetFloat( _p[5] );
  double v2 = (double) DaoValue_TryGetFloat( _p[6] );
  int vstride = (int) DaoValue_TryGetInteger( _p[7] );
  int vorder = (int) DaoValue_TryGetInteger( _p[8] );
  const double* points = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[9] );
...
static void dao__glMap2f( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  int vstride = (int) DaoValue_TryGetInteger( _p[7] );
  int vorder = (int) DaoValue_TryGetInteger( _p[8] );
  const float* points = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[9] );
...
static void dao__glMapGrid2d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double v1 = (double) DaoValue_TryGetFloat( _p[4] );
  double v2 = (double) DaoValue_TryGetFloat( _p[5] );
...
static void dao__glNormal3d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double nx = (double) DaoValue_TryGetFloat( _p[0] );
  double ny = (double) DaoValue_TryGetFloat( _p[1] );
  double nz = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glPixelMapfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float* values = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
...
static void dao__glPixelMapuiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int map = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  int mapsize = (int) DaoValue_TryGetInteger( _p[1] );
  const unsigned int* values = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[2] );

  glPixelMapuiv( map, mapsize, values );
  DaoArray_FromUInt32( (DaoArray*)_p[2] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glPixelMapusv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int map = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  int mapsize = (int) DaoValue_TryGetInteger( _p[1] );
  const unsigned short* values = (const unsigned short*) DaoArray_ToUInt16( (DaoArray*)_p[2] );
...
{
  int n = (int) DaoValue_TryGetInteger( _p[0] );
  const float* priorities = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
  const unsigned int* textures = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[1] );
...
static void dao__glRasterPos2d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double x = (double) DaoValue_TryGetFloat( _p[0] );
  double y = (double) DaoValue_TryGetFloat( _p[1] );
...
static void dao__glRasterPos3d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double x = (double) DaoValue_TryGetFloat( _p[0] );
  double y = (double) DaoValue_TryGetFloat( _p[1] );
  double z = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glRasterPos4d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double y = (double) DaoValue_TryGetFloat( _p[1] );
  double z = (double) DaoValue_TryGetFloat( _p[2] );
  double w = (double) DaoValue_TryGetFloat( _p[3] );
...
static void dao__glRectd( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double x1 = (double) DaoValue_TryGetFloat( _p[0] );
  double y1 = (double) DaoValue_TryGetFloat( _p[1] );
  double x2 = (double) DaoValue_TryGetFloat( _p[2] );
  double y2 = (double) DaoValue_TryGetFloat( _p[3] );
...
static void dao__glRectdv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const double* v2 = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
  const double* v1 = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[0] );
...
static void dao__glRectfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const float* v2 = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
  const float* v1 = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[0] );
...
static void dao__glRectiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const int* v2 = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[1] );
  const int* v1 = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[0] );
...
static void dao__glRectsv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const short* v2 = (const short*) DaoArray_ToSInt16( (DaoArray*)_p[1] );
  const short* v1 = (const short*) DaoArray_ToSInt16( (DaoArray*)_p[0] );

  glRectsv( v1, v2 );
  DaoArray_FromSInt16( (DaoArray*)_p[0] );
  DaoArray_FromSInt16( (DaoArray*)_p[1] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glRenderMode( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glRenderMode );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glResetHistogram( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glRotated( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double angle = (double) DaoValue_TryGetFloat( _p[0] );
  double x = (double) DaoValue_TryGetFloat( _p[1] );
  double y = (double) DaoValue_TryGetFloat( _p[2] );
  double z = (double) DaoValue_TryGetFloat( _p[3] );
...
static void dao__glSelectBuffer( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) buffer );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glSeparableFilter2D( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glTexCoord1d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double s = (double) DaoValue_TryGetFloat( _p[0] );
...
{
  double s = (double) DaoValue_TryGetFloat( _p[0] );
  double t = (double) DaoValue_TryGetFloat( _p[1] );
...
static void dao__glTexCoord3d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double s = (double) DaoValue_TryGetFloat( _p[0] );
  double t = (double) DaoValue_TryGetFloat( _p[1] );
  double r = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glTexCoord4d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double t = (double) DaoValue_TryGetFloat( _p[1] );
  double r = (double) DaoValue_TryGetFloat( _p[2] );
  double q = (double) DaoValue_TryGetFloat( _p[3] );
...
static void dao__glTexGend( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int coord = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[1] );
  double param = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glTexGendv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int coord = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  unsigned int pname = (unsigned int) DaoValue_TryGetInteger( _p[1] );
  const double* params = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[2] );
...
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  double s = (double) DaoValue_TryGetFloat( _p[1] );
...
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const double* v = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[1] );
...
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const float* v = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[1] );
...
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const int* v = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[1] );
...
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const short* v = (const short*) DaoArray_ToSInt16( (DaoArray*)_p[1] );
...
static void dao__glMultiTexCoord2d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int target = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  double s = (double) DaoValue_TryGetFloat( _p[1] );
  double t = (double) DaoValue_TryGetFloat( _p[2] );
...
static void dao__glMultiTexCoord3d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double s = (double) DaoValue_TryGetFloat( _p[1] );
  double t = (double) DaoValue_TryGetFloat( _p[2] );
  double r = (double) DaoValue_TryGetFloat( _p[3] );
...
static void dao__glMultiTexCoord4d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double t = (double) DaoValue_TryGetFloat( _p[2] );
  double r = (double) DaoValue_TryGetFloat( _p[3] );
  double q = (double) DaoValue_TryGetFloat( _p[4] );
...
static void dao__glFogCoordfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const float* coord = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[0] );
...
static void dao__glFogCoordd( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  double coord = (double) DaoValue_TryGetFloat( _p[0] );
...
static void dao__glFogCoorddv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  const double* coord = (const double*) DaoArray_ToFloat64( (DaoArray*)_p[0] );
...
static void dao__glMultiDrawArrays( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const int* count = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[2] );
  const int* first = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[1] );
...
static void dao__glGenQueries( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  glGenQueries( n, &ids );
  DaoProcess_PutInteger( _proc, (dao_integer) ids );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glDeleteQueries( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  int n = (int) DaoValue_TryGetInteger( _p[0] );
  const unsigned int* ids = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[1] );
...
static void dao__glIsQuery( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsQuery );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glBeginQuery( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  int n = (int) DaoValue_TryGetInteger( _p[0] );
  const unsigned int* buffers = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[1] );
...
static void dao__glGenBuffers( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) buffers );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glIsBuffer( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsBuffer );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glBufferData( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glUnmapBuffer( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glUnmapBuffer );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetBufferParameteriv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  int n = (int) DaoValue_TryGetInteger( _p[0] );
  const unsigned int* bufs = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[1] );
...
{
  unsigned int index = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const signed char* v = (const signed char*) DaoArray_ToSInt8( (DaoArray*)_p[1] );

  glVertexAttrib4Nbv( index, v );
  DaoArray_FromSInt8( (DaoArray*)_p[1] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glVertexAttrib4Niv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  unsigned int index = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const unsigned char* v = (const unsigned char*) DaoArray_ToUInt8( (DaoArray*)_p[1] );

  glVertexAttrib4Nubv( index, v );
  DaoArray_FromUInt8( (DaoArray*)_p[1] );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glVertexAttrib4Nuiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int index = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const unsigned int* v = (const unsigned int*) DaoArray_ToUInt32( (DaoArray*)_p[1] );
...
{
  unsigned int index = (unsigned int) DaoValue_TryGetInteger( _p[0] );
  const unsigned short* v = (const unsigned short*) DaoArray_ToUInt16( (DaoArray*)_p[1] );
...
static void dao__glVertexAttrib4d( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  double y = (double) DaoValue_TryGetFloat( _p[2] );
  double z = (double) DaoValue_TryGetFloat( _p[3] );
  double w = (double) DaoValue_TryGetFloat( _p[4] );
...
static void dao__glCreateShader( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glCreateShader );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glCompileShader( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glCreateProgram( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glCreateProgram );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glAttachShader( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glUniform1fv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  int location = (int) DaoValue_TryGetInteger( _p[0] );
  int count = (int) DaoValue_TryGetInteger( _p[1] );
  const float* value = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[2] );
...
static void dao__glUniform1iv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  int location = (int) DaoValue_TryGetInteger( _p[0] );
  int count = (int) DaoValue_TryGetInteger( _p[1] );
  const int* value = (const int*) DaoArray_ToSInt32( (DaoArray*)_p[2] );
...
static void dao__glUniformMatrix2fv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  const float* value = (const float*) DaoArray_ToFloat32( (DaoArray*)_p[3] );
...
static void dao__glIsShader( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsShader );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glIsProgram( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glIsProgram );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetShaderiv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetAttachedShaders( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_NewInteger( _proc, (dao_integer)count );
  DaoProcess_NewInteger( _proc, (dao_integer)shaders );
...
static void dao__glGetShaderInfoLog( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) length );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetProgramInfoLog( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glGetUniformLocation( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glGetUniformLocation );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetActiveUniform( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_NewInteger( _proc, (dao_integer)length );
  DaoProcess_NewInteger( _proc, (dao_integer)size );
  DaoProcess_NewInteger( _proc, (dao_integer)type );
...
static void dao__glGetAttribLocation( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutInteger( _proc, (dao_integer) _glGetAttribLocation );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glStencilFuncSeparate( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
{
  {  "GL_2D", DAO_FLOAT, GL_2D},
  {  "GL_2_BYTES", DAO_FLOAT, GL_2_BYTES},
  {  "GL_3D", DAO_FLOAT, GL_3D},
  {  "GL_3D_COLOR", DAO_FLOAT, GL_3D_COLOR},
  {  "GL_3D_COLOR_TEXTURE", DAO_FLOAT, GL_3D_COLOR_TEXTURE},
  {  "GL_3_BYTES", DAO_FLOAT, GL_3_BYTES},
  {  "GL_4D_COLOR_TEXTURE", DAO_FLOAT, GL_4D_COLOR_TEXTURE},
  {  "GL_4_BYTES", DAO_FLOAT, GL_4_BYTES},
  {  "GL_ACCUM", DAO_FLOAT, GL_ACCUM},
  {  "GL_ACCUM_ALPHA_BITS", DAO_FLOAT, GL_ACCUM_ALPHA_BITS},
  {  "GL_ACCUM_BLUE_BITS", DAO_FLOAT, GL_ACCUM_BLUE_BITS},
  {  "GL_ACCUM_BUFFER_BIT", DAO_FLOAT, GL_ACCUM_BUFFER_BIT},
  {  "GL_ACCUM_CLEAR_VALUE", DAO_FLOAT, GL_ACCUM_CLEAR_VALUE},
  {  "GL_ACCUM_GREEN_BITS", DAO_FLOAT, GL_ACCUM_GREEN_BITS},
  {  "GL_ACCUM_RED_BITS", DAO_FLOAT, GL_ACCUM_RED_BITS},
  {  "GL_ACTIVE_ATTRIBUTES", DAO_FLOAT, GL_ACTIVE_ATTRIBUTES},
  {  "GL_ACTIVE_ATTRIBUTE_MAX_LENGTH", DAO_FLOAT, GL_ACTIVE_ATTRIBUTE_MAX_LENGTH},
  {  "GL_ACTIVE_TEXTURE", DAO_FLOAT, GL_ACTIVE_TEXTURE},
  {  "GL_ACTIVE_UNIFORMS", DAO_FLOAT, GL_ACTIVE_UNIFORMS},
  {  "GL_ACTIVE_UNIFORM_MAX_LENGTH", DAO_FLOAT, GL_ACTIVE_UNIFORM_MAX_LENGTH},
  {  "GL_ADD", DAO_FLOAT, GL_ADD},
  {  "GL_ADD_SIGNED", DAO_FLOAT, GL_ADD_SIGNED},
  {  "GL_ALIASED_LINE_WIDTH_RANGE", DAO_FLOAT, GL_ALIASED_LINE_WIDTH_RANGE},
  {  "GL_ALIASED_POINT_SIZE_RANGE", DAO_FLOAT, GL_ALIASED_POINT_SIZE_RANGE},
  {  "GL_ALL_ATTRIB_BITS", DAO_FLOAT, GL_ALL_ATTRIB_BITS},
  {  "GL_ALPHA", DAO_FLOAT, GL_ALPHA},
  {  "GL_ALPHA12", DAO_FLOAT, GL_ALPHA12},
  {  "GL_ALPHA16", DAO_FLOAT, GL_ALPHA16},
  {  "GL_ALPHA4", DAO_FLOAT, GL_ALPHA4},
  {  "GL_ALPHA8", DAO_FLOAT, GL_ALPHA8},
  {  "GL_ALPHA_BIAS", DAO_FLOAT, GL_ALPHA_BIAS},
  {  "GL_ALPHA_BITS", DAO_FLOAT, GL_ALPHA_BITS},
  {  "GL_ALPHA_SCALE", DAO_FLOAT, GL_ALPHA_SCALE},
  {  "GL_ALPHA_TEST", DAO_FLOAT, GL_ALPHA_TEST},
  {  "GL_ALPHA_TEST_FUNC", DAO_FLOAT, GL_ALPHA_TEST_FUNC},
  {  "GL_ALPHA_TEST_REF", DAO_FLOAT, GL_ALPHA_TEST_REF},
  {  "GL_ALWAYS", DAO_FLOAT, GL_ALWAYS},
  {  "GL_AMBIENT", DAO_FLOAT, GL_AMBIENT},
  {  "GL_AMBIENT_AND_DIFFUSE", DAO_FLOAT, GL_AMBIENT_AND_DIFFUSE},
  {  "GL_AND", DAO_FLOAT, GL_AND},
  {  "GL_AND_INVERTED", DAO_FLOAT, GL_AND_INVERTED},
  {  "GL_AND_REVERSE", DAO_FLOAT, GL_AND_REVERSE},
  {  "GL_ARRAY_BUFFER", DAO_FLOAT, GL_ARRAY_BUFFER},
  {  "GL_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_ARRAY_BUFFER_BINDING},
  {  "GL_ATTACHED_SHADERS", DAO_FLOAT, GL_ATTACHED_SHADERS},
  {  "GL_ATTRIB_STACK_DEPTH", DAO_FLOAT, GL_ATTRIB_STACK_DEPTH},
  {  "GL_AUTO_NORMAL", DAO_FLOAT, GL_AUTO_NORMAL},
  {  "GL_AUX0", DAO_FLOAT, GL_AUX0},
  {  "GL_AUX1", DAO_FLOAT, GL_AUX1},
  {  "GL_AUX2", DAO_FLOAT, GL_AUX2},
  {  "GL_AUX3", DAO_FLOAT, GL_AUX3},
  {  "GL_AUX_BUFFERS", DAO_FLOAT, GL_AUX_BUFFERS},
  {  "GL_BACK", DAO_FLOAT, GL_BACK},
  {  "GL_BACK_LEFT", DAO_FLOAT, GL_BACK_LEFT},
  {  "GL_BACK_RIGHT", DAO_FLOAT, GL_BACK_RIGHT},
  {  "GL_BGR", DAO_FLOAT, GL_BGR},
  {  "GL_BGRA", DAO_FLOAT, GL_BGRA},
  {  "GL_BITMAP", DAO_FLOAT, GL_BITMAP},
  {  "GL_BITMAP_TOKEN", DAO_FLOAT, GL_BITMAP_TOKEN},
  {  "GL_BLEND", DAO_FLOAT, GL_BLEND},
  {  "GL_BLEND_COLOR", DAO_FLOAT, GL_BLEND_COLOR},
  {  "GL_BLEND_DST", DAO_FLOAT, GL_BLEND_DST},
  {  "GL_BLEND_DST_ALPHA", DAO_FLOAT, GL_BLEND_DST_ALPHA},
  {  "GL_BLEND_DST_RGB", DAO_FLOAT, GL_BLEND_DST_RGB},
  {  "GL_BLEND_EQUATION", DAO_FLOAT, GL_BLEND_EQUATION},
  {  "GL_BLEND_EQUATION_ALPHA", DAO_FLOAT, GL_BLEND_EQUATION_ALPHA},
  {  "GL_BLEND_EQUATION_RGB", DAO_FLOAT, GL_BLEND_EQUATION_RGB},
  {  "GL_BLEND_SRC", DAO_FLOAT, GL_BLEND_SRC},
  {  "GL_BLEND_SRC_ALPHA", DAO_FLOAT, GL_BLEND_SRC_ALPHA},
  {  "GL_BLEND_SRC_RGB", DAO_FLOAT, GL_BLEND_SRC_RGB},
  {  "GL_BLUE", DAO_FLOAT, GL_BLUE},
  {  "GL_BLUE_BIAS", DAO_FLOAT, GL_BLUE_BIAS},
  {  "GL_BLUE_BITS", DAO_FLOAT, GL_BLUE_BITS},
  {  "GL_BLUE_SCALE", DAO_FLOAT, GL_BLUE_SCALE},
  {  "GL_BOOL", DAO_FLOAT, GL_BOOL},
  {  "GL_BOOL_VEC2", DAO_FLOAT, GL_BOOL_VEC2},
  {  "GL_BOOL_VEC3", DAO_FLOAT, GL_BOOL_VEC3},
  {  "GL_BOOL_VEC4", DAO_FLOAT, GL_BOOL_VEC4},
  {  "GL_BUFFER_ACCESS", DAO_FLOAT, GL_BUFFER_ACCESS},
  {  "GL_BUFFER_MAPPED", DAO_FLOAT, GL_BUFFER_MAPPED},
  {  "GL_BUFFER_MAP_POINTER", DAO_FLOAT, GL_BUFFER_MAP_POINTER},
  {  "GL_BUFFER_SIZE", DAO_FLOAT, GL_BUFFER_SIZE},
  {  "GL_BUFFER_USAGE", DAO_FLOAT, GL_BUFFER_USAGE},
  {  "GL_BYTE", DAO_FLOAT, GL_BYTE},
  {  "GL_C3F_V3F", DAO_FLOAT, GL_C3F_V3F},
  {  "GL_C4F_N3F_V3F", DAO_FLOAT, GL_C4F_N3F_V3F},
  {  "GL_C4UB_V2F", DAO_FLOAT, GL_C4UB_V2F},
  {  "GL_C4UB_V3F", DAO_FLOAT, GL_C4UB_V3F},
  {  "GL_CCW", DAO_FLOAT, GL_CCW},
  {  "GL_CLAMP", DAO_FLOAT, GL_CLAMP},
  {  "GL_CLAMP_TO_BORDER", DAO_FLOAT, GL_CLAMP_TO_BORDER},
  {  "GL_CLAMP_TO_EDGE", DAO_FLOAT, GL_CLAMP_TO_EDGE},
  {  "GL_CLEAR", DAO_FLOAT, GL_CLEAR},
  {  "GL_CLIENT_ACTIVE_TEXTURE", DAO_FLOAT, GL_CLIENT_ACTIVE_TEXTURE},
  {  "GL_CLIENT_ALL_ATTRIB_BITS", DAO_FLOAT, GL_CLIENT_ALL_ATTRIB_BITS},
  {  "GL_CLIENT_ATTRIB_STACK_DEPTH", DAO_FLOAT, GL_CLIENT_ATTRIB_STACK_DEPTH},
  {  "GL_CLIENT_PIXEL_STORE_BIT", DAO_FLOAT, GL_CLIENT_PIXEL_STORE_BIT},
  {  "GL_CLIENT_VERTEX_ARRAY_BIT", DAO_FLOAT, GL_CLIENT_VERTEX_ARRAY_BIT},
  {  "GL_CLIP_PLANE0", DAO_FLOAT, GL_CLIP_PLANE0},
  {  "GL_CLIP_PLANE1", DAO_FLOAT, GL_CLIP_PLANE1},
  {  "GL_CLIP_PLANE2", DAO_FLOAT, GL_CLIP_PLANE2},
  {  "GL_CLIP_PLANE3", DAO_FLOAT, GL_CLIP_PLANE3},
  {  "GL_CLIP_PLANE4", DAO_FLOAT, GL_CLIP_PLANE4},
  {  "GL_CLIP_PLANE5", DAO_FLOAT, GL_CLIP_PLANE5},
  {  "GL_COEFF", DAO_FLOAT, GL_COEFF},
  {  "GL_COLOR", DAO_FLOAT, GL_COLOR},
  {  "GL_COLOR_ARRAY", DAO_FLOAT, GL_COLOR_ARRAY},
  {  "GL_COLOR_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_COLOR_ARRAY_BUFFER_BINDING},
  {  "GL_COLOR_ARRAY_POINTER", DAO_FLOAT, GL_COLOR_ARRAY_POINTER},
  {  "GL_COLOR_ARRAY_SIZE", DAO_FLOAT, GL_COLOR_ARRAY_SIZE},
  {  "GL_COLOR_ARRAY_STRIDE", DAO_FLOAT, GL_COLOR_ARRAY_STRIDE},
  {  "GL_COLOR_ARRAY_TYPE", DAO_FLOAT, GL_COLOR_ARRAY_TYPE},
  {  "GL_COLOR_BUFFER_BIT", DAO_FLOAT, GL_COLOR_BUFFER_BIT},
  {  "GL_COLOR_CLEAR_VALUE", DAO_FLOAT, GL_COLOR_CLEAR_VALUE},
  {  "GL_COLOR_INDEX", DAO_FLOAT, GL_COLOR_INDEX},
  {  "GL_COLOR_INDEXES", DAO_FLOAT, GL_COLOR_INDEXES},
  {  "GL_COLOR_LOGIC_OP", DAO_FLOAT, GL_COLOR_LOGIC_OP},
  {  "GL_COLOR_MATERIAL", DAO_FLOAT, GL_COLOR_MATERIAL},
  {  "GL_COLOR_MATERIAL_FACE", DAO_FLOAT, GL_COLOR_MATERIAL_FACE},
  {  "GL_COLOR_MATERIAL_PARAMETER", DAO_FLOAT, GL_COLOR_MATERIAL_PARAMETER},
  {  "GL_COLOR_MATRIX", DAO_FLOAT, GL_COLOR_MATRIX},
  {  "GL_COLOR_MATRIX_STACK_DEPTH", DAO_FLOAT, GL_COLOR_MATRIX_STACK_DEPTH},
  {  "GL_COLOR_SUM", DAO_FLOAT, GL_COLOR_SUM},
  {  "GL_COLOR_TABLE", DAO_FLOAT, GL_COLOR_TABLE},
  {  "GL_COLOR_TABLE_ALPHA_SIZE", DAO_FLOAT, GL_COLOR_TABLE_ALPHA_SIZE},
  {  "GL_COLOR_TABLE_BIAS", DAO_FLOAT, GL_COLOR_TABLE_BIAS},
  {  "GL_COLOR_TABLE_BLUE_SIZE", DAO_FLOAT, GL_COLOR_TABLE_BLUE_SIZE},
  {  "GL_COLOR_TABLE_FORMAT", DAO_FLOAT, GL_COLOR_TABLE_FORMAT},
  {  "GL_COLOR_TABLE_GREEN_SIZE", DAO_FLOAT, GL_COLOR_TABLE_GREEN_SIZE},
  {  "GL_COLOR_TABLE_INTENSITY_SIZE", DAO_FLOAT, GL_COLOR_TABLE_INTENSITY_SIZE},
  {  "GL_COLOR_TABLE_LUMINANCE_SIZE", DAO_FLOAT, GL_COLOR_TABLE_LUMINANCE_SIZE},
  {  "GL_COLOR_TABLE_RED_SIZE", DAO_FLOAT, GL_COLOR_TABLE_RED_SIZE},
  {  "GL_COLOR_TABLE_SCALE", DAO_FLOAT, GL_COLOR_TABLE_SCALE},
  {  "GL_COLOR_TABLE_WIDTH", DAO_FLOAT, GL_COLOR_TABLE_WIDTH},
  {  "GL_COLOR_WRITEMASK", DAO_FLOAT, GL_COLOR_WRITEMASK},
  {  "GL_COMBINE", DAO_FLOAT, GL_COMBINE},
  {  "GL_COMBINE_ALPHA", DAO_FLOAT, GL_COMBINE_ALPHA},
  {  "GL_COMBINE_RGB", DAO_FLOAT, GL_COMBINE_RGB},
  {  "GL_COMPARE_R_TO_TEXTURE", DAO_FLOAT, GL_COMPARE_R_TO_TEXTURE},
  {  "GL_COMPILE", DAO_FLOAT, GL_COMPILE},
  {  "GL_COMPILE_AND_EXECUTE", DAO_FLOAT, GL_COMPILE_AND_EXECUTE},
  {  "GL_COMPILE_STATUS", DAO_FLOAT, GL_COMPILE_STATUS},
  {  "GL_COMPRESSED_ALPHA", DAO_FLOAT, GL_COMPRESSED_ALPHA},
  {  "GL_COMPRESSED_INTENSITY", DAO_FLOAT, GL_COMPRESSED_INTENSITY},
  {  "GL_COMPRESSED_LUMINANCE", DAO_FLOAT, GL_COMPRESSED_LUMINANCE},
  {  "GL_COMPRESSED_LUMINANCE_ALPHA", DAO_FLOAT, GL_COMPRESSED_LUMINANCE_ALPHA},
  {  "GL_COMPRESSED_RGB", DAO_FLOAT, GL_COMPRESSED_RGB},
  {  "GL_COMPRESSED_RGBA", DAO_FLOAT, GL_COMPRESSED_RGBA},
  {  "GL_COMPRESSED_SLUMINANCE", DAO_FLOAT, GL_COMPRESSED_SLUMINANCE},
  {  "GL_COMPRESSED_SLUMINANCE_ALPHA", DAO_FLOAT, GL_COMPRESSED_SLUMINANCE_ALPHA},
  {  "GL_COMPRESSED_SRGB", DAO_FLOAT, GL_COMPRESSED_SRGB},
  {  "GL_COMPRESSED_SRGB_ALPHA", DAO_FLOAT, GL_COMPRESSED_SRGB_ALPHA},
  {  "GL_COMPRESSED_TEXTURE_FORMATS", DAO_FLOAT, GL_COMPRESSED_TEXTURE_FORMATS},
  {  "GL_CONSTANT", DAO_FLOAT, GL_CONSTANT},
  {  "GL_CONSTANT_ALPHA", DAO_FLOAT, GL_CONSTANT_ALPHA},
  {  "GL_CONSTANT_ATTENUATION", DAO_FLOAT, GL_CONSTANT_ATTENUATION},
  {  "GL_CONSTANT_BORDER", DAO_FLOAT, GL_CONSTANT_BORDER},
  {  "GL_CONSTANT_COLOR", DAO_FLOAT, GL_CONSTANT_COLOR},
  {  "GL_CONVOLUTION_1D", DAO_FLOAT, GL_CONVOLUTION_1D},
  {  "GL_CONVOLUTION_2D", DAO_FLOAT, GL_CONVOLUTION_2D},
  {  "GL_CONVOLUTION_BORDER_COLOR", DAO_FLOAT, GL_CONVOLUTION_BORDER_COLOR},
  {  "GL_CONVOLUTION_BORDER_MODE", DAO_FLOAT, GL_CONVOLUTION_BORDER_MODE},
  {  "GL_CONVOLUTION_FILTER_BIAS", DAO_FLOAT, GL_CONVOLUTION_FILTER_BIAS},
  {  "GL_CONVOLUTION_FILTER_SCALE", DAO_FLOAT, GL_CONVOLUTION_FILTER_SCALE},
  {  "GL_CONVOLUTION_FORMAT", DAO_FLOAT, GL_CONVOLUTION_FORMAT},
  {  "GL_CONVOLUTION_HEIGHT", DAO_FLOAT, GL_CONVOLUTION_HEIGHT},
  {  "GL_CONVOLUTION_WIDTH", DAO_FLOAT, GL_CONVOLUTION_WIDTH},
  {  "GL_COORD_REPLACE", DAO_FLOAT, GL_COORD_REPLACE},
  {  "GL_COPY", DAO_FLOAT, GL_COPY},
  {  "GL_COPY_INVERTED", DAO_FLOAT, GL_COPY_INVERTED},
  {  "GL_COPY_PIXEL_TOKEN", DAO_FLOAT, GL_COPY_PIXEL_TOKEN},
  {  "GL_CULL_FACE", DAO_FLOAT, GL_CULL_FACE},
  {  "GL_CULL_FACE_MODE", DAO_FLOAT, GL_CULL_FACE_MODE},
  {  "GL_CURRENT_BIT", DAO_FLOAT, GL_CURRENT_BIT},
  {  "GL_CURRENT_COLOR", DAO_FLOAT, GL_CURRENT_COLOR},
  {  "GL_CURRENT_FOG_COORD", DAO_FLOAT, GL_CURRENT_FOG_COORD},
  {  "GL_CURRENT_FOG_COORDINATE", DAO_FLOAT, GL_CURRENT_FOG_COORDINATE},
  {  "GL_CURRENT_INDEX", DAO_FLOAT, GL_CURRENT_INDEX},
  {  "GL_CURRENT_NORMAL", DAO_FLOAT, GL_CURRENT_NORMAL},
  {  "GL_CURRENT_PROGRAM", DAO_FLOAT, GL_CURRENT_PROGRAM},
  {  "GL_CURRENT_QUERY", DAO_FLOAT, GL_CURRENT_QUERY},
  {  "GL_CURRENT_RASTER_COLOR", DAO_FLOAT, GL_CURRENT_RASTER_COLOR},
  {  "GL_CURRENT_RASTER_DISTANCE", DAO_FLOAT, GL_CURRENT_RASTER_DISTANCE},
  {  "GL_CURRENT_RASTER_INDEX", DAO_FLOAT, GL_CURRENT_RASTER_INDEX},
  {  "GL_CURRENT_RASTER_POSITION", DAO_FLOAT, GL_CURRENT_RASTER_POSITION},
  {  "GL_CURRENT_RASTER_POSITION_VALID", DAO_FLOAT, GL_CURRENT_RASTER_POSITION_VALID},
  {  "GL_CURRENT_RASTER_SECONDARY_COLOR", DAO_FLOAT, GL_CURRENT_RASTER_SECONDARY_COLOR},
  {  "GL_CURRENT_RASTER_TEXTURE_COORDS", DAO_FLOAT, GL_CURRENT_RASTER_TEXTURE_COORDS},
  {  "GL_CURRENT_SECONDARY_COLOR", DAO_FLOAT, GL_CURRENT_SECONDARY_COLOR},
  {  "GL_CURRENT_TEXTURE_COORDS", DAO_FLOAT, GL_CURRENT_TEXTURE_COORDS},
  {  "GL_CURRENT_VERTEX_ATTRIB", DAO_FLOAT, GL_CURRENT_VERTEX_ATTRIB},
  {  "GL_CW", DAO_FLOAT, GL_CW},
  {  "GL_DECAL", DAO_FLOAT, GL_DECAL},
  {  "GL_DECR", DAO_FLOAT, GL_DECR},
  {  "GL_DECR_WRAP", DAO_FLOAT, GL_DECR_WRAP},
  {  "GL_DELETE_STATUS", DAO_FLOAT, GL_DELETE_STATUS},
  {  "GL_DEPTH", DAO_FLOAT, GL_DEPTH},
  {  "GL_DEPTH_BIAS", DAO_FLOAT, GL_DEPTH_BIAS},
  {  "GL_DEPTH_BITS", DAO_FLOAT, GL_DEPTH_BITS},
  {  "GL_DEPTH_BUFFER_BIT", DAO_FLOAT, GL_DEPTH_BUFFER_BIT},
  {  "GL_DEPTH_CLEAR_VALUE", DAO_FLOAT, GL_DEPTH_CLEAR_VALUE},
  {  "GL_DEPTH_COMPONENT", DAO_FLOAT, GL_DEPTH_COMPONENT},
  {  "GL_DEPTH_COMPONENT16", DAO_FLOAT, GL_DEPTH_COMPONENT16},
  {  "GL_DEPTH_COMPONENT24", DAO_FLOAT, GL_DEPTH_COMPONENT24},
  {  "GL_DEPTH_COMPONENT32", DAO_FLOAT, GL_DEPTH_COMPONENT32},
  {  "GL_DEPTH_FUNC", DAO_FLOAT, GL_DEPTH_FUNC},
  {  "GL_DEPTH_RANGE", DAO_FLOAT, GL_DEPTH_RANGE},
  {  "GL_DEPTH_SCALE", DAO_FLOAT, GL_DEPTH_SCALE},
  {  "GL_DEPTH_TEST", DAO_FLOAT, GL_DEPTH_TEST},
  {  "GL_DEPTH_TEXTURE_MODE", DAO_FLOAT, GL_DEPTH_TEXTURE_MODE},
  {  "GL_DEPTH_WRITEMASK", DAO_FLOAT, GL_DEPTH_WRITEMASK},
  {  "GL_DIFFUSE", DAO_FLOAT, GL_DIFFUSE},
  {  "GL_DITHER", DAO_FLOAT, GL_DITHER},
  {  "GL_DOMAIN", DAO_FLOAT, GL_DOMAIN},
  {  "GL_DONT_CARE", DAO_FLOAT, GL_DONT_CARE},
  {  "GL_DOT3_RGB", DAO_FLOAT, GL_DOT3_RGB},
  {  "GL_DOT3_RGBA", DAO_FLOAT, GL_DOT3_RGBA},
  {  "GL_DOUBLE", DAO_FLOAT, GL_DOUBLE},
  {  "GL_DOUBLEBUFFER", DAO_FLOAT, GL_DOUBLEBUFFER},
  {  "GL_DRAW_BUFFER", DAO_FLOAT, GL_DRAW_BUFFER},
  {  "GL_DRAW_BUFFER0", DAO_FLOAT, GL_DRAW_BUFFER0},
  {  "GL_DRAW_BUFFER1", DAO_FLOAT, GL_DRAW_BUFFER1},
  {  "GL_DRAW_BUFFER10", DAO_FLOAT, GL_DRAW_BUFFER10},
  {  "GL_DRAW_BUFFER11", DAO_FLOAT, GL_DRAW_BUFFER11},
  {  "GL_DRAW_BUFFER12", DAO_FLOAT, GL_DRAW_BUFFER12},
  {  "GL_DRAW_BUFFER13", DAO_FLOAT, GL_DRAW_BUFFER13},
  {  "GL_DRAW_BUFFER14", DAO_FLOAT, GL_DRAW_BUFFER14},
  {  "GL_DRAW_BUFFER15", DAO_FLOAT, GL_DRAW_BUFFER15},
  {  "GL_DRAW_BUFFER2", DAO_FLOAT, GL_DRAW_BUFFER2},
  {  "GL_DRAW_BUFFER3", DAO_FLOAT, GL_DRAW_BUFFER3},
  {  "GL_DRAW_BUFFER4", DAO_FLOAT, GL_DRAW_BUFFER4},
  {  "GL_DRAW_BUFFER5", DAO_FLOAT, GL_DRAW_BUFFER5},
  {  "GL_DRAW_BUFFER6", DAO_FLOAT, GL_DRAW_BUFFER6},
  {  "GL_DRAW_BUFFER7", DAO_FLOAT, GL_DRAW_BUFFER7},
  {  "GL_DRAW_BUFFER8", DAO_FLOAT, GL_DRAW_BUFFER8},
  {  "GL_DRAW_BUFFER9", DAO_FLOAT, GL_DRAW_BUFFER9},
  {  "GL_DRAW_PIXEL_TOKEN", DAO_FLOAT, GL_DRAW_PIXEL_TOKEN},
  {  "GL_DST_ALPHA", DAO_FLOAT, GL_DST_ALPHA},
  {  "GL_DST_COLOR", DAO_FLOAT, GL_DST_COLOR},
  {  "GL_DYNAMIC_COPY", DAO_FLOAT, GL_DYNAMIC_COPY},
  {  "GL_DYNAMIC_DRAW", DAO_FLOAT, GL_DYNAMIC_DRAW},
  {  "GL_DYNAMIC_READ", DAO_FLOAT, GL_DYNAMIC_READ},
  {  "GL_EDGE_FLAG", DAO_FLOAT, GL_EDGE_FLAG},
  {  "GL_EDGE_FLAG_ARRAY", DAO_FLOAT, GL_EDGE_FLAG_ARRAY},
  {  "GL_EDGE_FLAG_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_EDGE_FLAG_ARRAY_BUFFER_BINDING},
  {  "GL_EDGE_FLAG_ARRAY_POINTER", DAO_FLOAT, GL_EDGE_FLAG_ARRAY_POINTER},
  {  "GL_EDGE_FLAG_ARRAY_STRIDE", DAO_FLOAT, GL_EDGE_FLAG_ARRAY_STRIDE},
  {  "GL_ELEMENT_ARRAY_BUFFER", DAO_FLOAT, GL_ELEMENT_ARRAY_BUFFER},
  {  "GL_ELEMENT_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_ELEMENT_ARRAY_BUFFER_BINDING},
  {  "GL_EMISSION", DAO_FLOAT, GL_EMISSION},
  {  "GL_ENABLE_BIT", DAO_FLOAT, GL_ENABLE_BIT},
  {  "GL_EQUAL", DAO_FLOAT, GL_EQUAL},
  {  "GL_EQUIV", DAO_FLOAT, GL_EQUIV},
  {  "GL_EVAL_BIT", DAO_FLOAT, GL_EVAL_BIT},
  {  "GL_EXP", DAO_FLOAT, GL_EXP},
  {  "GL_EXP2", DAO_FLOAT, GL_EXP2},
  {  "GL_EXTENSIONS", DAO_FLOAT, GL_EXTENSIONS},
  {  "GL_EYE_LINEAR", DAO_FLOAT, GL_EYE_LINEAR},
  {  "GL_EYE_PLANE", DAO_FLOAT, GL_EYE_PLANE},
  {  "GL_FALSE", DAO_FLOAT, GL_FALSE},
  {  "GL_FASTEST", DAO_FLOAT, GL_FASTEST},
  {  "GL_FEEDBACK", DAO_FLOAT, GL_FEEDBACK},
  {  "GL_FEEDBACK_BUFFER_POINTER", DAO_FLOAT, GL_FEEDBACK_BUFFER_POINTER},
  {  "GL_FEEDBACK_BUFFER_SIZE", DAO_FLOAT, GL_FEEDBACK_BUFFER_SIZE},
  {  "GL_FEEDBACK_BUFFER_TYPE", DAO_FLOAT, GL_FEEDBACK_BUFFER_TYPE},
  {  "GL_FILL", DAO_FLOAT, GL_FILL},
  {  "GL_FLAT", DAO_FLOAT, GL_FLAT},
  {  "GL_FLOAT", DAO_FLOAT, GL_FLOAT},
  {  "GL_FLOAT_MAT2", DAO_FLOAT, GL_FLOAT_MAT2},
  {  "GL_FLOAT_MAT2x3", DAO_FLOAT, GL_FLOAT_MAT2x3},
  {  "GL_FLOAT_MAT2x4", DAO_FLOAT, GL_FLOAT_MAT2x4},
  {  "GL_FLOAT_MAT3", DAO_FLOAT, GL_FLOAT_MAT3},
  {  "GL_FLOAT_MAT3x2", DAO_FLOAT, GL_FLOAT_MAT3x2},
  {  "GL_FLOAT_MAT3x4", DAO_FLOAT, GL_FLOAT_MAT3x4},
  {  "GL_FLOAT_MAT4", DAO_FLOAT, GL_FLOAT_MAT4},
  {  "GL_FLOAT_MAT4x2", DAO_FLOAT, GL_FLOAT_MAT4x2},
  {  "GL_FLOAT_MAT4x3", DAO_FLOAT, GL_FLOAT_MAT4x3},
  {  "GL_FLOAT_VEC2", DAO_FLOAT, GL_FLOAT_VEC2},
  {  "GL_FLOAT_VEC3", DAO_FLOAT, GL_FLOAT_VEC3},
  {  "GL_FLOAT_VEC4", DAO_FLOAT, GL_FLOAT_VEC4},
  {  "GL_FOG", DAO_FLOAT, GL_FOG},
  {  "GL_FOG_BIT", DAO_FLOAT, GL_FOG_BIT},
  {  "GL_FOG_COLOR", DAO_FLOAT, GL_FOG_COLOR},
  {  "GL_FOG_COORD", DAO_FLOAT, GL_FOG_COORD},
  {  "GL_FOG_COORDINATE", DAO_FLOAT, GL_FOG_COORDINATE},
  {  "GL_FOG_COORDINATE_ARRAY", DAO_FLOAT, GL_FOG_COORDINATE_ARRAY},
  {  "GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING},
  {  "GL_FOG_COORDINATE_ARRAY_POINTER", DAO_FLOAT, GL_FOG_COORDINATE_ARRAY_POINTER},
  {  "GL_FOG_COORDINATE_ARRAY_STRIDE", DAO_FLOAT, GL_FOG_COORDINATE_ARRAY_STRIDE},
  {  "GL_FOG_COORDINATE_ARRAY_TYPE", DAO_FLOAT, GL_FOG_COORDINATE_ARRAY_TYPE},
  {  "GL_FOG_COORDINATE_SOURCE", DAO_FLOAT, GL_FOG_COORDINATE_SOURCE},
  {  "GL_FOG_COORD_ARRAY", DAO_FLOAT, GL_FOG_COORD_ARRAY},
  {  "GL_FOG_COORD_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_FOG_COORD_ARRAY_BUFFER_BINDING},
  {  "GL_FOG_COORD_ARRAY_POINTER", DAO_FLOAT, GL_FOG_COORD_ARRAY_POINTER},
  {  "GL_FOG_COORD_ARRAY_STRIDE", DAO_FLOAT, GL_FOG_COORD_ARRAY_STRIDE},
  {  "GL_FOG_COORD_ARRAY_TYPE", DAO_FLOAT, GL_FOG_COORD_ARRAY_TYPE},
  {  "GL_FOG_COORD_SRC", DAO_FLOAT, GL_FOG_COORD_SRC},
  {  "GL_FOG_DENSITY", DAO_FLOAT, GL_FOG_DENSITY},
  {  "GL_FOG_END", DAO_FLOAT, GL_FOG_END},
  {  "GL_FOG_HINT", DAO_FLOAT, GL_FOG_HINT},
  {  "GL_FOG_INDEX", DAO_FLOAT, GL_FOG_INDEX},
  {  "GL_FOG_MODE", DAO_FLOAT, GL_FOG_MODE},
  {  "GL_FOG_START", DAO_FLOAT, GL_FOG_START},
  {  "GL_FRAGMENT_DEPTH", DAO_FLOAT, GL_FRAGMENT_DEPTH},
  {  "GL_FRAGMENT_SHADER", DAO_FLOAT, GL_FRAGMENT_SHADER},
  {  "GL_FRAGMENT_SHADER_DERIVATIVE_HINT", DAO_FLOAT, GL_FRAGMENT_SHADER_DERIVATIVE_HINT},
  {  "GL_FRONT", DAO_FLOAT, GL_FRONT},
  {  "GL_FRONT_AND_BACK", DAO_FLOAT, GL_FRONT_AND_BACK},
  {  "GL_FRONT_FACE", DAO_FLOAT, GL_FRONT_FACE},
  {  "GL_FRONT_LEFT", DAO_FLOAT, GL_FRONT_LEFT},
  {  "GL_FRONT_RIGHT", DAO_FLOAT, GL_FRONT_RIGHT},
  {  "GL_FUNC_ADD", DAO_FLOAT, GL_FUNC_ADD},
  {  "GL_FUNC_REVERSE_SUBTRACT", DAO_FLOAT, GL_FUNC_REVERSE_SUBTRACT},
  {  "GL_FUNC_SUBTRACT", DAO_FLOAT, GL_FUNC_SUBTRACT},
  {  "GL_GENERATE_MIPMAP", DAO_FLOAT, GL_GENERATE_MIPMAP},
  {  "GL_GENERATE_MIPMAP_HINT", DAO_FLOAT, GL_GENERATE_MIPMAP_HINT},
  {  "GL_GEQUAL", DAO_FLOAT, GL_GEQUAL},
  {  "GL_GREATER", DAO_FLOAT, GL_GREATER},
  {  "GL_GREEN", DAO_FLOAT, GL_GREEN},
  {  "GL_GREEN_BIAS", DAO_FLOAT, GL_GREEN_BIAS},
  {  "GL_GREEN_BITS", DAO_FLOAT, GL_GREEN_BITS},
  {  "GL_GREEN_SCALE", DAO_FLOAT, GL_GREEN_SCALE},
  {  "GL_HINT_BIT", DAO_FLOAT, GL_HINT_BIT},
  {  "GL_HISTOGRAM", DAO_FLOAT, GL_HISTOGRAM},
  {  "GL_HISTOGRAM_ALPHA_SIZE", DAO_FLOAT, GL_HISTOGRAM_ALPHA_SIZE},
  {  "GL_HISTOGRAM_BLUE_SIZE", DAO_FLOAT, GL_HISTOGRAM_BLUE_SIZE},
  {  "GL_HISTOGRAM_FORMAT", DAO_FLOAT, GL_HISTOGRAM_FORMAT},
  {  "GL_HISTOGRAM_GREEN_SIZE", DAO_FLOAT, GL_HISTOGRAM_GREEN_SIZE},
  {  "GL_HISTOGRAM_LUMINANCE_SIZE", DAO_FLOAT, GL_HISTOGRAM_LUMINANCE_SIZE},
  {  "GL_HISTOGRAM_RED_SIZE", DAO_FLOAT, GL_HISTOGRAM_RED_SIZE},
  {  "GL_HISTOGRAM_SINK", DAO_FLOAT, GL_HISTOGRAM_SINK},
  {  "GL_HISTOGRAM_WIDTH", DAO_FLOAT, GL_HISTOGRAM_WIDTH},
  {  "GL_INCR", DAO_FLOAT, GL_INCR},
  {  "GL_INCR_WRAP", DAO_FLOAT, GL_INCR_WRAP},
  {  "GL_INDEX_ARRAY", DAO_FLOAT, GL_INDEX_ARRAY},
  {  "GL_INDEX_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_INDEX_ARRAY_BUFFER_BINDING},
  {  "GL_INDEX_ARRAY_POINTER", DAO_FLOAT, GL_INDEX_ARRAY_POINTER},
  {  "GL_INDEX_ARRAY_STRIDE", DAO_FLOAT, GL_INDEX_ARRAY_STRIDE},
  {  "GL_INDEX_ARRAY_TYPE", DAO_FLOAT, GL_INDEX_ARRAY_TYPE},
  {  "GL_INDEX_BITS", DAO_FLOAT, GL_INDEX_BITS},
  {  "GL_INDEX_CLEAR_VALUE", DAO_FLOAT, GL_INDEX_CLEAR_VALUE},
  {  "GL_INDEX_LOGIC_OP", DAO_FLOAT, GL_INDEX_LOGIC_OP},
  {  "GL_INDEX_MODE", DAO_FLOAT, GL_INDEX_MODE},
  {  "GL_INDEX_OFFSET", DAO_FLOAT, GL_INDEX_OFFSET},
  {  "GL_INDEX_SHIFT", DAO_FLOAT, GL_INDEX_SHIFT},
  {  "GL_INDEX_WRITEMASK", DAO_FLOAT, GL_INDEX_WRITEMASK},
  {  "GL_INFO_LOG_LENGTH", DAO_FLOAT, GL_INFO_LOG_LENGTH},
  {  "GL_INT", DAO_FLOAT, GL_INT},
  {  "GL_INTENSITY", DAO_FLOAT, GL_INTENSITY},
  {  "GL_INTENSITY12", DAO_FLOAT, GL_INTENSITY12},
  {  "GL_INTENSITY16", DAO_FLOAT, GL_INTENSITY16},
  {  "GL_INTENSITY4", DAO_FLOAT, GL_INTENSITY4},
  {  "GL_INTENSITY8", DAO_FLOAT, GL_INTENSITY8},
  {  "GL_INTERPOLATE", DAO_FLOAT, GL_INTERPOLATE},
  {  "GL_INT_VEC2", DAO_FLOAT, GL_INT_VEC2},
  {  "GL_INT_VEC3", DAO_FLOAT, GL_INT_VEC3},
  {  "GL_INT_VEC4", DAO_FLOAT, GL_INT_VEC4},
  {  "GL_INVALID_ENUM", DAO_FLOAT, GL_INVALID_ENUM},
  {  "GL_INVALID_OPERATION", DAO_FLOAT, GL_INVALID_OPERATION},
  {  "GL_INVALID_VALUE", DAO_FLOAT, GL_INVALID_VALUE},
  {  "GL_INVERT", DAO_FLOAT, GL_INVERT},
  {  "GL_KEEP", DAO_FLOAT, GL_KEEP},
  {  "GL_LEFT", DAO_FLOAT, GL_LEFT},
  {  "GL_LEQUAL", DAO_FLOAT, GL_LEQUAL},
  {  "GL_LESS", DAO_FLOAT, GL_LESS},
  {  "GL_LIGHT0", DAO_FLOAT, GL_LIGHT0},
  {  "GL_LIGHT1", DAO_FLOAT, GL_LIGHT1},
  {  "GL_LIGHT2", DAO_FLOAT, GL_LIGHT2},
  {  "GL_LIGHT3", DAO_FLOAT, GL_LIGHT3},
  {  "GL_LIGHT4", DAO_FLOAT, GL_LIGHT4},
  {  "GL_LIGHT5", DAO_FLOAT, GL_LIGHT5},
  {  "GL_LIGHT6", DAO_FLOAT, GL_LIGHT6},
  {  "GL_LIGHT7", DAO_FLOAT, GL_LIGHT7},
  {  "GL_LIGHTING", DAO_FLOAT, GL_LIGHTING},
  {  "GL_LIGHTING_BIT", DAO_FLOAT, GL_LIGHTING_BIT},
  {  "GL_LIGHT_MODEL_AMBIENT", DAO_FLOAT, GL_LIGHT_MODEL_AMBIENT},
  {  "GL_LIGHT_MODEL_COLOR_CONTROL", DAO_FLOAT, GL_LIGHT_MODEL_COLOR_CONTROL},
  {  "GL_LIGHT_MODEL_LOCAL_VIEWER", DAO_FLOAT, GL_LIGHT_MODEL_LOCAL_VIEWER},
  {  "GL_LIGHT_MODEL_TWO_SIDE", DAO_FLOAT, GL_LIGHT_MODEL_TWO_SIDE},
  {  "GL_LINE", DAO_FLOAT, GL_LINE},
  {  "GL_LINEAR", DAO_FLOAT, GL_LINEAR},
  {  "GL_LINEAR_ATTENUATION", DAO_FLOAT, GL_LINEAR_ATTENUATION},
  {  "GL_LINEAR_MIPMAP_LINEAR", DAO_FLOAT, GL_LINEAR_MIPMAP_LINEAR},
  {  "GL_LINEAR_MIPMAP_NEAREST", DAO_FLOAT, GL_LINEAR_MIPMAP_NEAREST},
  {  "GL_LINES", DAO_FLOAT, GL_LINES},
  {  "GL_LINE_BIT", DAO_FLOAT, GL_LINE_BIT},
  {  "GL_LINE_LOOP", DAO_FLOAT, GL_LINE_LOOP},
  {  "GL_LINE_RESET_TOKEN", DAO_FLOAT, GL_LINE_RESET_TOKEN},
  {  "GL_LINE_SMOOTH", DAO_FLOAT, GL_LINE_SMOOTH},
  {  "GL_LINE_SMOOTH_HINT", DAO_FLOAT, GL_LINE_SMOOTH_HINT},
  {  "GL_LINE_STIPPLE", DAO_FLOAT, GL_LINE_STIPPLE},
  {  "GL_LINE_STIPPLE_PATTERN", DAO_FLOAT, GL_LINE_STIPPLE_PATTERN},
  {  "GL_LINE_STIPPLE_REPEAT", DAO_FLOAT, GL_LINE_STIPPLE_REPEAT},
  {  "GL_LINE_STRIP", DAO_FLOAT, GL_LINE_STRIP},
  {  "GL_LINE_TOKEN", DAO_FLOAT, GL_LINE_TOKEN},
  {  "GL_LINE_WIDTH", DAO_FLOAT, GL_LINE_WIDTH},
  {  "GL_LINE_WIDTH_GRANULARITY", DAO_FLOAT, GL_LINE_WIDTH_GRANULARITY},
  {  "GL_LINE_WIDTH_RANGE", DAO_FLOAT, GL_LINE_WIDTH_RANGE},
  {  "GL_LINK_STATUS", DAO_FLOAT, GL_LINK_STATUS},
  {  "GL_LIST_BASE", DAO_FLOAT, GL_LIST_BASE},
  {  "GL_LIST_BIT", DAO_FLOAT, GL_LIST_BIT},
  {  "GL_LIST_INDEX", DAO_FLOAT, GL_LIST_INDEX},
  {  "GL_LIST_MODE", DAO_FLOAT, GL_LIST_MODE},
  {  "GL_LOAD", DAO_FLOAT, GL_LOAD},
  {  "GL_LOGIC_OP_MODE", DAO_FLOAT, GL_LOGIC_OP_MODE},
  {  "GL_LOWER_LEFT", DAO_FLOAT, GL_LOWER_LEFT},
  {  "GL_LUMINANCE", DAO_FLOAT, GL_LUMINANCE},
  {  "GL_LUMINANCE12", DAO_FLOAT, GL_LUMINANCE12},
  {  "GL_LUMINANCE12_ALPHA12", DAO_FLOAT, GL_LUMINANCE12_ALPHA12},
  {  "GL_LUMINANCE12_ALPHA4", DAO_FLOAT, GL_LUMINANCE12_ALPHA4},
  {  "GL_LUMINANCE16", DAO_FLOAT, GL_LUMINANCE16},
  {  "GL_LUMINANCE16_ALPHA16", DAO_FLOAT, GL_LUMINANCE16_ALPHA16},
  {  "GL_LUMINANCE4", DAO_FLOAT, GL_LUMINANCE4},
  {  "GL_LUMINANCE4_ALPHA4", DAO_FLOAT, GL_LUMINANCE4_ALPHA4},
  {  "GL_LUMINANCE6_ALPHA2", DAO_FLOAT, GL_LUMINANCE6_ALPHA2},
  {  "GL_LUMINANCE8", DAO_FLOAT, GL_LUMINANCE8},
  {  "GL_LUMINANCE8_ALPHA8", DAO_FLOAT, GL_LUMINANCE8_ALPHA8},
  {  "GL_LUMINANCE_ALPHA", DAO_FLOAT, GL_LUMINANCE_ALPHA},
  {  "GL_MAP1_COLOR_4", DAO_FLOAT, GL_MAP1_COLOR_4},
  {  "GL_MAP1_GRID_DOMAIN", DAO_FLOAT, GL_MAP1_GRID_DOMAIN},
  {  "GL_MAP1_GRID_SEGMENTS", DAO_FLOAT, GL_MAP1_GRID_SEGMENTS},
  {  "GL_MAP1_INDEX", DAO_FLOAT, GL_MAP1_INDEX},
  {  "GL_MAP1_NORMAL", DAO_FLOAT, GL_MAP1_NORMAL},
  {  "GL_MAP1_TEXTURE_COORD_1", DAO_FLOAT, GL_MAP1_TEXTURE_COORD_1},
  {  "GL_MAP1_TEXTURE_COORD_2", DAO_FLOAT, GL_MAP1_TEXTURE_COORD_2},
  {  "GL_MAP1_TEXTURE_COORD_3", DAO_FLOAT, GL_MAP1_TEXTURE_COORD_3},
  {  "GL_MAP1_TEXTURE_COORD_4", DAO_FLOAT, GL_MAP1_TEXTURE_COORD_4},
  {  "GL_MAP1_VERTEX_3", DAO_FLOAT, GL_MAP1_VERTEX_3},
  {  "GL_MAP1_VERTEX_4", DAO_FLOAT, GL_MAP1_VERTEX_4},
  {  "GL_MAP2_COLOR_4", DAO_FLOAT, GL_MAP2_COLOR_4},
  {  "GL_MAP2_GRID_DOMAIN", DAO_FLOAT, GL_MAP2_GRID_DOMAIN},
  {  "GL_MAP2_GRID_SEGMENTS", DAO_FLOAT, GL_MAP2_GRID_SEGMENTS},
  {  "GL_MAP2_INDEX", DAO_FLOAT, GL_MAP2_INDEX},
  {  "GL_MAP2_NORMAL", DAO_FLOAT, GL_MAP2_NORMAL},
  {  "GL_MAP2_TEXTURE_COORD_1", DAO_FLOAT, GL_MAP2_TEXTURE_COORD_1},
  {  "GL_MAP2_TEXTURE_COORD_2", DAO_FLOAT, GL_MAP2_TEXTURE_COORD_2},
  {  "GL_MAP2_TEXTURE_COORD_3", DAO_FLOAT, GL_MAP2_TEXTURE_COORD_3},
  {  "GL_MAP2_TEXTURE_COORD_4", DAO_FLOAT, GL_MAP2_TEXTURE_COORD_4},
  {  "GL_MAP2_VERTEX_3", DAO_FLOAT, GL_MAP2_VERTEX_3},
  {  "GL_MAP2_VERTEX_4", DAO_FLOAT, GL_MAP2_VERTEX_4},
  {  "GL_MAP_COLOR", DAO_FLOAT, GL_MAP_COLOR},
  {  "GL_MAP_STENCIL", DAO_FLOAT, GL_MAP_STENCIL},
  {  "GL_MATRIX_MODE", DAO_FLOAT, GL_MATRIX_MODE},
  {  "GL_MAX", DAO_FLOAT, GL_MAX},
  {  "GL_MAX_3D_TEXTURE_SIZE", DAO_FLOAT, GL_MAX_3D_TEXTURE_SIZE},
  {  "GL_MAX_ATTRIB_STACK_DEPTH", DAO_FLOAT, GL_MAX_ATTRIB_STACK_DEPTH},
  {  "GL_MAX_CLIENT_ATTRIB_STACK_DEPTH", DAO_FLOAT, GL_MAX_CLIENT_ATTRIB_STACK_DEPTH},
  {  "GL_MAX_CLIP_PLANES", DAO_FLOAT, GL_MAX_CLIP_PLANES},
  {  "GL_MAX_COLOR_MATRIX_STACK_DEPTH", DAO_FLOAT, GL_MAX_COLOR_MATRIX_STACK_DEPTH},
  {  "GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS", DAO_FLOAT, GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS},
  {  "GL_MAX_CONVOLUTION_HEIGHT", DAO_FLOAT, GL_MAX_CONVOLUTION_HEIGHT},
  {  "GL_MAX_CONVOLUTION_WIDTH", DAO_FLOAT, GL_MAX_CONVOLUTION_WIDTH},
  {  "GL_MAX_CUBE_MAP_TEXTURE_SIZE", DAO_FLOAT, GL_MAX_CUBE_MAP_TEXTURE_SIZE},
  {  "GL_MAX_DRAW_BUFFERS", DAO_FLOAT, GL_MAX_DRAW_BUFFERS},
  {  "GL_MAX_ELEMENTS_INDICES", DAO_FLOAT, GL_MAX_ELEMENTS_INDICES},
  {  "GL_MAX_ELEMENTS_VERTICES", DAO_FLOAT, GL_MAX_ELEMENTS_VERTICES},
  {  "GL_MAX_EVAL_ORDER", DAO_FLOAT, GL_MAX_EVAL_ORDER},
  {  "GL_MAX_FRAGMENT_UNIFORM_COMPONENTS", DAO_FLOAT, GL_MAX_FRAGMENT_UNIFORM_COMPONENTS},
  {  "GL_MAX_LIGHTS", DAO_FLOAT, GL_MAX_LIGHTS},
  {  "GL_MAX_LIST_NESTING", DAO_FLOAT, GL_MAX_LIST_NESTING},
  {  "GL_MAX_MODELVIEW_STACK_DEPTH", DAO_FLOAT, GL_MAX_MODELVIEW_STACK_DEPTH},
  {  "GL_MAX_NAME_STACK_DEPTH", DAO_FLOAT, GL_MAX_NAME_STACK_DEPTH},
  {  "GL_MAX_PIXEL_MAP_TABLE", DAO_FLOAT, GL_MAX_PIXEL_MAP_TABLE},
  {  "GL_MAX_PROJECTION_STACK_DEPTH", DAO_FLOAT, GL_MAX_PROJECTION_STACK_DEPTH},
  {  "GL_MAX_TEXTURE_COORDS", DAO_FLOAT, GL_MAX_TEXTURE_COORDS},
  {  "GL_MAX_TEXTURE_IMAGE_UNITS", DAO_FLOAT, GL_MAX_TEXTURE_IMAGE_UNITS},
  {  "GL_MAX_TEXTURE_LOD_BIAS", DAO_FLOAT, GL_MAX_TEXTURE_LOD_BIAS},
  {  "GL_MAX_TEXTURE_SIZE", DAO_FLOAT, GL_MAX_TEXTURE_SIZE},
  {  "GL_MAX_TEXTURE_STACK_DEPTH", DAO_FLOAT, GL_MAX_TEXTURE_STACK_DEPTH},
  {  "GL_MAX_TEXTURE_UNITS", DAO_FLOAT, GL_MAX_TEXTURE_UNITS},
  {  "GL_MAX_VARYING_FLOATS", DAO_FLOAT, GL_MAX_VARYING_FLOATS},
  {  "GL_MAX_VERTEX_ATTRIBS", DAO_FLOAT, GL_MAX_VERTEX_ATTRIBS},
  {  "GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS", DAO_FLOAT, GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS},
  {  "GL_MAX_VERTEX_UNIFORM_COMPONENTS", DAO_FLOAT, GL_MAX_VERTEX_UNIFORM_COMPONENTS},
  {  "GL_MAX_VIEWPORT_DIMS", DAO_FLOAT, GL_MAX_VIEWPORT_DIMS},
  {  "GL_MIN", DAO_FLOAT, GL_MIN},
  {  "GL_MINMAX", DAO_FLOAT, GL_MINMAX},
  {  "GL_MINMAX_FORMAT", DAO_FLOAT, GL_MINMAX_FORMAT},
  {  "GL_MINMAX_SINK", DAO_FLOAT, GL_MINMAX_SINK},
  {  "GL_MIRRORED_REPEAT", DAO_FLOAT, GL_MIRRORED_REPEAT},
  {  "GL_MODELVIEW", DAO_FLOAT, GL_MODELVIEW},
  {  "GL_MODELVIEW_MATRIX", DAO_FLOAT, GL_MODELVIEW_MATRIX},
  {  "GL_MODELVIEW_STACK_DEPTH", DAO_FLOAT, GL_MODELVIEW_STACK_DEPTH},
  {  "GL_MODULATE", DAO_FLOAT, GL_MODULATE},
  {  "GL_MULT", DAO_FLOAT, GL_MULT},
  {  "GL_MULTISAMPLE", DAO_FLOAT, GL_MULTISAMPLE},
  {  "GL_MULTISAMPLE_BIT", DAO_FLOAT, GL_MULTISAMPLE_BIT},
  {  "GL_N3F_V3F", DAO_FLOAT, GL_N3F_V3F},
  {  "GL_NAME_STACK_DEPTH", DAO_FLOAT, GL_NAME_STACK_DEPTH},
  {  "GL_NAND", DAO_FLOAT, GL_NAND},
  {  "GL_NEAREST", DAO_FLOAT, GL_NEAREST},
  {  "GL_NEAREST_MIPMAP_LINEAR", DAO_FLOAT, GL_NEAREST_MIPMAP_LINEAR},
  {  "GL_NEAREST_MIPMAP_NEAREST", DAO_FLOAT, GL_NEAREST_MIPMAP_NEAREST},
  {  "GL_NEVER", DAO_FLOAT, GL_NEVER},
  {  "GL_NICEST", DAO_FLOAT, GL_NICEST},
  {  "GL_NONE", DAO_FLOAT, GL_NONE},
  {  "GL_NOOP", DAO_FLOAT, GL_NOOP},
  {  "GL_NOR", DAO_FLOAT, GL_NOR},
  {  "GL_NORMALIZE", DAO_FLOAT, GL_NORMALIZE},
  {  "GL_NORMAL_ARRAY", DAO_FLOAT, GL_NORMAL_ARRAY},
  {  "GL_NORMAL_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_NORMAL_ARRAY_BUFFER_BINDING},
  {  "GL_NORMAL_ARRAY_POINTER", DAO_FLOAT, GL_NORMAL_ARRAY_POINTER},
  {  "GL_NORMAL_ARRAY_STRIDE", DAO_FLOAT, GL_NORMAL_ARRAY_STRIDE},
  {  "GL_NORMAL_ARRAY_TYPE", DAO_FLOAT, GL_NORMAL_ARRAY_TYPE},
  {  "GL_NORMAL_MAP", DAO_FLOAT, GL_NORMAL_MAP},
  {  "GL_NOTEQUAL", DAO_FLOAT, GL_NOTEQUAL},
  {  "GL_NO_ERROR", DAO_FLOAT, GL_NO_ERROR},
  {  "GL_NUM_COMPRESSED_TEXTURE_FORMATS", DAO_FLOAT, GL_NUM_COMPRESSED_TEXTURE_FORMATS},
  {  "GL_OBJECT_LINEAR", DAO_FLOAT, GL_OBJECT_LINEAR},
  {  "GL_OBJECT_PLANE", DAO_FLOAT, GL_OBJECT_PLANE},
  {  "GL_ONE", DAO_FLOAT, GL_ONE},
  {  "GL_ONE_MINUS_CONSTANT_ALPHA", DAO_FLOAT, GL_ONE_MINUS_CONSTANT_ALPHA},
  {  "GL_ONE_MINUS_CONSTANT_COLOR", DAO_FLOAT, GL_ONE_MINUS_CONSTANT_COLOR},
  {  "GL_ONE_MINUS_DST_ALPHA", DAO_FLOAT, GL_ONE_MINUS_DST_ALPHA},
  {  "GL_ONE_MINUS_DST_COLOR", DAO_FLOAT, GL_ONE_MINUS_DST_COLOR},
  {  "GL_ONE_MINUS_SRC_ALPHA", DAO_FLOAT, GL_ONE_MINUS_SRC_ALPHA},
  {  "GL_ONE_MINUS_SRC_COLOR", DAO_FLOAT, GL_ONE_MINUS_SRC_COLOR},
  {  "GL_OPERAND0_ALPHA", DAO_FLOAT, GL_OPERAND0_ALPHA},
  {  "GL_OPERAND0_RGB", DAO_FLOAT, GL_OPERAND0_RGB},
  {  "GL_OPERAND1_ALPHA", DAO_FLOAT, GL_OPERAND1_ALPHA},
  {  "GL_OPERAND1_RGB", DAO_FLOAT, GL_OPERAND1_RGB},
  {  "GL_OPERAND2_ALPHA", DAO_FLOAT, GL_OPERAND2_ALPHA},
  {  "GL_OPERAND2_RGB", DAO_FLOAT, GL_OPERAND2_RGB},
  {  "GL_OR", DAO_FLOAT, GL_OR},
  {  "GL_ORDER", DAO_FLOAT, GL_ORDER},
  {  "GL_OR_INVERTED", DAO_FLOAT, GL_OR_INVERTED},
  {  "GL_OR_REVERSE", DAO_FLOAT, GL_OR_REVERSE},
  {  "GL_OUT_OF_MEMORY", DAO_FLOAT, GL_OUT_OF_MEMORY},
  {  "GL_PACK_ALIGNMENT", DAO_FLOAT, GL_PACK_ALIGNMENT},
  {  "GL_PACK_IMAGE_HEIGHT", DAO_FLOAT, GL_PACK_IMAGE_HEIGHT},
  {  "GL_PACK_LSB_FIRST", DAO_FLOAT, GL_PACK_LSB_FIRST},
  {  "GL_PACK_ROW_LENGTH", DAO_FLOAT, GL_PACK_ROW_LENGTH},
  {  "GL_PACK_SKIP_IMAGES", DAO_FLOAT, GL_PACK_SKIP_IMAGES},
  {  "GL_PACK_SKIP_PIXELS", DAO_FLOAT, GL_PACK_SKIP_PIXELS},
  {  "GL_PACK_SKIP_ROWS", DAO_FLOAT, GL_PACK_SKIP_ROWS},
  {  "GL_PACK_SWAP_BYTES", DAO_FLOAT, GL_PACK_SWAP_BYTES},
  {  "GL_PASS_THROUGH_TOKEN", DAO_FLOAT, GL_PASS_THROUGH_TOKEN},
  {  "GL_PERSPECTIVE_CORRECTION_HINT", DAO_FLOAT, GL_PERSPECTIVE_CORRECTION_HINT},
  {  "GL_PIXEL_MAP_A_TO_A", DAO_FLOAT, GL_PIXEL_MAP_A_TO_A},
  {  "GL_PIXEL_MAP_A_TO_A_SIZE", DAO_FLOAT, GL_PIXEL_MAP_A_TO_A_SIZE},
  {  "GL_PIXEL_MAP_B_TO_B", DAO_FLOAT, GL_PIXEL_MAP_B_TO_B},
  {  "GL_PIXEL_MAP_B_TO_B_SIZE", DAO_FLOAT, GL_PIXEL_MAP_B_TO_B_SIZE},
  {  "GL_PIXEL_MAP_G_TO_G", DAO_FLOAT, GL_PIXEL_MAP_G_TO_G},
  {  "GL_PIXEL_MAP_G_TO_G_SIZE", DAO_FLOAT, GL_PIXEL_MAP_G_TO_G_SIZE},
  {  "GL_PIXEL_MAP_I_TO_A", DAO_FLOAT, GL_PIXEL_MAP_I_TO_A},
  {  "GL_PIXEL_MAP_I_TO_A_SIZE", DAO_FLOAT, GL_PIXEL_MAP_I_TO_A_SIZE},
  {  "GL_PIXEL_MAP_I_TO_B", DAO_FLOAT, GL_PIXEL_MAP_I_TO_B},
  {  "GL_PIXEL_MAP_I_TO_B_SIZE", DAO_FLOAT, GL_PIXEL_MAP_I_TO_B_SIZE},
  {  "GL_PIXEL_MAP_I_TO_G", DAO_FLOAT, GL_PIXEL_MAP_I_TO_G},
  {  "GL_PIXEL_MAP_I_TO_G_SIZE", DAO_FLOAT, GL_PIXEL_MAP_I_TO_G_SIZE},
  {  "GL_PIXEL_MAP_I_TO_I", DAO_FLOAT, GL_PIXEL_MAP_I_TO_I},
  {  "GL_PIXEL_MAP_I_TO_I_SIZE", DAO_FLOAT, GL_PIXEL_MAP_I_TO_I_SIZE},
  {  "GL_PIXEL_MAP_I_TO_R", DAO_FLOAT, GL_PIXEL_MAP_I_TO_R},
  {  "GL_PIXEL_MAP_I_TO_R_SIZE", DAO_FLOAT, GL_PIXEL_MAP_I_TO_R_SIZE},
  {  "GL_PIXEL_MAP_R_TO_R", DAO_FLOAT, GL_PIXEL_MAP_R_TO_R},
  {  "GL_PIXEL_MAP_R_TO_R_SIZE", DAO_FLOAT, GL_PIXEL_MAP_R_TO_R_SIZE},
  {  "GL_PIXEL_MAP_S_TO_S", DAO_FLOAT, GL_PIXEL_MAP_S_TO_S},
  {  "GL_PIXEL_MAP_S_TO_S_SIZE", DAO_FLOAT, GL_PIXEL_MAP_S_TO_S_SIZE},
  {  "GL_PIXEL_MODE_BIT", DAO_FLOAT, GL_PIXEL_MODE_BIT},
  {  "GL_PIXEL_PACK_BUFFER", DAO_FLOAT, GL_PIXEL_PACK_BUFFER},
  {  "GL_PIXEL_PACK_BUFFER_BINDING", DAO_FLOAT, GL_PIXEL_PACK_BUFFER_BINDING},
  {  "GL_PIXEL_UNPACK_BUFFER", DAO_FLOAT, GL_PIXEL_UNPACK_BUFFER},
  {  "GL_PIXEL_UNPACK_BUFFER_BINDING", DAO_FLOAT, GL_PIXEL_UNPACK_BUFFER_BINDING},
  {  "GL_POINT", DAO_FLOAT, GL_POINT},
  {  "GL_POINTS", DAO_FLOAT, GL_POINTS},
  {  "GL_POINT_BIT", DAO_FLOAT, GL_POINT_BIT},
  {  "GL_POINT_DISTANCE_ATTENUATION", DAO_FLOAT, GL_POINT_DISTANCE_ATTENUATION},
  {  "GL_POINT_FADE_THRESHOLD_SIZE", DAO_FLOAT, GL_POINT_FADE_THRESHOLD_SIZE},
  {  "GL_POINT_SIZE", DAO_FLOAT, GL_POINT_SIZE},
  {  "GL_POINT_SIZE_GRANULARITY", DAO_FLOAT, GL_POINT_SIZE_GRANULARITY},
  {  "GL_POINT_SIZE_MAX", DAO_FLOAT, GL_POINT_SIZE_MAX},
  {  "GL_POINT_SIZE_MIN", DAO_FLOAT, GL_POINT_SIZE_MIN},
  {  "GL_POINT_SIZE_RANGE", DAO_FLOAT, GL_POINT_SIZE_RANGE},
  {  "GL_POINT_SMOOTH", DAO_FLOAT, GL_POINT_SMOOTH},
  {  "GL_POINT_SMOOTH_HINT", DAO_FLOAT, GL_POINT_SMOOTH_HINT},
  {  "GL_POINT_SPRITE", DAO_FLOAT, GL_POINT_SPRITE},
  {  "GL_POINT_SPRITE_COORD_ORIGIN", DAO_FLOAT, GL_POINT_SPRITE_COORD_ORIGIN},
  {  "GL_POINT_TOKEN", DAO_FLOAT, GL_POINT_TOKEN},
  {  "GL_POLYGON", DAO_FLOAT, GL_POLYGON},
  {  "GL_POLYGON_BIT", DAO_FLOAT, GL_POLYGON_BIT},
  {  "GL_POLYGON_MODE", DAO_FLOAT, GL_POLYGON_MODE},
  {  "GL_POLYGON_OFFSET_FACTOR", DAO_FLOAT, GL_POLYGON_OFFSET_FACTOR},
  {  "GL_POLYGON_OFFSET_FILL", DAO_FLOAT, GL_POLYGON_OFFSET_FILL},
  {  "GL_POLYGON_OFFSET_LINE", DAO_FLOAT, GL_POLYGON_OFFSET_LINE},
  {  "GL_POLYGON_OFFSET_POINT", DAO_FLOAT, GL_POLYGON_OFFSET_POINT},
  {  "GL_POLYGON_OFFSET_UNITS", DAO_FLOAT, GL_POLYGON_OFFSET_UNITS},
  {  "GL_POLYGON_SMOOTH", DAO_FLOAT, GL_POLYGON_SMOOTH},
  {  "GL_POLYGON_SMOOTH_HINT", DAO_FLOAT, GL_POLYGON_SMOOTH_HINT},
  {  "GL_POLYGON_STIPPLE", DAO_FLOAT, GL_POLYGON_STIPPLE},
  {  "GL_POLYGON_STIPPLE_BIT", DAO_FLOAT, GL_POLYGON_STIPPLE_BIT},
  {  "GL_POLYGON_TOKEN", DAO_FLOAT, GL_POLYGON_TOKEN},
  {  "GL_POSITION", DAO_FLOAT, GL_POSITION},
  {  "GL_POST_COLOR_MATRIX_ALPHA_BIAS", DAO_FLOAT, GL_POST_COLOR_MATRIX_ALPHA_BIAS},
  {  "GL_POST_COLOR_MATRIX_ALPHA_SCALE", DAO_FLOAT, GL_POST_COLOR_MATRIX_ALPHA_SCALE},
  {  "GL_POST_COLOR_MATRIX_BLUE_BIAS", DAO_FLOAT, GL_POST_COLOR_MATRIX_BLUE_BIAS},
  {  "GL_POST_COLOR_MATRIX_BLUE_SCALE", DAO_FLOAT, GL_POST_COLOR_MATRIX_BLUE_SCALE},
  {  "GL_POST_COLOR_MATRIX_COLOR_TABLE", DAO_FLOAT, GL_POST_COLOR_MATRIX_COLOR_TABLE},
  {  "GL_POST_COLOR_MATRIX_GREEN_BIAS", DAO_FLOAT, GL_POST_COLOR_MATRIX_GREEN_BIAS},
  {  "GL_POST_COLOR_MATRIX_GREEN_SCALE", DAO_FLOAT, GL_POST_COLOR_MATRIX_GREEN_SCALE},
  {  "GL_POST_COLOR_MATRIX_RED_BIAS", DAO_FLOAT, GL_POST_COLOR_MATRIX_RED_BIAS},
  {  "GL_POST_COLOR_MATRIX_RED_SCALE", DAO_FLOAT, GL_POST_COLOR_MATRIX_RED_SCALE},
  {  "GL_POST_CONVOLUTION_ALPHA_BIAS", DAO_FLOAT, GL_POST_CONVOLUTION_ALPHA_BIAS},
  {  "GL_POST_CONVOLUTION_ALPHA_SCALE", DAO_FLOAT, GL_POST_CONVOLUTION_ALPHA_SCALE},
  {  "GL_POST_CONVOLUTION_BLUE_BIAS", DAO_FLOAT, GL_POST_CONVOLUTION_BLUE_BIAS},
  {  "GL_POST_CONVOLUTION_BLUE_SCALE", DAO_FLOAT, GL_POST_CONVOLUTION_BLUE_SCALE},
  {  "GL_POST_CONVOLUTION_COLOR_TABLE", DAO_FLOAT, GL_POST_CONVOLUTION_COLOR_TABLE},
  {  "GL_POST_CONVOLUTION_GREEN_BIAS", DAO_FLOAT, GL_POST_CONVOLUTION_GREEN_BIAS},
  {  "GL_POST_CONVOLUTION_GREEN_SCALE", DAO_FLOAT, GL_POST_CONVOLUTION_GREEN_SCALE},
  {  "GL_POST_CONVOLUTION_RED_BIAS", DAO_FLOAT, GL_POST_CONVOLUTION_RED_BIAS},
  {  "GL_POST_CONVOLUTION_RED_SCALE", DAO_FLOAT, GL_POST_CONVOLUTION_RED_SCALE},
  {  "GL_PREVIOUS", DAO_FLOAT, GL_PREVIOUS},
  {  "GL_PRIMARY_COLOR", DAO_FLOAT, GL_PRIMARY_COLOR},
  {  "GL_PROJECTION", DAO_FLOAT, GL_PROJECTION},
  {  "GL_PROJECTION_MATRIX", DAO_FLOAT, GL_PROJECTION_MATRIX},
  {  "GL_PROJECTION_STACK_DEPTH", DAO_FLOAT, GL_PROJECTION_STACK_DEPTH},
  {  "GL_PROXY_COLOR_TABLE", DAO_FLOAT, GL_PROXY_COLOR_TABLE},
  {  "GL_PROXY_HISTOGRAM", DAO_FLOAT, GL_PROXY_HISTOGRAM},
  {  "GL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE", DAO_FLOAT, GL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE},
  {  "GL_PROXY_POST_CONVOLUTION_COLOR_TABLE", DAO_FLOAT, GL_PROXY_POST_CONVOLUTION_COLOR_TABLE},
  {  "GL_PROXY_TEXTURE_1D", DAO_FLOAT, GL_PROXY_TEXTURE_1D},
  {  "GL_PROXY_TEXTURE_2D", DAO_FLOAT, GL_PROXY_TEXTURE_2D},
  {  "GL_PROXY_TEXTURE_3D", DAO_FLOAT, GL_PROXY_TEXTURE_3D},
  {  "GL_PROXY_TEXTURE_CUBE_MAP", DAO_FLOAT, GL_PROXY_TEXTURE_CUBE_MAP},
  {  "GL_Q", DAO_FLOAT, GL_Q},
  {  "GL_QUADRATIC_ATTENUATION", DAO_FLOAT, GL_QUADRATIC_ATTENUATION},
  {  "GL_QUADS", DAO_FLOAT, GL_QUADS},
  {  "GL_QUAD_STRIP", DAO_FLOAT, GL_QUAD_STRIP},
  {  "GL_QUERY_COUNTER_BITS", DAO_FLOAT, GL_QUERY_COUNTER_BITS},
  {  "GL_QUERY_RESULT", DAO_FLOAT, GL_QUERY_RESULT},
  {  "GL_QUERY_RESULT_AVAILABLE", DAO_FLOAT, GL_QUERY_RESULT_AVAILABLE},
  {  "GL_R", DAO_FLOAT, GL_R},
  {  "GL_R3_G3_B2", DAO_FLOAT, GL_R3_G3_B2},
  {  "GL_READ_BUFFER", DAO_FLOAT, GL_READ_BUFFER},
  {  "GL_READ_ONLY", DAO_FLOAT, GL_READ_ONLY},
  {  "GL_READ_WRITE", DAO_FLOAT, GL_READ_WRITE},
  {  "GL_RED", DAO_FLOAT, GL_RED},
  {  "GL_REDUCE", DAO_FLOAT, GL_REDUCE},
  {  "GL_RED_BIAS", DAO_FLOAT, GL_RED_BIAS},
  {  "GL_RED_BITS", DAO_FLOAT, GL_RED_BITS},
  {  "GL_RED_SCALE", DAO_FLOAT, GL_RED_SCALE},
  {  "GL_REFLECTION_MAP", DAO_FLOAT, GL_REFLECTION_MAP},
  {  "GL_RENDER", DAO_FLOAT, GL_RENDER},
  {  "GL_RENDERER", DAO_FLOAT, GL_RENDERER},
  {  "GL_RENDER_MODE", DAO_FLOAT, GL_RENDER_MODE},
  {  "GL_REPEAT", DAO_FLOAT, GL_REPEAT},
  {  "GL_REPLACE", DAO_FLOAT, GL_REPLACE},
  {  "GL_REPLICATE_BORDER", DAO_FLOAT, GL_REPLICATE_BORDER},
  {  "GL_RESCALE_NORMAL", DAO_FLOAT, GL_RESCALE_NORMAL},
  {  "GL_RETURN", DAO_FLOAT, GL_RETURN},
  {  "GL_RGB", DAO_FLOAT, GL_RGB},
  {  "GL_RGB10", DAO_FLOAT, GL_RGB10},
  {  "GL_RGB10_A2", DAO_FLOAT, GL_RGB10_A2},
  {  "GL_RGB12", DAO_FLOAT, GL_RGB12},
  {  "GL_RGB16", DAO_FLOAT, GL_RGB16},
  {  "GL_RGB4", DAO_FLOAT, GL_RGB4},
  {  "GL_RGB5", DAO_FLOAT, GL_RGB5},
  {  "GL_RGB5_A1", DAO_FLOAT, GL_RGB5_A1},
  {  "GL_RGB8", DAO_FLOAT, GL_RGB8},
  {  "GL_RGBA", DAO_FLOAT, GL_RGBA},
  {  "GL_RGBA12", DAO_FLOAT, GL_RGBA12},
  {  "GL_RGBA16", DAO_FLOAT, GL_RGBA16},
  {  "GL_RGBA2", DAO_FLOAT, GL_RGBA2},
  {  "GL_RGBA4", DAO_FLOAT, GL_RGBA4},
  {  "GL_RGBA8", DAO_FLOAT, GL_RGBA8},
  {  "GL_RGBA_MODE", DAO_FLOAT, GL_RGBA_MODE},
  {  "GL_RGB_SCALE", DAO_FLOAT, GL_RGB_SCALE},
  {  "GL_RIGHT", DAO_FLOAT, GL_RIGHT},
  {  "GL_S", DAO_FLOAT, GL_S},
  {  "GL_SAMPLER_1D", DAO_FLOAT, GL_SAMPLER_1D},
  {  "GL_SAMPLER_1D_SHADOW", DAO_FLOAT, GL_SAMPLER_1D_SHADOW},
  {  "GL_SAMPLER_2D", DAO_FLOAT, GL_SAMPLER_2D},
  {  "GL_SAMPLER_2D_SHADOW", DAO_FLOAT, GL_SAMPLER_2D_SHADOW},
  {  "GL_SAMPLER_3D", DAO_FLOAT, GL_SAMPLER_3D},
  {  "GL_SAMPLER_CUBE", DAO_FLOAT, GL_SAMPLER_CUBE},
  {  "GL_SAMPLES", DAO_FLOAT, GL_SAMPLES},
  {  "GL_SAMPLES_PASSED", DAO_FLOAT, GL_SAMPLES_PASSED},
  {  "GL_SAMPLE_ALPHA_TO_COVERAGE", DAO_FLOAT, GL_SAMPLE_ALPHA_TO_COVERAGE},
  {  "GL_SAMPLE_ALPHA_TO_ONE", DAO_FLOAT, GL_SAMPLE_ALPHA_TO_ONE},
  {  "GL_SAMPLE_BUFFERS", DAO_FLOAT, GL_SAMPLE_BUFFERS},
  {  "GL_SAMPLE_COVERAGE", DAO_FLOAT, GL_SAMPLE_COVERAGE},
  {  "GL_SAMPLE_COVERAGE_INVERT", DAO_FLOAT, GL_SAMPLE_COVERAGE_INVERT},
  {  "GL_SAMPLE_COVERAGE_VALUE", DAO_FLOAT, GL_SAMPLE_COVERAGE_VALUE},
  {  "GL_SCISSOR_BIT", DAO_FLOAT, GL_SCISSOR_BIT},
  {  "GL_SCISSOR_BOX", DAO_FLOAT, GL_SCISSOR_BOX},
  {  "GL_SCISSOR_TEST", DAO_FLOAT, GL_SCISSOR_TEST},
  {  "GL_SECONDARY_COLOR_ARRAY", DAO_FLOAT, GL_SECONDARY_COLOR_ARRAY},
  {  "GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING},
  {  "GL_SECONDARY_COLOR_ARRAY_POINTER", DAO_FLOAT, GL_SECONDARY_COLOR_ARRAY_POINTER},
  {  "GL_SECONDARY_COLOR_ARRAY_SIZE", DAO_FLOAT, GL_SECONDARY_COLOR_ARRAY_SIZE},
  {  "GL_SECONDARY_COLOR_ARRAY_STRIDE", DAO_FLOAT, GL_SECONDARY_COLOR_ARRAY_STRIDE},
  {  "GL_SECONDARY_COLOR_ARRAY_TYPE", DAO_FLOAT, GL_SECONDARY_COLOR_ARRAY_TYPE},
  {  "GL_SELECT", DAO_FLOAT, GL_SELECT},
  {  "GL_SELECTION_BUFFER_POINTER", DAO_FLOAT, GL_SELECTION_BUFFER_POINTER},
  {  "GL_SELECTION_BUFFER_SIZE", DAO_FLOAT, GL_SELECTION_BUFFER_SIZE},
  {  "GL_SEPARABLE_2D", DAO_FLOAT, GL_SEPARABLE_2D},
  {  "GL_SEPARATE_SPECULAR_COLOR", DAO_FLOAT, GL_SEPARATE_SPECULAR_COLOR},
  {  "GL_SET", DAO_FLOAT, GL_SET},
  {  "GL_SHADER_SOURCE_LENGTH", DAO_FLOAT, GL_SHADER_SOURCE_LENGTH},
  {  "GL_SHADER_TYPE", DAO_FLOAT, GL_SHADER_TYPE},
  {  "GL_SHADE_MODEL", DAO_FLOAT, GL_SHADE_MODEL},
  {  "GL_SHADING_LANGUAGE_VERSION", DAO_FLOAT, GL_SHADING_LANGUAGE_VERSION},
  {  "GL_SHININESS", DAO_FLOAT, GL_SHININESS},
  {  "GL_SHORT", DAO_FLOAT, GL_SHORT},
  {  "GL_SINGLE_COLOR", DAO_FLOAT, GL_SINGLE_COLOR},
  {  "GL_SLUMINANCE", DAO_FLOAT, GL_SLUMINANCE},
  {  "GL_SLUMINANCE8", DAO_FLOAT, GL_SLUMINANCE8},
  {  "GL_SLUMINANCE8_ALPHA8", DAO_FLOAT, GL_SLUMINANCE8_ALPHA8},
  {  "GL_SLUMINANCE_ALPHA", DAO_FLOAT, GL_SLUMINANCE_ALPHA},
  {  "GL_SMOOTH", DAO_FLOAT, GL_SMOOTH},
  {  "GL_SMOOTH_LINE_WIDTH_GRANULARITY", DAO_FLOAT, GL_SMOOTH_LINE_WIDTH_GRANULARITY},
  {  "GL_SMOOTH_LINE_WIDTH_RANGE", DAO_FLOAT, GL_SMOOTH_LINE_WIDTH_RANGE},
  {  "GL_SMOOTH_POINT_SIZE_GRANULARITY", DAO_FLOAT, GL_SMOOTH_POINT_SIZE_GRANULARITY},
  {  "GL_SMOOTH_POINT_SIZE_RANGE", DAO_FLOAT, GL_SMOOTH_POINT_SIZE_RANGE},
  {  "GL_SOURCE0_ALPHA", DAO_FLOAT, GL_SOURCE0_ALPHA},
  {  "GL_SOURCE0_RGB", DAO_FLOAT, GL_SOURCE0_RGB},
  {  "GL_SOURCE1_ALPHA", DAO_FLOAT, GL_SOURCE1_ALPHA},
  {  "GL_SOURCE1_RGB", DAO_FLOAT, GL_SOURCE1_RGB},
  {  "GL_SOURCE2_ALPHA", DAO_FLOAT, GL_SOURCE2_ALPHA},
  {  "GL_SOURCE2_RGB", DAO_FLOAT, GL_SOURCE2_RGB},
  {  "GL_SPECULAR", DAO_FLOAT, GL_SPECULAR},
  {  "GL_SPHERE_MAP", DAO_FLOAT, GL_SPHERE_MAP},
  {  "GL_SPOT_CUTOFF", DAO_FLOAT, GL_SPOT_CUTOFF},
  {  "GL_SPOT_DIRECTION", DAO_FLOAT, GL_SPOT_DIRECTION},
  {  "GL_SPOT_EXPONENT", DAO_FLOAT, GL_SPOT_EXPONENT},
  {  "GL_SRC0_ALPHA", DAO_FLOAT, GL_SRC0_ALPHA},
  {  "GL_SRC0_RGB", DAO_FLOAT, GL_SRC0_RGB},
  {  "GL_SRC1_ALPHA", DAO_FLOAT, GL_SRC1_ALPHA},
  {  "GL_SRC1_RGB", DAO_FLOAT, GL_SRC1_RGB},
  {  "GL_SRC2_ALPHA", DAO_FLOAT, GL_SRC2_ALPHA},
  {  "GL_SRC2_RGB", DAO_FLOAT, GL_SRC2_RGB},
  {  "GL_SRC_ALPHA", DAO_FLOAT, GL_SRC_ALPHA},
  {  "GL_SRC_ALPHA_SATURATE", DAO_FLOAT, GL_SRC_ALPHA_SATURATE},
  {  "GL_SRC_COLOR", DAO_FLOAT, GL_SRC_COLOR},
  {  "GL_SRGB", DAO_FLOAT, GL_SRGB},
  {  "GL_SRGB8", DAO_FLOAT, GL_SRGB8},
  {  "GL_SRGB8_ALPHA8", DAO_FLOAT, GL_SRGB8_ALPHA8},
  {  "GL_SRGB_ALPHA", DAO_FLOAT, GL_SRGB_ALPHA},
  {  "GL_STACK_OVERFLOW", DAO_FLOAT, GL_STACK_OVERFLOW},
  {  "GL_STACK_UNDERFLOW", DAO_FLOAT, GL_STACK_UNDERFLOW},
  {  "GL_STATIC_COPY", DAO_FLOAT, GL_STATIC_COPY},
  {  "GL_STATIC_DRAW", DAO_FLOAT, GL_STATIC_DRAW},
  {  "GL_STATIC_READ", DAO_FLOAT, GL_STATIC_READ},
  {  "GL_STENCIL", DAO_FLOAT, GL_STENCIL},
  {  "GL_STENCIL_BACK_FAIL", DAO_FLOAT, GL_STENCIL_BACK_FAIL},
  {  "GL_STENCIL_BACK_FUNC", DAO_FLOAT, GL_STENCIL_BACK_FUNC},
  {  "GL_STENCIL_BACK_PASS_DEPTH_FAIL", DAO_FLOAT, GL_STENCIL_BACK_PASS_DEPTH_FAIL},
  {  "GL_STENCIL_BACK_PASS_DEPTH_PASS", DAO_FLOAT, GL_STENCIL_BACK_PASS_DEPTH_PASS},
  {  "GL_STENCIL_BACK_REF", DAO_FLOAT, GL_STENCIL_BACK_REF},
  {  "GL_STENCIL_BACK_VALUE_MASK", DAO_FLOAT, GL_STENCIL_BACK_VALUE_MASK},
  {  "GL_STENCIL_BACK_WRITEMASK", DAO_FLOAT, GL_STENCIL_BACK_WRITEMASK},
  {  "GL_STENCIL_BITS", DAO_FLOAT, GL_STENCIL_BITS},
  {  "GL_STENCIL_BUFFER_BIT", DAO_FLOAT, GL_STENCIL_BUFFER_BIT},
  {  "GL_STENCIL_CLEAR_VALUE", DAO_FLOAT, GL_STENCIL_CLEAR_VALUE},
  {  "GL_STENCIL_FAIL", DAO_FLOAT, GL_STENCIL_FAIL},
  {  "GL_STENCIL_FUNC", DAO_FLOAT, GL_STENCIL_FUNC},
  {  "GL_STENCIL_INDEX", DAO_FLOAT, GL_STENCIL_INDEX},
  {  "GL_STENCIL_PASS_DEPTH_FAIL", DAO_FLOAT, GL_STENCIL_PASS_DEPTH_FAIL},
  {  "GL_STENCIL_PASS_DEPTH_PASS", DAO_FLOAT, GL_STENCIL_PASS_DEPTH_PASS},
  {  "GL_STENCIL_REF", DAO_FLOAT, GL_STENCIL_REF},
  {  "GL_STENCIL_TEST", DAO_FLOAT, GL_STENCIL_TEST},
  {  "GL_STENCIL_VALUE_MASK", DAO_FLOAT, GL_STENCIL_VALUE_MASK},
  {  "GL_STENCIL_WRITEMASK", DAO_FLOAT, GL_STENCIL_WRITEMASK},
  {  "GL_STEREO", DAO_FLOAT, GL_STEREO},
  {  "GL_STREAM_COPY", DAO_FLOAT, GL_STREAM_COPY},
  {  "GL_STREAM_DRAW", DAO_FLOAT, GL_STREAM_DRAW},
  {  "GL_STREAM_READ", DAO_FLOAT, GL_STREAM_READ},
  {  "GL_SUBPIXEL_BITS", DAO_FLOAT, GL_SUBPIXEL_BITS},
  {  "GL_SUBTRACT", DAO_FLOAT, GL_SUBTRACT},
  {  "GL_T", DAO_FLOAT, GL_T},
  {  "GL_T2F_C3F_V3F", DAO_FLOAT, GL_T2F_C3F_V3F},
  {  "GL_T2F_C4F_N3F_V3F", DAO_FLOAT, GL_T2F_C4F_N3F_V3F},
  {  "GL_T2F_C4UB_V3F", DAO_FLOAT, GL_T2F_C4UB_V3F},
  {  "GL_T2F_N3F_V3F", DAO_FLOAT, GL_T2F_N3F_V3F},
  {  "GL_T2F_V3F", DAO_FLOAT, GL_T2F_V3F},
  {  "GL_T4F_C4F_N3F_V4F", DAO_FLOAT, GL_T4F_C4F_N3F_V4F},
  {  "GL_T4F_V4F", DAO_FLOAT, GL_T4F_V4F},
  {  "GL_TABLE_TOO_LARGE", DAO_FLOAT, GL_TABLE_TOO_LARGE},
  {  "GL_TEXTURE", DAO_FLOAT, GL_TEXTURE},
  {  "GL_TEXTURE0", DAO_FLOAT, GL_TEXTURE0},
  {  "GL_TEXTURE1", DAO_FLOAT, GL_TEXTURE1},
  {  "GL_TEXTURE10", DAO_FLOAT, GL_TEXTURE10},
  {  "GL_TEXTURE11", DAO_FLOAT, GL_TEXTURE11},
  {  "GL_TEXTURE12", DAO_FLOAT, GL_TEXTURE12},
  {  "GL_TEXTURE13", DAO_FLOAT, GL_TEXTURE13},
  {  "GL_TEXTURE14", DAO_FLOAT, GL_TEXTURE14},
  {  "GL_TEXTURE15", DAO_FLOAT, GL_TEXTURE15},
  {  "GL_TEXTURE16", DAO_FLOAT, GL_TEXTURE16},
  {  "GL_TEXTURE17", DAO_FLOAT, GL_TEXTURE17},
  {  "GL_TEXTURE18", DAO_FLOAT, GL_TEXTURE18},
  {  "GL_TEXTURE19", DAO_FLOAT, GL_TEXTURE19},
  {  "GL_TEXTURE2", DAO_FLOAT, GL_TEXTURE2},
  {  "GL_TEXTURE20", DAO_FLOAT, GL_TEXTURE20},
  {  "GL_TEXTURE21", DAO_FLOAT, GL_TEXTURE21},
  {  "GL_TEXTURE22", DAO_FLOAT, GL_TEXTURE22},
  {  "GL_TEXTURE23", DAO_FLOAT, GL_TEXTURE23},
  {  "GL_TEXTURE24", DAO_FLOAT, GL_TEXTURE24},
  {  "GL_TEXTURE25", DAO_FLOAT, GL_TEXTURE25},
  {  "GL_TEXTURE26", DAO_FLOAT, GL_TEXTURE26},
  {  "GL_TEXTURE27", DAO_FLOAT, GL_TEXTURE27},
  {  "GL_TEXTURE28", DAO_FLOAT, GL_TEXTURE28},
  {  "GL_TEXTURE29", DAO_FLOAT, GL_TEXTURE29},
  {  "GL_TEXTURE3", DAO_FLOAT, GL_TEXTURE3},
  {  "GL_TEXTURE30", DAO_FLOAT, GL_TEXTURE30},
  {  "GL_TEXTURE31", DAO_FLOAT, GL_TEXTURE31},
  {  "GL_TEXTURE4", DAO_FLOAT, GL_TEXTURE4},
  {  "GL_TEXTURE5", DAO_FLOAT, GL_TEXTURE5},
  {  "GL_TEXTURE6", DAO_FLOAT, GL_TEXTURE6},
  {  "GL_TEXTURE7", DAO_FLOAT, GL_TEXTURE7},
  {  "GL_TEXTURE8", DAO_FLOAT, GL_TEXTURE8},
  {  "GL_TEXTURE9", DAO_FLOAT, GL_TEXTURE9},
  {  "GL_TEXTURE_1D", DAO_FLOAT, GL_TEXTURE_1D},
  {  "GL_TEXTURE_2D", DAO_FLOAT, GL_TEXTURE_2D},
  {  "GL_TEXTURE_3D", DAO_FLOAT, GL_TEXTURE_3D},
  {  "GL_TEXTURE_ALPHA_SIZE", DAO_FLOAT, GL_TEXTURE_ALPHA_SIZE},
  {  "GL_TEXTURE_BASE_LEVEL", DAO_FLOAT, GL_TEXTURE_BASE_LEVEL},
  {  "GL_TEXTURE_BINDING_1D", DAO_FLOAT, GL_TEXTURE_BINDING_1D},
  {  "GL_TEXTURE_BINDING_2D", DAO_FLOAT, GL_TEXTURE_BINDING_2D},
  {  "GL_TEXTURE_BINDING_3D", DAO_FLOAT, GL_TEXTURE_BINDING_3D},
  {  "GL_TEXTURE_BINDING_CUBE_MAP", DAO_FLOAT, GL_TEXTURE_BINDING_CUBE_MAP},
  {  "GL_TEXTURE_BIT", DAO_FLOAT, GL_TEXTURE_BIT},
  {  "GL_TEXTURE_BLUE_SIZE", DAO_FLOAT, GL_TEXTURE_BLUE_SIZE},
  {  "GL_TEXTURE_BORDER", DAO_FLOAT, GL_TEXTURE_BORDER},
  {  "GL_TEXTURE_BORDER_COLOR", DAO_FLOAT, GL_TEXTURE_BORDER_COLOR},
  {  "GL_TEXTURE_COMPARE_FUNC", DAO_FLOAT, GL_TEXTURE_COMPARE_FUNC},
  {  "GL_TEXTURE_COMPARE_MODE", DAO_FLOAT, GL_TEXTURE_COMPARE_MODE},
  {  "GL_TEXTURE_COMPRESSED", DAO_FLOAT, GL_TEXTURE_COMPRESSED},
  {  "GL_TEXTURE_COMPRESSED_IMAGE_SIZE", DAO_FLOAT, GL_TEXTURE_COMPRESSED_IMAGE_SIZE},
  {  "GL_TEXTURE_COMPRESSION_HINT", DAO_FLOAT, GL_TEXTURE_COMPRESSION_HINT},
  {  "GL_TEXTURE_COORD_ARRAY", DAO_FLOAT, GL_TEXTURE_COORD_ARRAY},
  {  "GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING},
  {  "GL_TEXTURE_COORD_ARRAY_POINTER", DAO_FLOAT, GL_TEXTURE_COORD_ARRAY_POINTER},
  {  "GL_TEXTURE_COORD_ARRAY_SIZE", DAO_FLOAT, GL_TEXTURE_COORD_ARRAY_SIZE},
  {  "GL_TEXTURE_COORD_ARRAY_STRIDE", DAO_FLOAT, GL_TEXTURE_COORD_ARRAY_STRIDE},
  {  "GL_TEXTURE_COORD_ARRAY_TYPE", DAO_FLOAT, GL_TEXTURE_COORD_ARRAY_TYPE},
  {  "GL_TEXTURE_CUBE_MAP", DAO_FLOAT, GL_TEXTURE_CUBE_MAP},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_X", DAO_FLOAT, GL_TEXTURE_CUBE_MAP_NEGATIVE_X},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_Y", DAO_FLOAT, GL_TEXTURE_CUBE_MAP_NEGATIVE_Y},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_Z", DAO_FLOAT, GL_TEXTURE_CUBE_MAP_NEGATIVE_Z},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_X", DAO_FLOAT, GL_TEXTURE_CUBE_MAP_POSITIVE_X},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_Y", DAO_FLOAT, GL_TEXTURE_CUBE_MAP_POSITIVE_Y},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_Z", DAO_FLOAT, GL_TEXTURE_CUBE_MAP_POSITIVE_Z},
  {  "GL_TEXTURE_DEPTH", DAO_FLOAT, GL_TEXTURE_DEPTH},
  {  "GL_TEXTURE_DEPTH_SIZE", DAO_FLOAT, GL_TEXTURE_DEPTH_SIZE},
  {  "GL_TEXTURE_ENV", DAO_FLOAT, GL_TEXTURE_ENV},
  {  "GL_TEXTURE_ENV_COLOR", DAO_FLOAT, GL_TEXTURE_ENV_COLOR},
  {  "GL_TEXTURE_ENV_MODE", DAO_FLOAT, GL_TEXTURE_ENV_MODE},
  {  "GL_TEXTURE_FILTER_CONTROL", DAO_FLOAT, GL_TEXTURE_FILTER_CONTROL},
  {  "GL_TEXTURE_GEN_MODE", DAO_FLOAT, GL_TEXTURE_GEN_MODE},
  {  "GL_TEXTURE_GEN_Q", DAO_FLOAT, GL_TEXTURE_GEN_Q},
  {  "GL_TEXTURE_GEN_R", DAO_FLOAT, GL_TEXTURE_GEN_R},
  {  "GL_TEXTURE_GEN_S", DAO_FLOAT, GL_TEXTURE_GEN_S},
  {  "GL_TEXTURE_GEN_T", DAO_FLOAT, GL_TEXTURE_GEN_T},
  {  "GL_TEXTURE_GREEN_SIZE", DAO_FLOAT, GL_TEXTURE_GREEN_SIZE},
  {  "GL_TEXTURE_HEIGHT", DAO_FLOAT, GL_TEXTURE_HEIGHT},
  {  "GL_TEXTURE_INTENSITY_SIZE", DAO_FLOAT, GL_TEXTURE_INTENSITY_SIZE},
  {  "GL_TEXTURE_INTERNAL_FORMAT", DAO_FLOAT, GL_TEXTURE_INTERNAL_FORMAT},
  {  "GL_TEXTURE_LOD_BIAS", DAO_FLOAT, GL_TEXTURE_LOD_BIAS},
  {  "GL_TEXTURE_LUMINANCE_SIZE", DAO_FLOAT, GL_TEXTURE_LUMINANCE_SIZE},
  {  "GL_TEXTURE_MAG_FILTER", DAO_FLOAT, GL_TEXTURE_MAG_FILTER},
  {  "GL_TEXTURE_MATRIX", DAO_FLOAT, GL_TEXTURE_MATRIX},
  {  "GL_TEXTURE_MAX_LEVEL", DAO_FLOAT, GL_TEXTURE_MAX_LEVEL},
  {  "GL_TEXTURE_MAX_LOD", DAO_FLOAT, GL_TEXTURE_MAX_LOD},
  {  "GL_TEXTURE_MIN_FILTER", DAO_FLOAT, GL_TEXTURE_MIN_FILTER},
  {  "GL_TEXTURE_MIN_LOD", DAO_FLOAT, GL_TEXTURE_MIN_LOD},
  {  "GL_TEXTURE_PRIORITY", DAO_FLOAT, GL_TEXTURE_PRIORITY},
  {  "GL_TEXTURE_RED_SIZE", DAO_FLOAT, GL_TEXTURE_RED_SIZE},
  {  "GL_TEXTURE_RESIDENT", DAO_FLOAT, GL_TEXTURE_RESIDENT},
  {  "GL_TEXTURE_STACK_DEPTH", DAO_FLOAT, GL_TEXTURE_STACK_DEPTH},
  {  "GL_TEXTURE_WIDTH", DAO_FLOAT, GL_TEXTURE_WIDTH},
  {  "GL_TEXTURE_WRAP_R", DAO_FLOAT, GL_TEXTURE_WRAP_R},
  {  "GL_TEXTURE_WRAP_S", DAO_FLOAT, GL_TEXTURE_WRAP_S},
  {  "GL_TEXTURE_WRAP_T", DAO_FLOAT, GL_TEXTURE_WRAP_T},
  {  "GL_TRANSFORM_BIT", DAO_FLOAT, GL_TRANSFORM_BIT},
  {  "GL_TRANSPOSE_COLOR_MATRIX", DAO_FLOAT, GL_TRANSPOSE_COLOR_MATRIX},
  {  "GL_TRANSPOSE_MODELVIEW_MATRIX", DAO_FLOAT, GL_TRANSPOSE_MODELVIEW_MATRIX},
  {  "GL_TRANSPOSE_PROJECTION_MATRIX", DAO_FLOAT, GL_TRANSPOSE_PROJECTION_MATRIX},
  {  "GL_TRANSPOSE_TEXTURE_MATRIX", DAO_FLOAT, GL_TRANSPOSE_TEXTURE_MATRIX},
  {  "GL_TRIANGLES", DAO_FLOAT, GL_TRIANGLES},
  {  "GL_TRIANGLE_FAN", DAO_FLOAT, GL_TRIANGLE_FAN},
  {  "GL_TRIANGLE_STRIP", DAO_FLOAT, GL_TRIANGLE_STRIP},
  {  "GL_TRUE", DAO_FLOAT, GL_TRUE},
  {  "GL_UNPACK_ALIGNMENT", DAO_FLOAT, GL_UNPACK_ALIGNMENT},
  {  "GL_UNPACK_IMAGE_HEIGHT", DAO_FLOAT, GL_UNPACK_IMAGE_HEIGHT},
  {  "GL_UNPACK_LSB_FIRST", DAO_FLOAT, GL_UNPACK_LSB_FIRST},
  {  "GL_UNPACK_ROW_LENGTH", DAO_FLOAT, GL_UNPACK_ROW_LENGTH},
  {  "GL_UNPACK_SKIP_IMAGES", DAO_FLOAT, GL_UNPACK_SKIP_IMAGES},
  {  "GL_UNPACK_SKIP_PIXELS", DAO_FLOAT, GL_UNPACK_SKIP_PIXELS},
  {  "GL_UNPACK_SKIP_ROWS", DAO_FLOAT, GL_UNPACK_SKIP_ROWS},
  {  "GL_UNPACK_SWAP_BYTES", DAO_FLOAT, GL_UNPACK_SWAP_BYTES},
  {  "GL_UNSIGNED_BYTE", DAO_FLOAT, GL_UNSIGNED_BYTE},
  {  "GL_UNSIGNED_BYTE_2_3_3_REV", DAO_FLOAT, GL_UNSIGNED_BYTE_2_3_3_REV},
  {  "GL_UNSIGNED_BYTE_3_3_2", DAO_FLOAT, GL_UNSIGNED_BYTE_3_3_2},
  {  "GL_UNSIGNED_INT", DAO_FLOAT, GL_UNSIGNED_INT},
  {  "GL_UNSIGNED_INT_10_10_10_2", DAO_FLOAT, GL_UNSIGNED_INT_10_10_10_2},
  {  "GL_UNSIGNED_INT_2_10_10_10_REV", DAO_FLOAT, GL_UNSIGNED_INT_2_10_10_10_REV},
  {  "GL_UNSIGNED_INT_8_8_8_8", DAO_FLOAT, GL_UNSIGNED_INT_8_8_8_8},
  {  "GL_UNSIGNED_INT_8_8_8_8_REV", DAO_FLOAT, GL_UNSIGNED_INT_8_8_8_8_REV},
  {  "GL_UNSIGNED_SHORT", DAO_FLOAT, GL_UNSIGNED_SHORT},
  {  "GL_UNSIGNED_SHORT_1_5_5_5_REV", DAO_FLOAT, GL_UNSIGNED_SHORT_1_5_5_5_REV},
  {  "GL_UNSIGNED_SHORT_4_4_4_4", DAO_FLOAT, GL_UNSIGNED_SHORT_4_4_4_4},
  {  "GL_UNSIGNED_SHORT_4_4_4_4_REV", DAO_FLOAT, GL_UNSIGNED_SHORT_4_4_4_4_REV},
  {  "GL_UNSIGNED_SHORT_5_5_5_1", DAO_FLOAT, GL_UNSIGNED_SHORT_5_5_5_1},
  {  "GL_UNSIGNED_SHORT_5_6_5", DAO_FLOAT, GL_UNSIGNED_SHORT_5_6_5},
  {  "GL_UNSIGNED_SHORT_5_6_5_REV", DAO_FLOAT, GL_UNSIGNED_SHORT_5_6_5_REV},
  {  "GL_UPPER_LEFT", DAO_FLOAT, GL_UPPER_LEFT},
  {  "GL_V2F", DAO_FLOAT, GL_V2F},
  {  "GL_V3F", DAO_FLOAT, GL_V3F},
  {  "GL_VALIDATE_STATUS", DAO_FLOAT, GL_VALIDATE_STATUS},
  {  "GL_VENDOR", DAO_FLOAT, GL_VENDOR},
  {  "GL_VERSION", DAO_FLOAT, GL_VERSION},
  {  "GL_VERSION_1_1", DAO_FLOAT, GL_VERSION_1_1},
  {  "GL_VERSION_1_2", DAO_FLOAT, GL_VERSION_1_2},
  {  "GL_VERSION_1_3", DAO_FLOAT, GL_VERSION_1_3},
  {  "GL_VERSION_1_4", DAO_FLOAT, GL_VERSION_1_4},
  {  "GL_VERSION_1_5", DAO_FLOAT, GL_VERSION_1_5},
  {  "GL_VERSION_2_0", DAO_FLOAT, GL_VERSION_2_0},
  {  "GL_VERSION_2_1", DAO_FLOAT, GL_VERSION_2_1},
  {  "GL_VERTEX_ARRAY", DAO_FLOAT, GL_VERTEX_ARRAY},
  {  "GL_VERTEX_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_VERTEX_ARRAY_BUFFER_BINDING},
  {  "GL_VERTEX_ARRAY_POINTER", DAO_FLOAT, GL_VERTEX_ARRAY_POINTER},
  {  "GL_VERTEX_ARRAY_SIZE", DAO_FLOAT, GL_VERTEX_ARRAY_SIZE},
  {  "GL_VERTEX_ARRAY_STRIDE", DAO_FLOAT, GL_VERTEX_ARRAY_STRIDE},
  {  "GL_VERTEX_ARRAY_TYPE", DAO_FLOAT, GL_VERTEX_ARRAY_TYPE},
  {  "GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING},
  {  "GL_VERTEX_ATTRIB_ARRAY_ENABLED", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_ENABLED},
  {  "GL_VERTEX_ATTRIB_ARRAY_NORMALIZED", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED},
  {  "GL_VERTEX_ATTRIB_ARRAY_POINTER", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_POINTER},
  {  "GL_VERTEX_ATTRIB_ARRAY_SIZE", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_SIZE},
  {  "GL_VERTEX_ATTRIB_ARRAY_STRIDE", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_STRIDE},
  {  "GL_VERTEX_ATTRIB_ARRAY_TYPE", DAO_FLOAT, GL_VERTEX_ATTRIB_ARRAY_TYPE},
  {  "GL_VERTEX_PROGRAM_POINT_SIZE", DAO_FLOAT, GL_VERTEX_PROGRAM_POINT_SIZE},
  {  "GL_VERTEX_PROGRAM_TWO_SIDE", DAO_FLOAT, GL_VERTEX_PROGRAM_TWO_SIDE},
  {  "GL_VERTEX_SHADER", DAO_FLOAT, GL_VERTEX_SHADER},
  {  "GL_VIEWPORT", DAO_FLOAT, GL_VIEWPORT},
  {  "GL_VIEWPORT_BIT", DAO_FLOAT, GL_VIEWPORT_BIT},
  {  "GL_WEIGHT_ARRAY_BUFFER_BINDING", DAO_FLOAT, GL_WEIGHT_ARRAY_BUFFER_BINDING},
  {  "GL_WRITE_ONLY", DAO_FLOAT, GL_WRITE_ONLY},
  {  "GL_XOR", DAO_FLOAT, GL_XOR},
  {  "GL_ZERO", DAO_FLOAT, GL_ZERO},
  {  "GL_ZOOM_X", DAO_FLOAT, GL_ZOOM_X},
  {  "GL_ZOOM_Y", DAO_FLOAT, GL_ZOOM_Y},
  { NULL, 0, 0 }
};
