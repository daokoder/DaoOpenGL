...
static void dao__glSamplePass( DaoProcess *_proc, DaoValue *_p[], int _n );
...
static DaoFuncItem dao__Funcs[] = 
{
  ...
  { dao__glSamplePass, "glSamplePass( pass :int )" },
  ...
  { dao__glMultiTexCoord4i, "glMultiTexCoord4i( target :int, _p1 :int, s :int, t :int, r :int )" },
...
static void dao__glGetString( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  DaoProcess_PutMBString( _proc, (char*) _glGetString );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glGetTexEnvfv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static void dao__glSamplePass( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  unsigned int pass = (unsigned int) DaoValue_TryGetInteger( _p[0] );
...
static void dao__glMultiTexCoord4i( DaoProcess *_proc, DaoValue *_p[], int _n )
{
  ...
  int s = (int) DaoValue_TryGetInteger( _p[2] );
  int t = (int) DaoValue_TryGetInteger( _p[3] );
  int r = (int) DaoValue_TryGetInteger( _p[4] );

  glMultiTexCoord4i( target, _p1, s, t, r );
}
/* /System/Library/Frameworks/OpenGL.framework/Headers/gl.h */
static void dao__glMultiTexCoord4iv( DaoProcess *_proc, DaoValue *_p[], int _n )
{
...
static DaoNumItem dao__Nums[] = 
{
  ...
  {  "GL_ABGR_EXT", DAO_DOUBLE, GL_ABGR_EXT},
  ...
  {  "GL_ACTIVE_STENCIL_FACE_EXT", DAO_DOUBLE, GL_ACTIVE_STENCIL_FACE_EXT},
  {  "GL_ACTIVE_TEXTURE", DAO_DOUBLE, GL_ACTIVE_TEXTURE},
  {  "GL_ACTIVE_TEXTURE_ARB", DAO_DOUBLE, GL_ACTIVE_TEXTURE_ARB},
  {  "GL_ACTIVE_UNIFORMS", DAO_DOUBLE, GL_ACTIVE_UNIFORMS},
  {  "GL_ACTIVE_UNIFORM_MAX_LENGTH", DAO_DOUBLE, GL_ACTIVE_UNIFORM_MAX_LENGTH},
  {  "GL_ACTIVE_VERTEX_UNITS_ARB", DAO_DOUBLE, GL_ACTIVE_VERTEX_UNITS_ARB},
  {  "GL_ADD", DAO_DOUBLE, GL_ADD},
  {  "GL_ADD_SIGNED", DAO_DOUBLE, GL_ADD_SIGNED},
  {  "GL_ADD_SIGNED_ARB", DAO_DOUBLE, GL_ADD_SIGNED_ARB},
  ...
  {  "GL_ALPHA16F_ARB", DAO_DOUBLE, GL_ALPHA16F_ARB},
  {  "GL_ALPHA16I_EXT", DAO_DOUBLE, GL_ALPHA16I_EXT},
  {  "GL_ALPHA16UI_EXT", DAO_DOUBLE, GL_ALPHA16UI_EXT},
  {  "GL_ALPHA32F_ARB", DAO_DOUBLE, GL_ALPHA32F_ARB},
  {  "GL_ALPHA32I_EXT", DAO_DOUBLE, GL_ALPHA32I_EXT},
  {  "GL_ALPHA32UI_EXT", DAO_DOUBLE, GL_ALPHA32UI_EXT},
  {  "GL_ALPHA4", DAO_DOUBLE, GL_ALPHA4},
  {  "GL_ALPHA8", DAO_DOUBLE, GL_ALPHA8},
  {  "GL_ALPHA8I_EXT", DAO_DOUBLE, GL_ALPHA8I_EXT},
  {  "GL_ALPHA8UI_EXT", DAO_DOUBLE, GL_ALPHA8UI_EXT},
  {  "GL_ALPHA_BIAS", DAO_DOUBLE, GL_ALPHA_BIAS},
  {  "GL_ALPHA_BITS", DAO_DOUBLE, GL_ALPHA_BITS},
  {  "GL_ALPHA_BLEND_EQUATION_ATI", DAO_DOUBLE, GL_ALPHA_BLEND_EQUATION_ATI},
  {  "GL_ALPHA_FLOAT16_APPLE", DAO_DOUBLE, GL_ALPHA_FLOAT16_APPLE},
  {  "GL_ALPHA_FLOAT16_ATI", DAO_DOUBLE, GL_ALPHA_FLOAT16_ATI},
  {  "GL_ALPHA_FLOAT32_APPLE", DAO_DOUBLE, GL_ALPHA_FLOAT32_APPLE},
  {  "GL_ALPHA_FLOAT32_ATI", DAO_DOUBLE, GL_ALPHA_FLOAT32_ATI},
  {  "GL_ALPHA_INTEGER_EXT", DAO_DOUBLE, GL_ALPHA_INTEGER_EXT},
  ...
  {  "GL_APPLE_aux_depth_stencil", DAO_DOUBLE, GL_APPLE_aux_depth_stencil},
  {  "GL_APPLE_client_storage", DAO_DOUBLE, GL_APPLE_client_storage},
  {  "GL_APPLE_element_array", DAO_DOUBLE, GL_APPLE_element_array},
  {  "GL_APPLE_fence", DAO_DOUBLE, GL_APPLE_fence},
  {  "GL_APPLE_float_pixels", DAO_DOUBLE, GL_APPLE_float_pixels},
  {  "GL_APPLE_flush_buffer_range", DAO_DOUBLE, GL_APPLE_flush_buffer_range},
  {  "GL_APPLE_flush_render", DAO_DOUBLE, GL_APPLE_flush_render},
  {  "GL_APPLE_object_purgeable", DAO_DOUBLE, GL_APPLE_object_purgeable},
  {  "GL_APPLE_packed_pixels", DAO_DOUBLE, GL_APPLE_packed_pixels},
  {  "GL_APPLE_pixel_buffer", DAO_DOUBLE, GL_APPLE_pixel_buffer},
  {  "GL_APPLE_row_bytes", DAO_DOUBLE, GL_APPLE_row_bytes},
  {  "GL_APPLE_specular_vector", DAO_DOUBLE, GL_APPLE_specular_vector},
  {  "GL_APPLE_texture_range", DAO_DOUBLE, GL_APPLE_texture_range},
  {  "GL_APPLE_transform_hint", DAO_DOUBLE, GL_APPLE_transform_hint},
  {  "GL_APPLE_vertex_array_object", DAO_DOUBLE, GL_APPLE_vertex_array_object},
  {  "GL_APPLE_vertex_array_range", DAO_DOUBLE, GL_APPLE_vertex_array_range},
  {  "GL_APPLE_vertex_program_evaluators", DAO_DOUBLE, GL_APPLE_vertex_program_evaluators},
  {  "GL_APPLE_ycbcr_422", DAO_DOUBLE, GL_APPLE_ycbcr_422},
  {  "GL_ARB_depth_texture", DAO_DOUBLE, GL_ARB_depth_texture},
  {  "GL_ARB_draw_buffers", DAO_DOUBLE, GL_ARB_draw_buffers},
  {  "GL_ARB_fragment_program", DAO_DOUBLE, GL_ARB_fragment_program},
  {  "GL_ARB_fragment_program_shadow", DAO_DOUBLE, GL_ARB_fragment_program_shadow},
  {  "GL_ARB_fragment_shader", DAO_DOUBLE, GL_ARB_fragment_shader},
  {  "GL_ARB_half_float_pixel", DAO_DOUBLE, GL_ARB_half_float_pixel},
  {  "GL_ARB_imaging", DAO_DOUBLE, GL_ARB_imaging},
  {  "GL_ARB_multisample", DAO_DOUBLE, GL_ARB_multisample},
  {  "GL_ARB_multitexture", DAO_DOUBLE, GL_ARB_multitexture},
  {  "GL_ARB_occlusion_query", DAO_DOUBLE, GL_ARB_occlusion_query},
  {  "GL_ARB_pixel_buffer_object", DAO_DOUBLE, GL_ARB_pixel_buffer_object},
  {  "GL_ARB_point_parameters", DAO_DOUBLE, GL_ARB_point_parameters},
  {  "GL_ARB_point_sprite", DAO_DOUBLE, GL_ARB_point_sprite},
  {  "GL_ARB_shader_objects", DAO_DOUBLE, GL_ARB_shader_objects},
  {  "GL_ARB_shader_texture_lod", DAO_DOUBLE, GL_ARB_shader_texture_lod},
  {  "GL_ARB_shading_language_100", DAO_DOUBLE, GL_ARB_shading_language_100},
  {  "GL_ARB_shadow", DAO_DOUBLE, GL_ARB_shadow},
  {  "GL_ARB_shadow_ambient", DAO_DOUBLE, GL_ARB_shadow_ambient},
  {  "GL_ARB_texture_border_clamp", DAO_DOUBLE, GL_ARB_texture_border_clamp},
  {  "GL_ARB_texture_compression", DAO_DOUBLE, GL_ARB_texture_compression},
  {  "GL_ARB_texture_cube_map", DAO_DOUBLE, GL_ARB_texture_cube_map},
  {  "GL_ARB_texture_env_add", DAO_DOUBLE, GL_ARB_texture_env_add},
  {  "GL_ARB_texture_env_combine", DAO_DOUBLE, GL_ARB_texture_env_combine},
  {  "GL_ARB_texture_env_crossbar", DAO_DOUBLE, GL_ARB_texture_env_crossbar},
  {  "GL_ARB_texture_env_dot3", DAO_DOUBLE, GL_ARB_texture_env_dot3},
  {  "GL_ARB_texture_float", DAO_DOUBLE, GL_ARB_texture_float},
  {  "GL_ARB_texture_mirrored_repeat", DAO_DOUBLE, GL_ARB_texture_mirrored_repeat},
  {  "GL_ARB_texture_non_power_of_two", DAO_DOUBLE, GL_ARB_texture_non_power_of_two},
  {  "GL_ARB_texture_rectangle", DAO_DOUBLE, GL_ARB_texture_rectangle},
  {  "GL_ARB_transpose_matrix", DAO_DOUBLE, GL_ARB_transpose_matrix},
  {  "GL_ARB_vertex_blend", DAO_DOUBLE, GL_ARB_vertex_blend},
  {  "GL_ARB_vertex_buffer_object", DAO_DOUBLE, GL_ARB_vertex_buffer_object},
  {  "GL_ARB_vertex_program", DAO_DOUBLE, GL_ARB_vertex_program},
  {  "GL_ARB_vertex_shader", DAO_DOUBLE, GL_ARB_vertex_shader},
  {  "GL_ARB_window_pos", DAO_DOUBLE, GL_ARB_window_pos},
  {  "GL_ARRAY_BUFFER", DAO_DOUBLE, GL_ARRAY_BUFFER},
  {  "GL_ARRAY_BUFFER_ARB", DAO_DOUBLE, GL_ARRAY_BUFFER_ARB},
  {  "GL_ARRAY_BUFFER_BINDING", DAO_DOUBLE, GL_ARRAY_BUFFER_BINDING},
  {  "GL_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_ARRAY_ELEMENT_LOCK_COUNT_EXT", DAO_DOUBLE, GL_ARRAY_ELEMENT_LOCK_COUNT_EXT},
  {  "GL_ARRAY_ELEMENT_LOCK_FIRST_EXT", DAO_DOUBLE, GL_ARRAY_ELEMENT_LOCK_FIRST_EXT},
  {  "GL_ARRAY_REV_COMPS_IN_4_BYTES_ATI", DAO_DOUBLE, GL_ARRAY_REV_COMPS_IN_4_BYTES_ATI},
  {  "GL_ATIX_pn_triangles", DAO_DOUBLE, GL_ATIX_pn_triangles},
  {  "GL_ATI_array_rev_comps_in_4_bytes", DAO_DOUBLE, GL_ATI_array_rev_comps_in_4_bytes},
  {  "GL_ATI_blend_equation_separate", DAO_DOUBLE, GL_ATI_blend_equation_separate},
  {  "GL_ATI_blend_weighted_minmax", DAO_DOUBLE, GL_ATI_blend_weighted_minmax},
  {  "GL_ATI_pn_triangles", DAO_DOUBLE, GL_ATI_pn_triangles},
  {  "GL_ATI_point_cull_mode", DAO_DOUBLE, GL_ATI_point_cull_mode},
  {  "GL_ATI_separate_stencil", DAO_DOUBLE, GL_ATI_separate_stencil},
  {  "GL_ATI_text_fragment_shader", DAO_DOUBLE, GL_ATI_text_fragment_shader},
  {  "GL_ATI_texture_compression_3dc", DAO_DOUBLE, GL_ATI_texture_compression_3dc},
  {  "GL_ATI_texture_env_combine3", DAO_DOUBLE, GL_ATI_texture_env_combine3},
  {  "GL_ATI_texture_float", DAO_DOUBLE, GL_ATI_texture_float},
  {  "GL_ATI_texture_mirror_once", DAO_DOUBLE, GL_ATI_texture_mirror_once},
  ...
  {  "GL_AUX_DEPTH_STENCIL_APPLE", DAO_DOUBLE, GL_AUX_DEPTH_STENCIL_APPLE},
  ...
  {  "GL_BGRA_EXT", DAO_DOUBLE, GL_BGRA_EXT},
  {  "GL_BGRA_INTEGER_EXT", DAO_DOUBLE, GL_BGRA_INTEGER_EXT},
  {  "GL_BGR_EXT", DAO_DOUBLE, GL_BGR_EXT},
  {  "GL_BGR_INTEGER_EXT", DAO_DOUBLE, GL_BGR_INTEGER_EXT},
  {  "GL_BIAS_BY_NEGATIVE_ONE_HALF_NV", DAO_DOUBLE, GL_BIAS_BY_NEGATIVE_ONE_HALF_NV},
  ...
  {  "GL_BLEND_COLOR_EXT", DAO_DOUBLE, GL_BLEND_COLOR_EXT},
  {  "GL_BLEND_DST", DAO_DOUBLE, GL_BLEND_DST},
  {  "GL_BLEND_DST_ALPHA", DAO_DOUBLE, GL_BLEND_DST_ALPHA},
  {  "GL_BLEND_DST_ALPHA_EXT", DAO_DOUBLE, GL_BLEND_DST_ALPHA_EXT},
  {  "GL_BLEND_DST_RGB", DAO_DOUBLE, GL_BLEND_DST_RGB},
  {  "GL_BLEND_DST_RGB_EXT", DAO_DOUBLE, GL_BLEND_DST_RGB_EXT},
  {  "GL_BLEND_EQUATION", DAO_DOUBLE, GL_BLEND_EQUATION},
  {  "GL_BLEND_EQUATION_ALPHA", DAO_DOUBLE, GL_BLEND_EQUATION_ALPHA},
  {  "GL_BLEND_EQUATION_ALPHA_EXT", DAO_DOUBLE, GL_BLEND_EQUATION_ALPHA_EXT},
  {  "GL_BLEND_EQUATION_EXT", DAO_DOUBLE, GL_BLEND_EQUATION_EXT},
  {  "GL_BLEND_EQUATION_RGB", DAO_DOUBLE, GL_BLEND_EQUATION_RGB},
  {  "GL_BLEND_EQUATION_RGB_EXT", DAO_DOUBLE, GL_BLEND_EQUATION_RGB_EXT},
  {  "GL_BLEND_SRC", DAO_DOUBLE, GL_BLEND_SRC},
  {  "GL_BLEND_SRC_ALPHA", DAO_DOUBLE, GL_BLEND_SRC_ALPHA},
  {  "GL_BLEND_SRC_ALPHA_EXT", DAO_DOUBLE, GL_BLEND_SRC_ALPHA_EXT},
  {  "GL_BLEND_SRC_RGB", DAO_DOUBLE, GL_BLEND_SRC_RGB},
  {  "GL_BLEND_SRC_RGB_EXT", DAO_DOUBLE, GL_BLEND_SRC_RGB_EXT},
  {  "GL_BLUE", DAO_DOUBLE, GL_BLUE},
  {  "GL_BLUE_BIAS", DAO_DOUBLE, GL_BLUE_BIAS},
  {  "GL_BLUE_BITS", DAO_DOUBLE, GL_BLUE_BITS},
  {  "GL_BLUE_INTEGER_EXT", DAO_DOUBLE, GL_BLUE_INTEGER_EXT},
  {  "GL_BLUE_SCALE", DAO_DOUBLE, GL_BLUE_SCALE},
  {  "GL_BOOL", DAO_DOUBLE, GL_BOOL},
  {  "GL_BOOL_ARB", DAO_DOUBLE, GL_BOOL_ARB},
  {  "GL_BOOL_VEC2", DAO_DOUBLE, GL_BOOL_VEC2},
  {  "GL_BOOL_VEC2_ARB", DAO_DOUBLE, GL_BOOL_VEC2_ARB},
  {  "GL_BOOL_VEC3", DAO_DOUBLE, GL_BOOL_VEC3},
  {  "GL_BOOL_VEC3_ARB", DAO_DOUBLE, GL_BOOL_VEC3_ARB},
  {  "GL_BOOL_VEC4", DAO_DOUBLE, GL_BOOL_VEC4},
  {  "GL_BOOL_VEC4_ARB", DAO_DOUBLE, GL_BOOL_VEC4_ARB},
  {  "GL_BUFFER_ACCESS", DAO_DOUBLE, GL_BUFFER_ACCESS},
  {  "GL_BUFFER_ACCESS_ARB", DAO_DOUBLE, GL_BUFFER_ACCESS_ARB},
  {  "GL_BUFFER_FLUSHING_UNMAP_APPLE", DAO_DOUBLE, GL_BUFFER_FLUSHING_UNMAP_APPLE},
  {  "GL_BUFFER_MAPPED", DAO_DOUBLE, GL_BUFFER_MAPPED},
  {  "GL_BUFFER_MAPPED_ARB", DAO_DOUBLE, GL_BUFFER_MAPPED_ARB},
  {  "GL_BUFFER_MAP_POINTER", DAO_DOUBLE, GL_BUFFER_MAP_POINTER},
  {  "GL_BUFFER_MAP_POINTER_ARB", DAO_DOUBLE, GL_BUFFER_MAP_POINTER_ARB},
  {  "GL_BUFFER_OBJECT_APPLE", DAO_DOUBLE, GL_BUFFER_OBJECT_APPLE},
  {  "GL_BUFFER_SERIALIZED_MODIFY_APPLE", DAO_DOUBLE, GL_BUFFER_SERIALIZED_MODIFY_APPLE},
  {  "GL_BUFFER_SIZE", DAO_DOUBLE, GL_BUFFER_SIZE},
  {  "GL_BUFFER_SIZE_ARB", DAO_DOUBLE, GL_BUFFER_SIZE_ARB},
  {  "GL_BUFFER_USAGE", DAO_DOUBLE, GL_BUFFER_USAGE},
  {  "GL_BUFFER_USAGE_ARB", DAO_DOUBLE, GL_BUFFER_USAGE_ARB},
  ...
  {  "GL_CLAMP_TO_BORDER_ARB", DAO_DOUBLE, GL_CLAMP_TO_BORDER_ARB},
  {  "GL_CLAMP_TO_EDGE", DAO_DOUBLE, GL_CLAMP_TO_EDGE},
  {  "GL_CLAMP_TO_EDGE_SGIS", DAO_DOUBLE, GL_CLAMP_TO_EDGE_SGIS},
  {  "GL_CLEAR", DAO_DOUBLE, GL_CLEAR},
  {  "GL_CLIENT_ACTIVE_TEXTURE", DAO_DOUBLE, GL_CLIENT_ACTIVE_TEXTURE},
  {  "GL_CLIENT_ACTIVE_TEXTURE_ARB", DAO_DOUBLE, GL_CLIENT_ACTIVE_TEXTURE_ARB},
  ...
  {  "GL_CLIP_VOLUME_CLIPPING_HINT_EXT", DAO_DOUBLE, GL_CLIP_VOLUME_CLIPPING_HINT_EXT},
  ...
  {  "GL_COLOR_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_COLOR_ARRAY_BUFFER_BINDING_ARB},
  ...
  {  "GL_COLOR_ATTACHMENT0_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT0_EXT},
  {  "GL_COLOR_ATTACHMENT10_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT10_EXT},
  {  "GL_COLOR_ATTACHMENT11_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT11_EXT},
  {  "GL_COLOR_ATTACHMENT12_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT12_EXT},
  {  "GL_COLOR_ATTACHMENT13_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT13_EXT},
  {  "GL_COLOR_ATTACHMENT14_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT14_EXT},
  {  "GL_COLOR_ATTACHMENT15_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT15_EXT},
  {  "GL_COLOR_ATTACHMENT1_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT1_EXT},
  {  "GL_COLOR_ATTACHMENT2_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT2_EXT},
  {  "GL_COLOR_ATTACHMENT3_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT3_EXT},
  {  "GL_COLOR_ATTACHMENT4_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT4_EXT},
  {  "GL_COLOR_ATTACHMENT5_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT5_EXT},
  {  "GL_COLOR_ATTACHMENT6_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT6_EXT},
  {  "GL_COLOR_ATTACHMENT7_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT7_EXT},
  {  "GL_COLOR_ATTACHMENT8_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT8_EXT},
  {  "GL_COLOR_ATTACHMENT9_EXT", DAO_DOUBLE, GL_COLOR_ATTACHMENT9_EXT},
  {  "GL_COLOR_BUFFER_BIT", DAO_DOUBLE, GL_COLOR_BUFFER_BIT},
  {  "GL_COLOR_CLEAR_VALUE", DAO_DOUBLE, GL_COLOR_CLEAR_VALUE},
  {  "GL_COLOR_FLOAT_APPLE", DAO_DOUBLE, GL_COLOR_FLOAT_APPLE},
  {  "GL_COLOR_INDEX", DAO_DOUBLE, GL_COLOR_INDEX},
  {  "GL_COLOR_INDEX12_EXT", DAO_DOUBLE, GL_COLOR_INDEX12_EXT},
  {  "GL_COLOR_INDEX16_EXT", DAO_DOUBLE, GL_COLOR_INDEX16_EXT},
  {  "GL_COLOR_INDEX1_EXT", DAO_DOUBLE, GL_COLOR_INDEX1_EXT},
  {  "GL_COLOR_INDEX2_EXT", DAO_DOUBLE, GL_COLOR_INDEX2_EXT},
  {  "GL_COLOR_INDEX4_EXT", DAO_DOUBLE, GL_COLOR_INDEX4_EXT},
  {  "GL_COLOR_INDEX8_EXT", DAO_DOUBLE, GL_COLOR_INDEX8_EXT},
  ...
  {  "GL_COLOR_MATRIX_SGI", DAO_DOUBLE, GL_COLOR_MATRIX_SGI},
  {  "GL_COLOR_MATRIX_STACK_DEPTH", DAO_DOUBLE, GL_COLOR_MATRIX_STACK_DEPTH},
  {  "GL_COLOR_MATRIX_STACK_DEPTH_SGI", DAO_DOUBLE, GL_COLOR_MATRIX_STACK_DEPTH_SGI},
  {  "GL_COLOR_SUM", DAO_DOUBLE, GL_COLOR_SUM},
  {  "GL_COLOR_SUM_ARB", DAO_DOUBLE, GL_COLOR_SUM_ARB},
  {  "GL_COLOR_SUM_CLAMP_NV", DAO_DOUBLE, GL_COLOR_SUM_CLAMP_NV},
  {  "GL_COLOR_SUM_EXT", DAO_DOUBLE, GL_COLOR_SUM_EXT},
  ...
  {  "GL_COMBINER0_NV", DAO_DOUBLE, GL_COMBINER0_NV},
  {  "GL_COMBINER1_NV", DAO_DOUBLE, GL_COMBINER1_NV},
  {  "GL_COMBINER2_NV", DAO_DOUBLE, GL_COMBINER2_NV},
  {  "GL_COMBINER3_NV", DAO_DOUBLE, GL_COMBINER3_NV},
  {  "GL_COMBINER4_NV", DAO_DOUBLE, GL_COMBINER4_NV},
  {  "GL_COMBINER5_NV", DAO_DOUBLE, GL_COMBINER5_NV},
  {  "GL_COMBINER6_NV", DAO_DOUBLE, GL_COMBINER6_NV},
  {  "GL_COMBINER7_NV", DAO_DOUBLE, GL_COMBINER7_NV},
  {  "GL_COMBINER_AB_DOT_PRODUCT_NV", DAO_DOUBLE, GL_COMBINER_AB_DOT_PRODUCT_NV},
  {  "GL_COMBINER_AB_OUTPUT_NV", DAO_DOUBLE, GL_COMBINER_AB_OUTPUT_NV},
  {  "GL_COMBINER_BIAS_NV", DAO_DOUBLE, GL_COMBINER_BIAS_NV},
  {  "GL_COMBINER_CD_DOT_PRODUCT_NV", DAO_DOUBLE, GL_COMBINER_CD_DOT_PRODUCT_NV},
  {  "GL_COMBINER_CD_OUTPUT_NV", DAO_DOUBLE, GL_COMBINER_CD_OUTPUT_NV},
  {  "GL_COMBINER_COMPONENT_USAGE_NV", DAO_DOUBLE, GL_COMBINER_COMPONENT_USAGE_NV},
  {  "GL_COMBINER_INPUT_NV", DAO_DOUBLE, GL_COMBINER_INPUT_NV},
  {  "GL_COMBINER_MAPPING_NV", DAO_DOUBLE, GL_COMBINER_MAPPING_NV},
  {  "GL_COMBINER_MUX_SUM_NV", DAO_DOUBLE, GL_COMBINER_MUX_SUM_NV},
  {  "GL_COMBINER_SCALE_NV", DAO_DOUBLE, GL_COMBINER_SCALE_NV},
  {  "GL_COMBINER_SUM_OUTPUT_NV", DAO_DOUBLE, GL_COMBINER_SUM_OUTPUT_NV},
  {  "GL_COMBINE_ALPHA", DAO_DOUBLE, GL_COMBINE_ALPHA},
  {  "GL_COMBINE_ALPHA_ARB", DAO_DOUBLE, GL_COMBINE_ALPHA_ARB},
  {  "GL_COMBINE_ARB", DAO_DOUBLE, GL_COMBINE_ARB},
  {  "GL_COMBINE_RGB", DAO_DOUBLE, GL_COMBINE_RGB},
  {  "GL_COMBINE_RGB_ARB", DAO_DOUBLE, GL_COMBINE_RGB_ARB},
  {  "GL_COMPARE_R_TO_TEXTURE", DAO_DOUBLE, GL_COMPARE_R_TO_TEXTURE},
  {  "GL_COMPARE_R_TO_TEXTURE_ARB", DAO_DOUBLE, GL_COMPARE_R_TO_TEXTURE_ARB},
  ...
  {  "GL_COMPRESSED_ALPHA_ARB", DAO_DOUBLE, GL_COMPRESSED_ALPHA_ARB},
  {  "GL_COMPRESSED_INTENSITY", DAO_DOUBLE, GL_COMPRESSED_INTENSITY},
  {  "GL_COMPRESSED_INTENSITY_ARB", DAO_DOUBLE, GL_COMPRESSED_INTENSITY_ARB},
  ...
  {  "GL_COMPRESSED_LUMINANCE_ALPHA_3DC_ATI", DAO_DOUBLE, GL_COMPRESSED_LUMINANCE_ALPHA_3DC_ATI},
  {  "GL_COMPRESSED_LUMINANCE_ALPHA_ARB", DAO_DOUBLE, GL_COMPRESSED_LUMINANCE_ALPHA_ARB},
  {  "GL_COMPRESSED_LUMINANCE_ARB", DAO_DOUBLE, GL_COMPRESSED_LUMINANCE_ARB},
  {  "GL_COMPRESSED_RGB", DAO_DOUBLE, GL_COMPRESSED_RGB},
  {  "GL_COMPRESSED_RGBA", DAO_DOUBLE, GL_COMPRESSED_RGBA},
  {  "GL_COMPRESSED_RGBA_ARB", DAO_DOUBLE, GL_COMPRESSED_RGBA_ARB},
  {  "GL_COMPRESSED_RGBA_S3TC_DXT1_EXT", DAO_DOUBLE, GL_COMPRESSED_RGBA_S3TC_DXT1_EXT},
  {  "GL_COMPRESSED_RGBA_S3TC_DXT3_EXT", DAO_DOUBLE, GL_COMPRESSED_RGBA_S3TC_DXT3_EXT},
  {  "GL_COMPRESSED_RGBA_S3TC_DXT5_EXT", DAO_DOUBLE, GL_COMPRESSED_RGBA_S3TC_DXT5_EXT},
  {  "GL_COMPRESSED_RGB_ARB", DAO_DOUBLE, GL_COMPRESSED_RGB_ARB},
  {  "GL_COMPRESSED_RGB_S3TC_DXT1_EXT", DAO_DOUBLE, GL_COMPRESSED_RGB_S3TC_DXT1_EXT},
  ...
  {  "GL_COMPRESSED_SLUMINANCE_ALPHA_EXT", DAO_DOUBLE, GL_COMPRESSED_SLUMINANCE_ALPHA_EXT},
  {  "GL_COMPRESSED_SLUMINANCE_EXT", DAO_DOUBLE, GL_COMPRESSED_SLUMINANCE_EXT},
  {  "GL_COMPRESSED_SRGB", DAO_DOUBLE, GL_COMPRESSED_SRGB},
  {  "GL_COMPRESSED_SRGB_ALPHA", DAO_DOUBLE, GL_COMPRESSED_SRGB_ALPHA},
  {  "GL_COMPRESSED_SRGB_ALPHA_EXT", DAO_DOUBLE, GL_COMPRESSED_SRGB_ALPHA_EXT},
  {  "GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT", DAO_DOUBLE, GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT},
  {  "GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT", DAO_DOUBLE, GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT},
  {  "GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT", DAO_DOUBLE, GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT},
  {  "GL_COMPRESSED_SRGB_EXT", DAO_DOUBLE, GL_COMPRESSED_SRGB_EXT},
  {  "GL_COMPRESSED_SRGB_S3TC_DXT1_EXT", DAO_DOUBLE, GL_COMPRESSED_SRGB_S3TC_DXT1_EXT},
  {  "GL_COMPRESSED_TEXTURE_FORMATS", DAO_DOUBLE, GL_COMPRESSED_TEXTURE_FORMATS},
  {  "GL_COMPRESSED_TEXTURE_FORMATS_ARB", DAO_DOUBLE, GL_COMPRESSED_TEXTURE_FORMATS_ARB},
  {  "GL_CONSTANT", DAO_DOUBLE, GL_CONSTANT},
  {  "GL_CONSTANT_ALPHA", DAO_DOUBLE, GL_CONSTANT_ALPHA},
  {  "GL_CONSTANT_ALPHA_EXT", DAO_DOUBLE, GL_CONSTANT_ALPHA_EXT},
  {  "GL_CONSTANT_ARB", DAO_DOUBLE, GL_CONSTANT_ARB},
  ...
  {  "GL_CONSTANT_COLOR0_NV", DAO_DOUBLE, GL_CONSTANT_COLOR0_NV},
  {  "GL_CONSTANT_COLOR1_NV", DAO_DOUBLE, GL_CONSTANT_COLOR1_NV},
  {  "GL_CONSTANT_COLOR_EXT", DAO_DOUBLE, GL_CONSTANT_COLOR_EXT},
  {  "GL_CONST_EYE_NV", DAO_DOUBLE, GL_CONST_EYE_NV},
  ...
  {  "GL_COORD_REPLACE_ARB", DAO_DOUBLE, GL_COORD_REPLACE_ARB},
  {  "GL_COORD_REPLACE_NV", DAO_DOUBLE, GL_COORD_REPLACE_NV},
  ...
  {  "GL_CULL_FRAGMENT_NV", DAO_DOUBLE, GL_CULL_FRAGMENT_NV},
  {  "GL_CULL_MODES_NV", DAO_DOUBLE, GL_CULL_MODES_NV},
  ...
  {  "GL_CURRENT_FOG_COORDINATE_EXT", DAO_DOUBLE, GL_CURRENT_FOG_COORDINATE_EXT},
  {  "GL_CURRENT_INDEX", DAO_DOUBLE, GL_CURRENT_INDEX},
  {  "GL_CURRENT_MATRIX_ARB", DAO_DOUBLE, GL_CURRENT_MATRIX_ARB},
  {  "GL_CURRENT_MATRIX_STACK_DEPTH_ARB", DAO_DOUBLE, GL_CURRENT_MATRIX_STACK_DEPTH_ARB},
  ...
  {  "GL_CURRENT_QUERY_ARB", DAO_DOUBLE, GL_CURRENT_QUERY_ARB},
  ...
  {  "GL_CURRENT_SECONDARY_COLOR_EXT", DAO_DOUBLE, GL_CURRENT_SECONDARY_COLOR_EXT},
  ...
  {  "GL_CURRENT_VERTEX_ATTRIB_ARB", DAO_DOUBLE, GL_CURRENT_VERTEX_ATTRIB_ARB},
  {  "GL_CURRENT_WEIGHT_ARB", DAO_DOUBLE, GL_CURRENT_WEIGHT_ARB},
  {  "GL_CW", DAO_DOUBLE, GL_CW},
  {  "GL_DECAL", DAO_DOUBLE, GL_DECAL},
  {  "GL_DECR", DAO_DOUBLE, GL_DECR},
  {  "GL_DECR_WRAP", DAO_DOUBLE, GL_DECR_WRAP},
  {  "GL_DECR_WRAP_EXT", DAO_DOUBLE, GL_DECR_WRAP_EXT},
  {  "GL_DELETE_STATUS", DAO_DOUBLE, GL_DELETE_STATUS},
  {  "GL_DEPENDENT_AR_TEXTURE_2D_NV", DAO_DOUBLE, GL_DEPENDENT_AR_TEXTURE_2D_NV},
  {  "GL_DEPENDENT_GB_TEXTURE_2D_NV", DAO_DOUBLE, GL_DEPENDENT_GB_TEXTURE_2D_NV},
  {  "GL_DEPENDENT_HILO_TEXTURE_2D_NV", DAO_DOUBLE, GL_DEPENDENT_HILO_TEXTURE_2D_NV},
  {  "GL_DEPENDENT_RGB_TEXTURE_3D_NV", DAO_DOUBLE, GL_DEPENDENT_RGB_TEXTURE_3D_NV},
  {  "GL_DEPENDENT_RGB_TEXTURE_CUBE_MAP_NV", DAO_DOUBLE, GL_DEPENDENT_RGB_TEXTURE_CUBE_MAP_NV},
  {  "GL_DEPTH", DAO_DOUBLE, GL_DEPTH},
  {  "GL_DEPTH24_STENCIL8_EXT", DAO_DOUBLE, GL_DEPTH24_STENCIL8_EXT},
  {  "GL_DEPTH_ATTACHMENT_EXT", DAO_DOUBLE, GL_DEPTH_ATTACHMENT_EXT},
  {  "GL_DEPTH_BIAS", DAO_DOUBLE, GL_DEPTH_BIAS},
  {  "GL_DEPTH_BITS", DAO_DOUBLE, GL_DEPTH_BITS},
  {  "GL_DEPTH_BOUNDS_EXT", DAO_DOUBLE, GL_DEPTH_BOUNDS_EXT},
  {  "GL_DEPTH_BOUNDS_TEST_EXT", DAO_DOUBLE, GL_DEPTH_BOUNDS_TEST_EXT},
  {  "GL_DEPTH_BUFFER_BIT", DAO_DOUBLE, GL_DEPTH_BUFFER_BIT},
  {  "GL_DEPTH_CLAMP_NV", DAO_DOUBLE, GL_DEPTH_CLAMP_NV},
  ...
  {  "GL_DOT3_RGBA_ARB", DAO_DOUBLE, GL_DOT3_RGBA_ARB},
  {  "GL_DOT3_RGB_ARB", DAO_DOUBLE, GL_DOT3_RGB_ARB},
  {  "GL_DOT_PRODUCT_AFFINE_DEPTH_REPLACE_NV", DAO_DOUBLE, GL_DOT_PRODUCT_AFFINE_DEPTH_REPLACE_NV},
  {  "GL_DOT_PRODUCT_CONST_EYE_REFLECT_CUBE_MAP_NV", DAO_DOUBLE, GL_DOT_PRODUCT_CONST_EYE_REFLECT_CUBE_MAP_NV},
  {  "GL_DOT_PRODUCT_DEPTH_REPLACE_NV", DAO_DOUBLE, GL_DOT_PRODUCT_DEPTH_REPLACE_NV},
  {  "GL_DOT_PRODUCT_DIFFUSE_CUBE_MAP_NV", DAO_DOUBLE, GL_DOT_PRODUCT_DIFFUSE_CUBE_MAP_NV},
  {  "GL_DOT_PRODUCT_NV", DAO_DOUBLE, GL_DOT_PRODUCT_NV},
  {  "GL_DOT_PRODUCT_PASS_THROUGH_NV", DAO_DOUBLE, GL_DOT_PRODUCT_PASS_THROUGH_NV},
  {  "GL_DOT_PRODUCT_REFLECT_CUBE_MAP_NV", DAO_DOUBLE, GL_DOT_PRODUCT_REFLECT_CUBE_MAP_NV},
  {  "GL_DOT_PRODUCT_TEXTURE_1D_NV", DAO_DOUBLE, GL_DOT_PRODUCT_TEXTURE_1D_NV},
  {  "GL_DOT_PRODUCT_TEXTURE_2D_NV", DAO_DOUBLE, GL_DOT_PRODUCT_TEXTURE_2D_NV},
  {  "GL_DOT_PRODUCT_TEXTURE_3D_NV", DAO_DOUBLE, GL_DOT_PRODUCT_TEXTURE_3D_NV},
  {  "GL_DOT_PRODUCT_TEXTURE_CUBE_MAP_NV", DAO_DOUBLE, GL_DOT_PRODUCT_TEXTURE_CUBE_MAP_NV},
  {  "GL_DOT_PRODUCT_TEXTURE_RECTANGLE_NV", DAO_DOUBLE, GL_DOT_PRODUCT_TEXTURE_RECTANGLE_NV},
  ...
  {  "GL_DRAW_BUFFER0_ARB", DAO_DOUBLE, GL_DRAW_BUFFER0_ARB},
  {  "GL_DRAW_BUFFER1", DAO_DOUBLE, GL_DRAW_BUFFER1},
  {  "GL_DRAW_BUFFER10", DAO_DOUBLE, GL_DRAW_BUFFER10},
  {  "GL_DRAW_BUFFER10_ARB", DAO_DOUBLE, GL_DRAW_BUFFER10_ARB},
  {  "GL_DRAW_BUFFER11", DAO_DOUBLE, GL_DRAW_BUFFER11},
  {  "GL_DRAW_BUFFER11_ARB", DAO_DOUBLE, GL_DRAW_BUFFER11_ARB},
  {  "GL_DRAW_BUFFER12", DAO_DOUBLE, GL_DRAW_BUFFER12},
  {  "GL_DRAW_BUFFER12_ARB", DAO_DOUBLE, GL_DRAW_BUFFER12_ARB},
  {  "GL_DRAW_BUFFER13", DAO_DOUBLE, GL_DRAW_BUFFER13},
  {  "GL_DRAW_BUFFER13_ARB", DAO_DOUBLE, GL_DRAW_BUFFER13_ARB},
  {  "GL_DRAW_BUFFER14", DAO_DOUBLE, GL_DRAW_BUFFER14},
  {  "GL_DRAW_BUFFER14_ARB", DAO_DOUBLE, GL_DRAW_BUFFER14_ARB},
  {  "GL_DRAW_BUFFER15", DAO_DOUBLE, GL_DRAW_BUFFER15},
  {  "GL_DRAW_BUFFER15_ARB", DAO_DOUBLE, GL_DRAW_BUFFER15_ARB},
  {  "GL_DRAW_BUFFER1_ARB", DAO_DOUBLE, GL_DRAW_BUFFER1_ARB},
  {  "GL_DRAW_BUFFER2", DAO_DOUBLE, GL_DRAW_BUFFER2},
  {  "GL_DRAW_BUFFER2_ARB", DAO_DOUBLE, GL_DRAW_BUFFER2_ARB},
  {  "GL_DRAW_BUFFER3", DAO_DOUBLE, GL_DRAW_BUFFER3},
  {  "GL_DRAW_BUFFER3_ARB", DAO_DOUBLE, GL_DRAW_BUFFER3_ARB},
  {  "GL_DRAW_BUFFER4", DAO_DOUBLE, GL_DRAW_BUFFER4},
  {  "GL_DRAW_BUFFER4_ARB", DAO_DOUBLE, GL_DRAW_BUFFER4_ARB},
  {  "GL_DRAW_BUFFER5", DAO_DOUBLE, GL_DRAW_BUFFER5},
  {  "GL_DRAW_BUFFER5_ARB", DAO_DOUBLE, GL_DRAW_BUFFER5_ARB},
  {  "GL_DRAW_BUFFER6", DAO_DOUBLE, GL_DRAW_BUFFER6},
  {  "GL_DRAW_BUFFER6_ARB", DAO_DOUBLE, GL_DRAW_BUFFER6_ARB},
  {  "GL_DRAW_BUFFER7", DAO_DOUBLE, GL_DRAW_BUFFER7},
  {  "GL_DRAW_BUFFER7_ARB", DAO_DOUBLE, GL_DRAW_BUFFER7_ARB},
  {  "GL_DRAW_BUFFER8", DAO_DOUBLE, GL_DRAW_BUFFER8},
  {  "GL_DRAW_BUFFER8_ARB", DAO_DOUBLE, GL_DRAW_BUFFER8_ARB},
  {  "GL_DRAW_BUFFER9", DAO_DOUBLE, GL_DRAW_BUFFER9},
  {  "GL_DRAW_BUFFER9_ARB", DAO_DOUBLE, GL_DRAW_BUFFER9_ARB},
  {  "GL_DRAW_FRAMEBUFFER_BINDING_EXT", DAO_DOUBLE, GL_DRAW_FRAMEBUFFER_BINDING_EXT},
  {  "GL_DRAW_FRAMEBUFFER_EXT", DAO_DOUBLE, GL_DRAW_FRAMEBUFFER_EXT},
  {  "GL_DRAW_PIXELS_APPLE", DAO_DOUBLE, GL_DRAW_PIXELS_APPLE},
  {  "GL_DRAW_PIXEL_TOKEN", DAO_DOUBLE, GL_DRAW_PIXEL_TOKEN},
  {  "GL_DSDT8_MAG8_INTENSITY8_NV", DAO_DOUBLE, GL_DSDT8_MAG8_INTENSITY8_NV},
  {  "GL_DSDT8_MAG8_NV", DAO_DOUBLE, GL_DSDT8_MAG8_NV},
  {  "GL_DSDT8_NV", DAO_DOUBLE, GL_DSDT8_NV},
  {  "GL_DSDT_MAG_INTENSITY_NV", DAO_DOUBLE, GL_DSDT_MAG_INTENSITY_NV},
  {  "GL_DSDT_MAG_NV", DAO_DOUBLE, GL_DSDT_MAG_NV},
  {  "GL_DSDT_MAG_VIB_NV", DAO_DOUBLE, GL_DSDT_MAG_VIB_NV},
  {  "GL_DSDT_NV", DAO_DOUBLE, GL_DSDT_NV},
  {  "GL_DST_ALPHA", DAO_DOUBLE, GL_DST_ALPHA},
  {  "GL_DST_COLOR", DAO_DOUBLE, GL_DST_COLOR},
  {  "GL_DS_BIAS_NV", DAO_DOUBLE, GL_DS_BIAS_NV},
  {  "GL_DS_SCALE_NV", DAO_DOUBLE, GL_DS_SCALE_NV},
  {  "GL_DT_BIAS_NV", DAO_DOUBLE, GL_DT_BIAS_NV},
  {  "GL_DT_SCALE_NV", DAO_DOUBLE, GL_DT_SCALE_NV},
  {  "GL_DYNAMIC_COPY", DAO_DOUBLE, GL_DYNAMIC_COPY},
  {  "GL_DYNAMIC_COPY_ARB", DAO_DOUBLE, GL_DYNAMIC_COPY_ARB},
  {  "GL_DYNAMIC_DRAW", DAO_DOUBLE, GL_DYNAMIC_DRAW},
  {  "GL_DYNAMIC_DRAW_ARB", DAO_DOUBLE, GL_DYNAMIC_DRAW_ARB},
  {  "GL_DYNAMIC_READ", DAO_DOUBLE, GL_DYNAMIC_READ},
  {  "GL_DYNAMIC_READ_ARB", DAO_DOUBLE, GL_DYNAMIC_READ_ARB},
  ...
  {  "GL_EDGE_FLAG_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_EDGE_FLAG_ARRAY_BUFFER_BINDING_ARB},
  ...
  {  "GL_ELEMENT_ARRAY_APPLE", DAO_DOUBLE, GL_ELEMENT_ARRAY_APPLE},
  {  "GL_ELEMENT_ARRAY_BUFFER", DAO_DOUBLE, GL_ELEMENT_ARRAY_BUFFER},
  {  "GL_ELEMENT_ARRAY_BUFFER_ARB", DAO_DOUBLE, GL_ELEMENT_ARRAY_BUFFER_ARB},
  {  "GL_ELEMENT_ARRAY_BUFFER_BINDING", DAO_DOUBLE, GL_ELEMENT_ARRAY_BUFFER_BINDING},
  {  "GL_ELEMENT_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_ELEMENT_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_ELEMENT_ARRAY_POINTER_APPLE", DAO_DOUBLE, GL_ELEMENT_ARRAY_POINTER_APPLE},
  {  "GL_ELEMENT_ARRAY_TYPE_APPLE", DAO_DOUBLE, GL_ELEMENT_ARRAY_TYPE_APPLE},
  {  "GL_ELEMENT_BUFFER_BINDING_APPLE", DAO_DOUBLE, GL_ELEMENT_BUFFER_BINDING_APPLE},
  ...
  {  "GL_EXPAND_NEGATE_NV", DAO_DOUBLE, GL_EXPAND_NEGATE_NV},
  {  "GL_EXPAND_NORMAL_NV", DAO_DOUBLE, GL_EXPAND_NORMAL_NV},
  {  "GL_EXTENSIONS", DAO_DOUBLE, GL_EXTENSIONS},
  {  "GL_EXT_abgr", DAO_DOUBLE, GL_EXT_abgr},
  {  "GL_EXT_bgra", DAO_DOUBLE, GL_EXT_bgra},
  {  "GL_EXT_bindable_uniform", DAO_DOUBLE, GL_EXT_bindable_uniform},
  {  "GL_EXT_blend_color", DAO_DOUBLE, GL_EXT_blend_color},
  {  "GL_EXT_blend_equation_separate", DAO_DOUBLE, GL_EXT_blend_equation_separate},
  {  "GL_EXT_blend_func_separate", DAO_DOUBLE, GL_EXT_blend_func_separate},
  {  "GL_EXT_blend_minmax", DAO_DOUBLE, GL_EXT_blend_minmax},
  {  "GL_EXT_blend_subtract", DAO_DOUBLE, GL_EXT_blend_subtract},
  {  "GL_EXT_clip_volume_hint", DAO_DOUBLE, GL_EXT_clip_volume_hint},
  {  "GL_EXT_compiled_vertex_array", DAO_DOUBLE, GL_EXT_compiled_vertex_array},
  {  "GL_EXT_depth_bounds_test", DAO_DOUBLE, GL_EXT_depth_bounds_test},
  {  "GL_EXT_draw_range_elements", DAO_DOUBLE, GL_EXT_draw_range_elements},
  {  "GL_EXT_fog_coord", DAO_DOUBLE, GL_EXT_fog_coord},
  {  "GL_EXT_framebuffer_blit", DAO_DOUBLE, GL_EXT_framebuffer_blit},
  {  "GL_EXT_framebuffer_multisample", DAO_DOUBLE, GL_EXT_framebuffer_multisample},
  {  "GL_EXT_framebuffer_object", DAO_DOUBLE, GL_EXT_framebuffer_object},
  {  "GL_EXT_geometry_shader4", DAO_DOUBLE, GL_EXT_geometry_shader4},
  {  "GL_EXT_gpu_program_parameters", DAO_DOUBLE, GL_EXT_gpu_program_parameters},
  {  "GL_EXT_gpu_shader4", DAO_DOUBLE, GL_EXT_gpu_shader4},
  {  "GL_EXT_multi_draw_arrays", DAO_DOUBLE, GL_EXT_multi_draw_arrays},
  {  "GL_EXT_packed_depth_stencil", DAO_DOUBLE, GL_EXT_packed_depth_stencil},
  {  "GL_EXT_paletted_texture", DAO_DOUBLE, GL_EXT_paletted_texture},
  {  "GL_EXT_rescale_normal", DAO_DOUBLE, GL_EXT_rescale_normal},
  {  "GL_EXT_secondary_color", DAO_DOUBLE, GL_EXT_secondary_color},
  {  "GL_EXT_separate_specular_color", DAO_DOUBLE, GL_EXT_separate_specular_color},
  {  "GL_EXT_shadow_funcs", DAO_DOUBLE, GL_EXT_shadow_funcs},
  {  "GL_EXT_stencil_two_side", DAO_DOUBLE, GL_EXT_stencil_two_side},
  {  "GL_EXT_stencil_wrap", DAO_DOUBLE, GL_EXT_stencil_wrap},
  {  "GL_EXT_texture_compression_dxt1", DAO_DOUBLE, GL_EXT_texture_compression_dxt1},
  {  "GL_EXT_texture_compression_s3tc", DAO_DOUBLE, GL_EXT_texture_compression_s3tc},
  {  "GL_EXT_texture_env_add", DAO_DOUBLE, GL_EXT_texture_env_add},
  {  "GL_EXT_texture_filter_anisotropic", DAO_DOUBLE, GL_EXT_texture_filter_anisotropic},
  {  "GL_EXT_texture_integer", DAO_DOUBLE, GL_EXT_texture_integer},
  {  "GL_EXT_texture_lod_bias", DAO_DOUBLE, GL_EXT_texture_lod_bias},
  {  "GL_EXT_texture_mirror_clamp", DAO_DOUBLE, GL_EXT_texture_mirror_clamp},
  {  "GL_EXT_texture_rectangle", DAO_DOUBLE, GL_EXT_texture_rectangle},
  {  "GL_EXT_texture_sRGB", DAO_DOUBLE, GL_EXT_texture_sRGB},
  {  "GL_EXT_transform_feedback", DAO_DOUBLE, GL_EXT_transform_feedback},
  {  "GL_EYE_LINEAR", DAO_DOUBLE, GL_EYE_LINEAR},
  {  "GL_EYE_PLANE", DAO_DOUBLE, GL_EYE_PLANE},
  {  "GL_EYE_PLANE_ABSOLUTE_NV", DAO_DOUBLE, GL_EYE_PLANE_ABSOLUTE_NV},
  {  "GL_EYE_RADIAL_NV", DAO_DOUBLE, GL_EYE_RADIAL_NV},
  {  "GL_E_TIMES_F_NV", DAO_DOUBLE, GL_E_TIMES_F_NV},
  ...
  {  "GL_FLOAT_MAT3_ARB", DAO_DOUBLE, GL_FLOAT_MAT3_ARB},
  ...
  {  "GL_FLOAT_MAT4_ARB", DAO_DOUBLE, GL_FLOAT_MAT4_ARB},
  ...
  {  "GL_FLOAT_VEC2_ARB", DAO_DOUBLE, GL_FLOAT_VEC2_ARB},
  {  "GL_FLOAT_VEC3", DAO_DOUBLE, GL_FLOAT_VEC3},
  {  "GL_FLOAT_VEC3_ARB", DAO_DOUBLE, GL_FLOAT_VEC3_ARB},
  {  "GL_FLOAT_VEC4", DAO_DOUBLE, GL_FLOAT_VEC4},
  {  "GL_FLOAT_VEC4_ARB", DAO_DOUBLE, GL_FLOAT_VEC4_ARB},
  ...
  {  "GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_FOG_COORDINATE_ARRAY_EXT", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_EXT},
  {  "GL_FOG_COORDINATE_ARRAY_POINTER", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_POINTER},
  {  "GL_FOG_COORDINATE_ARRAY_POINTER_EXT", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_POINTER_EXT},
  {  "GL_FOG_COORDINATE_ARRAY_STRIDE", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_STRIDE},
  {  "GL_FOG_COORDINATE_ARRAY_STRIDE_EXT", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_STRIDE_EXT},
  {  "GL_FOG_COORDINATE_ARRAY_TYPE", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_TYPE},
  {  "GL_FOG_COORDINATE_ARRAY_TYPE_EXT", DAO_DOUBLE, GL_FOG_COORDINATE_ARRAY_TYPE_EXT},
  {  "GL_FOG_COORDINATE_EXT", DAO_DOUBLE, GL_FOG_COORDINATE_EXT},
  {  "GL_FOG_COORDINATE_SOURCE", DAO_DOUBLE, GL_FOG_COORDINATE_SOURCE},
  {  "GL_FOG_COORDINATE_SOURCE_EXT", DAO_DOUBLE, GL_FOG_COORDINATE_SOURCE_EXT},
  ...
  {  "GL_FOG_COORD_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_FOG_COORD_ARRAY_BUFFER_BINDING_ARB},
  ...
  {  "GL_FOG_DISTANCE_MODE_NV", DAO_DOUBLE, GL_FOG_DISTANCE_MODE_NV},
  ...
  {  "GL_FORCE_BLUE_TO_ONE_NV", DAO_DOUBLE, GL_FORCE_BLUE_TO_ONE_NV},
  {  "GL_FRAGMENT_DEPTH", DAO_DOUBLE, GL_FRAGMENT_DEPTH},
  {  "GL_FRAGMENT_DEPTH_EXT", DAO_DOUBLE, GL_FRAGMENT_DEPTH_EXT},
  {  "GL_FRAGMENT_PROGRAM_ARB", DAO_DOUBLE, GL_FRAGMENT_PROGRAM_ARB},
  {  "GL_FRAGMENT_SHADER", DAO_DOUBLE, GL_FRAGMENT_SHADER},
  {  "GL_FRAGMENT_SHADER_ARB", DAO_DOUBLE, GL_FRAGMENT_SHADER_ARB},
  {  "GL_FRAGMENT_SHADER_DERIVATIVE_HINT", DAO_DOUBLE, GL_FRAGMENT_SHADER_DERIVATIVE_HINT},
  {  "GL_FRAGMENT_SHADER_DERIVATIVE_HINT_ARB", DAO_DOUBLE, GL_FRAGMENT_SHADER_DERIVATIVE_HINT_ARB},
  {  "GL_FRAMEBUFFER_ATTACHMENT_LAYERED_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_LAYERED_EXT},
  {  "GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME_EXT},
  {  "GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE_EXT},
  {  "GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_EXT},
  {  "GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE_EXT},
  {  "GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER_EXT},
  {  "GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL_EXT},
  {  "GL_FRAMEBUFFER_BINDING_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_BINDING_EXT},
  {  "GL_FRAMEBUFFER_COMPLETE_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_COMPLETE_EXT},
  {  "GL_FRAMEBUFFER_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_FORMATS_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_FORMATS_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_LAYER_COUNT_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_LAYER_COUNT_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT},
  {  "GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER_EXT},
  {  "GL_FRAMEBUFFER_UNSUPPORTED_EXT", DAO_DOUBLE, GL_FRAMEBUFFER_UNSUPPORTED_EXT},
  ...
  {  "GL_FUNC_ADD_EXT", DAO_DOUBLE, GL_FUNC_ADD_EXT},
  {  "GL_FUNC_REVERSE_SUBTRACT", DAO_DOUBLE, GL_FUNC_REVERSE_SUBTRACT},
  {  "GL_FUNC_REVERSE_SUBTRACT_EXT", DAO_DOUBLE, GL_FUNC_REVERSE_SUBTRACT_EXT},
  {  "GL_FUNC_SUBTRACT", DAO_DOUBLE, GL_FUNC_SUBTRACT},
  {  "GL_FUNC_SUBTRACT_EXT", DAO_DOUBLE, GL_FUNC_SUBTRACT_EXT},
  {  "GL_GENERATE_MIPMAP", DAO_DOUBLE, GL_GENERATE_MIPMAP},
  {  "GL_GENERATE_MIPMAP_HINT", DAO_DOUBLE, GL_GENERATE_MIPMAP_HINT},
  {  "GL_GENERATE_MIPMAP_HINT_SGIS", DAO_DOUBLE, GL_GENERATE_MIPMAP_HINT_SGIS},
  {  "GL_GENERATE_MIPMAP_SGIS", DAO_DOUBLE, GL_GENERATE_MIPMAP_SGIS},
  {  "GL_GEOMETRY_INPUT_TYPE_EXT", DAO_DOUBLE, GL_GEOMETRY_INPUT_TYPE_EXT},
  {  "GL_GEOMETRY_OUTPUT_TYPE_EXT", DAO_DOUBLE, GL_GEOMETRY_OUTPUT_TYPE_EXT},
  {  "GL_GEOMETRY_SHADER_EXT", DAO_DOUBLE, GL_GEOMETRY_SHADER_EXT},
  {  "GL_GEOMETRY_VERTICES_OUT_EXT", DAO_DOUBLE, GL_GEOMETRY_VERTICES_OUT_EXT},
  {  "GL_GEQUAL", DAO_DOUBLE, GL_GEQUAL},
  {  "GL_GLEXT_VERSION", DAO_DOUBLE, GL_GLEXT_VERSION},
  ...
  {  "GL_GREEN_INTEGER_EXT", DAO_DOUBLE, GL_GREEN_INTEGER_EXT},
  {  "GL_GREEN_SCALE", DAO_DOUBLE, GL_GREEN_SCALE},
  {  "GL_HALF_APPLE", DAO_DOUBLE, GL_HALF_APPLE},
  {  "GL_HALF_BIAS_NEGATE_NV", DAO_DOUBLE, GL_HALF_BIAS_NEGATE_NV},
  {  "GL_HALF_BIAS_NORMAL_NV", DAO_DOUBLE, GL_HALF_BIAS_NORMAL_NV},
  {  "GL_HALF_FLOAT_ARB", DAO_DOUBLE, GL_HALF_FLOAT_ARB},
  {  "GL_HILO16_NV", DAO_DOUBLE, GL_HILO16_NV},
  {  "GL_HILO8_NV", DAO_DOUBLE, GL_HILO8_NV},
  {  "GL_HILO_NV", DAO_DOUBLE, GL_HILO_NV},
  ...
  {  "GL_HI_BIAS_NV", DAO_DOUBLE, GL_HI_BIAS_NV},
  {  "GL_HI_SCALE_NV", DAO_DOUBLE, GL_HI_SCALE_NV},
  {  "GL_IBM_rasterpos_clip", DAO_DOUBLE, GL_IBM_rasterpos_clip},
  {  "GL_INCR", DAO_DOUBLE, GL_INCR},
  {  "GL_INCR_WRAP", DAO_DOUBLE, GL_INCR_WRAP},
  {  "GL_INCR_WRAP_EXT", DAO_DOUBLE, GL_INCR_WRAP_EXT},
  {  "GL_INDEX_ARRAY", DAO_DOUBLE, GL_INDEX_ARRAY},
  {  "GL_INDEX_ARRAY_BUFFER_BINDING", DAO_DOUBLE, GL_INDEX_ARRAY_BUFFER_BINDING},
  {  "GL_INDEX_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_INDEX_ARRAY_BUFFER_BINDING_ARB},
  ...
  {  "GL_INTENSITY16F_ARB", DAO_DOUBLE, GL_INTENSITY16F_ARB},
  {  "GL_INTENSITY16I_EXT", DAO_DOUBLE, GL_INTENSITY16I_EXT},
  {  "GL_INTENSITY16UI_EXT", DAO_DOUBLE, GL_INTENSITY16UI_EXT},
  {  "GL_INTENSITY32F_ARB", DAO_DOUBLE, GL_INTENSITY32F_ARB},
  {  "GL_INTENSITY32I_EXT", DAO_DOUBLE, GL_INTENSITY32I_EXT},
  {  "GL_INTENSITY32UI_EXT", DAO_DOUBLE, GL_INTENSITY32UI_EXT},
  {  "GL_INTENSITY4", DAO_DOUBLE, GL_INTENSITY4},
  {  "GL_INTENSITY8", DAO_DOUBLE, GL_INTENSITY8},
  {  "GL_INTENSITY8I_EXT", DAO_DOUBLE, GL_INTENSITY8I_EXT},
  {  "GL_INTENSITY8UI_EXT", DAO_DOUBLE, GL_INTENSITY8UI_EXT},
  {  "GL_INTENSITY_FLOAT16_APPLE", DAO_DOUBLE, GL_INTENSITY_FLOAT16_APPLE},
  {  "GL_INTENSITY_FLOAT16_ATI", DAO_DOUBLE, GL_INTENSITY_FLOAT16_ATI},
  {  "GL_INTENSITY_FLOAT32_APPLE", DAO_DOUBLE, GL_INTENSITY_FLOAT32_APPLE},
  {  "GL_INTENSITY_FLOAT32_ATI", DAO_DOUBLE, GL_INTENSITY_FLOAT32_ATI},
  {  "GL_INTERLEAVED_ATTRIBS_EXT", DAO_DOUBLE, GL_INTERLEAVED_ATTRIBS_EXT},
  {  "GL_INTERPOLATE", DAO_DOUBLE, GL_INTERPOLATE},
  {  "GL_INTERPOLATE_ARB", DAO_DOUBLE, GL_INTERPOLATE_ARB},
  {  "GL_INT_SAMPLER_1D_ARRAY_EXT", DAO_DOUBLE, GL_INT_SAMPLER_1D_ARRAY_EXT},
  {  "GL_INT_SAMPLER_1D_EXT", DAO_DOUBLE, GL_INT_SAMPLER_1D_EXT},
  {  "GL_INT_SAMPLER_2D_ARRAY_EXT", DAO_DOUBLE, GL_INT_SAMPLER_2D_ARRAY_EXT},
  {  "GL_INT_SAMPLER_2D_EXT", DAO_DOUBLE, GL_INT_SAMPLER_2D_EXT},
  {  "GL_INT_SAMPLER_2D_RECT_EXT", DAO_DOUBLE, GL_INT_SAMPLER_2D_RECT_EXT},
  {  "GL_INT_SAMPLER_3D_EXT", DAO_DOUBLE, GL_INT_SAMPLER_3D_EXT},
  {  "GL_INT_SAMPLER_BUFFER_EXT", DAO_DOUBLE, GL_INT_SAMPLER_BUFFER_EXT},
  {  "GL_INT_SAMPLER_CUBE_EXT", DAO_DOUBLE, GL_INT_SAMPLER_CUBE_EXT},
  {  "GL_INT_VEC2", DAO_DOUBLE, GL_INT_VEC2},
  {  "GL_INT_VEC2_ARB", DAO_DOUBLE, GL_INT_VEC2_ARB},
  {  "GL_INT_VEC3", DAO_DOUBLE, GL_INT_VEC3},
  {  "GL_INT_VEC3_ARB", DAO_DOUBLE, GL_INT_VEC3_ARB},
  {  "GL_INT_VEC4", DAO_DOUBLE, GL_INT_VEC4},
  {  "GL_INT_VEC4_ARB", DAO_DOUBLE, GL_INT_VEC4_ARB},
  {  "GL_INVALID_ENUM", DAO_DOUBLE, GL_INVALID_ENUM},
  {  "GL_INVALID_FRAMEBUFFER_OPERATION_EXT", DAO_DOUBLE, GL_INVALID_FRAMEBUFFER_OPERATION_EXT},
  ...
  {  "GL_LIGHT_MODEL_COLOR_CONTROL_EXT", DAO_DOUBLE, GL_LIGHT_MODEL_COLOR_CONTROL_EXT},
  {  "GL_LIGHT_MODEL_LOCAL_VIEWER", DAO_DOUBLE, GL_LIGHT_MODEL_LOCAL_VIEWER},
  {  "GL_LIGHT_MODEL_SPECULAR_VECTOR_APPLE", DAO_DOUBLE, GL_LIGHT_MODEL_SPECULAR_VECTOR_APPLE},
  ...
  {  "GL_LINES_ADJACENCY_EXT", DAO_DOUBLE, GL_LINES_ADJACENCY_EXT},
  ...
  {  "GL_LINE_STRIP_ADJACENCY_EXT", DAO_DOUBLE, GL_LINE_STRIP_ADJACENCY_EXT},
  ...
  {  "GL_LO_BIAS_NV", DAO_DOUBLE, GL_LO_BIAS_NV},
  {  "GL_LO_SCALE_NV", DAO_DOUBLE, GL_LO_SCALE_NV},
  ...
  {  "GL_LUMINANCE16F_ARB", DAO_DOUBLE, GL_LUMINANCE16F_ARB},
  {  "GL_LUMINANCE16I_EXT", DAO_DOUBLE, GL_LUMINANCE16I_EXT},
  {  "GL_LUMINANCE16UI_EXT", DAO_DOUBLE, GL_LUMINANCE16UI_EXT},
  {  "GL_LUMINANCE16_ALPHA16", DAO_DOUBLE, GL_LUMINANCE16_ALPHA16},
  {  "GL_LUMINANCE32F_ARB", DAO_DOUBLE, GL_LUMINANCE32F_ARB},
  {  "GL_LUMINANCE32I_EXT", DAO_DOUBLE, GL_LUMINANCE32I_EXT},
  {  "GL_LUMINANCE32UI_EXT", DAO_DOUBLE, GL_LUMINANCE32UI_EXT},
  ...
  {  "GL_LUMINANCE8I_EXT", DAO_DOUBLE, GL_LUMINANCE8I_EXT},
  {  "GL_LUMINANCE8UI_EXT", DAO_DOUBLE, GL_LUMINANCE8UI_EXT},
  {  "GL_LUMINANCE8_ALPHA8", DAO_DOUBLE, GL_LUMINANCE8_ALPHA8},
  {  "GL_LUMINANCE_ALPHA", DAO_DOUBLE, GL_LUMINANCE_ALPHA},
  {  "GL_LUMINANCE_ALPHA16F_ARB", DAO_DOUBLE, GL_LUMINANCE_ALPHA16F_ARB},
  {  "GL_LUMINANCE_ALPHA16I_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA16I_EXT},
  {  "GL_LUMINANCE_ALPHA16UI_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA16UI_EXT},
  {  "GL_LUMINANCE_ALPHA32F_ARB", DAO_DOUBLE, GL_LUMINANCE_ALPHA32F_ARB},
  {  "GL_LUMINANCE_ALPHA32I_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA32I_EXT},
  {  "GL_LUMINANCE_ALPHA32UI_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA32UI_EXT},
  {  "GL_LUMINANCE_ALPHA8I_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA8I_EXT},
  {  "GL_LUMINANCE_ALPHA8UI_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA8UI_EXT},
  {  "GL_LUMINANCE_ALPHA_FLOAT16_APPLE", DAO_DOUBLE, GL_LUMINANCE_ALPHA_FLOAT16_APPLE},
  {  "GL_LUMINANCE_ALPHA_FLOAT16_ATI", DAO_DOUBLE, GL_LUMINANCE_ALPHA_FLOAT16_ATI},
  {  "GL_LUMINANCE_ALPHA_FLOAT32_APPLE", DAO_DOUBLE, GL_LUMINANCE_ALPHA_FLOAT32_APPLE},
  {  "GL_LUMINANCE_ALPHA_FLOAT32_ATI", DAO_DOUBLE, GL_LUMINANCE_ALPHA_FLOAT32_ATI},
  {  "GL_LUMINANCE_ALPHA_INTEGER_EXT", DAO_DOUBLE, GL_LUMINANCE_ALPHA_INTEGER_EXT},
  {  "GL_LUMINANCE_FLOAT16_APPLE", DAO_DOUBLE, GL_LUMINANCE_FLOAT16_APPLE},
  {  "GL_LUMINANCE_FLOAT16_ATI", DAO_DOUBLE, GL_LUMINANCE_FLOAT16_ATI},
  {  "GL_LUMINANCE_FLOAT32_APPLE", DAO_DOUBLE, GL_LUMINANCE_FLOAT32_APPLE},
  {  "GL_LUMINANCE_FLOAT32_ATI", DAO_DOUBLE, GL_LUMINANCE_FLOAT32_ATI},
  {  "GL_LUMINANCE_INTEGER_EXT", DAO_DOUBLE, GL_LUMINANCE_INTEGER_EXT},
  {  "GL_MAGNITUDE_BIAS_NV", DAO_DOUBLE, GL_MAGNITUDE_BIAS_NV},
  {  "GL_MAGNITUDE_SCALE_NV", DAO_DOUBLE, GL_MAGNITUDE_SCALE_NV},
  ...
  {  "GL_MATRIX0_ARB", DAO_DOUBLE, GL_MATRIX0_ARB},
  {  "GL_MATRIX10_ARB", DAO_DOUBLE, GL_MATRIX10_ARB},
  {  "GL_MATRIX11_ARB", DAO_DOUBLE, GL_MATRIX11_ARB},
  {  "GL_MATRIX12_ARB", DAO_DOUBLE, GL_MATRIX12_ARB},
  {  "GL_MATRIX13_ARB", DAO_DOUBLE, GL_MATRIX13_ARB},
  {  "GL_MATRIX14_ARB", DAO_DOUBLE, GL_MATRIX14_ARB},
  {  "GL_MATRIX15_ARB", DAO_DOUBLE, GL_MATRIX15_ARB},
  {  "GL_MATRIX16_ARB", DAO_DOUBLE, GL_MATRIX16_ARB},
  {  "GL_MATRIX17_ARB", DAO_DOUBLE, GL_MATRIX17_ARB},
  {  "GL_MATRIX18_ARB", DAO_DOUBLE, GL_MATRIX18_ARB},
  {  "GL_MATRIX19_ARB", DAO_DOUBLE, GL_MATRIX19_ARB},
  {  "GL_MATRIX1_ARB", DAO_DOUBLE, GL_MATRIX1_ARB},
  {  "GL_MATRIX20_ARB", DAO_DOUBLE, GL_MATRIX20_ARB},
  {  "GL_MATRIX21_ARB", DAO_DOUBLE, GL_MATRIX21_ARB},
  {  "GL_MATRIX22_ARB", DAO_DOUBLE, GL_MATRIX22_ARB},
  {  "GL_MATRIX23_ARB", DAO_DOUBLE, GL_MATRIX23_ARB},
  {  "GL_MATRIX24_ARB", DAO_DOUBLE, GL_MATRIX24_ARB},
  {  "GL_MATRIX25_ARB", DAO_DOUBLE, GL_MATRIX25_ARB},
  {  "GL_MATRIX26_ARB", DAO_DOUBLE, GL_MATRIX26_ARB},
  {  "GL_MATRIX27_ARB", DAO_DOUBLE, GL_MATRIX27_ARB},
  {  "GL_MATRIX28_ARB", DAO_DOUBLE, GL_MATRIX28_ARB},
  {  "GL_MATRIX29_ARB", DAO_DOUBLE, GL_MATRIX29_ARB},
  {  "GL_MATRIX2_ARB", DAO_DOUBLE, GL_MATRIX2_ARB},
  {  "GL_MATRIX30_ARB", DAO_DOUBLE, GL_MATRIX30_ARB},
  {  "GL_MATRIX31_ARB", DAO_DOUBLE, GL_MATRIX31_ARB},
  {  "GL_MATRIX3_ARB", DAO_DOUBLE, GL_MATRIX3_ARB},
  {  "GL_MATRIX4_ARB", DAO_DOUBLE, GL_MATRIX4_ARB},
  {  "GL_MATRIX5_ARB", DAO_DOUBLE, GL_MATRIX5_ARB},
  {  "GL_MATRIX6_ARB", DAO_DOUBLE, GL_MATRIX6_ARB},
  {  "GL_MATRIX7_ARB", DAO_DOUBLE, GL_MATRIX7_ARB},
  {  "GL_MATRIX8_ARB", DAO_DOUBLE, GL_MATRIX8_ARB},
  {  "GL_MATRIX9_ARB", DAO_DOUBLE, GL_MATRIX9_ARB},
  ...
  {  "GL_MAX_BINDABLE_UNIFORM_SIZE_EXT", DAO_DOUBLE, GL_MAX_BINDABLE_UNIFORM_SIZE_EXT},
  ...
  {  "GL_MAX_COLOR_ATTACHMENTS_EXT", DAO_DOUBLE, GL_MAX_COLOR_ATTACHMENTS_EXT},
  {  "GL_MAX_COLOR_MATRIX_STACK_DEPTH", DAO_DOUBLE, GL_MAX_COLOR_MATRIX_STACK_DEPTH},
  {  "GL_MAX_COLOR_MATRIX_STACK_DEPTH_SGI", DAO_DOUBLE, GL_MAX_COLOR_MATRIX_STACK_DEPTH_SGI},
  {  "GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS", DAO_DOUBLE, GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS},
  {  "GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS_ARB", DAO_DOUBLE, GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS_ARB},
  ...
  {  "GL_MAX_CUBE_MAP_TEXTURE_SIZE_ARB", DAO_DOUBLE, GL_MAX_CUBE_MAP_TEXTURE_SIZE_ARB},
  {  "GL_MAX_DRAW_BUFFERS", DAO_DOUBLE, GL_MAX_DRAW_BUFFERS},
  {  "GL_MAX_DRAW_BUFFERS_ARB", DAO_DOUBLE, GL_MAX_DRAW_BUFFERS_ARB},
  {  "GL_MAX_ELEMENTS_INDICES", DAO_DOUBLE, GL_MAX_ELEMENTS_INDICES},
  {  "GL_MAX_ELEMENTS_INDICES_EXT", DAO_DOUBLE, GL_MAX_ELEMENTS_INDICES_EXT},
  {  "GL_MAX_ELEMENTS_VERTICES", DAO_DOUBLE, GL_MAX_ELEMENTS_VERTICES},
  {  "GL_MAX_ELEMENTS_VERTICES_EXT", DAO_DOUBLE, GL_MAX_ELEMENTS_VERTICES_EXT},
  {  "GL_MAX_EVAL_ORDER", DAO_DOUBLE, GL_MAX_EVAL_ORDER},
  {  "GL_MAX_EXT", DAO_DOUBLE, GL_MAX_EXT},
  {  "GL_MAX_FRAGMENT_BINDABLE_UNIFORMS_EXT", DAO_DOUBLE, GL_MAX_FRAGMENT_BINDABLE_UNIFORMS_EXT},
  {  "GL_MAX_FRAGMENT_UNIFORM_COMPONENTS", DAO_DOUBLE, GL_MAX_FRAGMENT_UNIFORM_COMPONENTS},
  {  "GL_MAX_FRAGMENT_UNIFORM_COMPONENTS_ARB", DAO_DOUBLE, GL_MAX_FRAGMENT_UNIFORM_COMPONENTS_ARB},
  {  "GL_MAX_GENERAL_COMBINERS_NV", DAO_DOUBLE, GL_MAX_GENERAL_COMBINERS_NV},
  {  "GL_MAX_GEOMETRY_BINDABLE_UNIFORMS_EXT", DAO_DOUBLE, GL_MAX_GEOMETRY_BINDABLE_UNIFORMS_EXT},
  {  "GL_MAX_GEOMETRY_OUTPUT_VERTICES_EXT", DAO_DOUBLE, GL_MAX_GEOMETRY_OUTPUT_VERTICES_EXT},
  {  "GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_EXT", DAO_DOUBLE, GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_EXT},
  {  "GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_EXT},
  {  "GL_MAX_GEOMETRY_UNIFORM_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_GEOMETRY_UNIFORM_COMPONENTS_EXT},
  {  "GL_MAX_GEOMETRY_VARYING_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_GEOMETRY_VARYING_COMPONENTS_EXT},
  ...
  {  "GL_MAX_PN_TRIANGLES_TESSELATION_LEVEL_ATI", DAO_DOUBLE, GL_MAX_PN_TRIANGLES_TESSELATION_LEVEL_ATI},
  {  "GL_MAX_PN_TRIANGLES_TESSELATION_LEVEL_ATIX", DAO_DOUBLE, GL_MAX_PN_TRIANGLES_TESSELATION_LEVEL_ATIX},
  {  "GL_MAX_PROGRAM_ADDRESS_REGISTERS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_ADDRESS_REGISTERS_ARB},
  {  "GL_MAX_PROGRAM_ALU_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_ALU_INSTRUCTIONS_ARB},
  {  "GL_MAX_PROGRAM_ATTRIBS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_ATTRIBS_ARB},
  {  "GL_MAX_PROGRAM_CALL_DEPTH_NV", DAO_DOUBLE, GL_MAX_PROGRAM_CALL_DEPTH_NV},
  {  "GL_MAX_PROGRAM_ENV_PARAMETERS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_ENV_PARAMETERS_ARB},
  {  "GL_MAX_PROGRAM_EXEC_INSTRUCTIONS_NV", DAO_DOUBLE, GL_MAX_PROGRAM_EXEC_INSTRUCTIONS_NV},
  {  "GL_MAX_PROGRAM_IF_DEPTH_NV", DAO_DOUBLE, GL_MAX_PROGRAM_IF_DEPTH_NV},
  {  "GL_MAX_PROGRAM_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_INSTRUCTIONS_ARB},
  {  "GL_MAX_PROGRAM_LOCAL_PARAMETERS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_LOCAL_PARAMETERS_ARB},
  {  "GL_MAX_PROGRAM_LOOP_COUNT_NV", DAO_DOUBLE, GL_MAX_PROGRAM_LOOP_COUNT_NV},
  {  "GL_MAX_PROGRAM_LOOP_DEPTH_NV", DAO_DOUBLE, GL_MAX_PROGRAM_LOOP_DEPTH_NV},
  {  "GL_MAX_PROGRAM_MATRICES_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_MATRICES_ARB},
  {  "GL_MAX_PROGRAM_MATRIX_STACK_DEPTH_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_MATRIX_STACK_DEPTH_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_ADDRESS_REGISTERS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_ADDRESS_REGISTERS_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_ATTRIBS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_ATTRIBS_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_INSTRUCTIONS_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_PARAMETERS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_PARAMETERS_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_TEMPORARIES_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_TEMPORARIES_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB},
  {  "GL_MAX_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB},
  {  "GL_MAX_PROGRAM_PARAMETERS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_PARAMETERS_ARB},
  {  "GL_MAX_PROGRAM_TEMPORARIES_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_TEMPORARIES_ARB},
  {  "GL_MAX_PROGRAM_TEXEL_OFFSET_EXT", DAO_DOUBLE, GL_MAX_PROGRAM_TEXEL_OFFSET_EXT},
  {  "GL_MAX_PROGRAM_TEX_INDIRECTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_TEX_INDIRECTIONS_ARB},
  {  "GL_MAX_PROGRAM_TEX_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_MAX_PROGRAM_TEX_INSTRUCTIONS_ARB},
  {  "GL_MAX_PROJECTION_STACK_DEPTH", DAO_DOUBLE, GL_MAX_PROJECTION_STACK_DEPTH},
  {  "GL_MAX_RECTANGLE_TEXTURE_SIZE_ARB", DAO_DOUBLE, GL_MAX_RECTANGLE_TEXTURE_SIZE_ARB},
  {  "GL_MAX_RECTANGLE_TEXTURE_SIZE_EXT", DAO_DOUBLE, GL_MAX_RECTANGLE_TEXTURE_SIZE_EXT},
  {  "GL_MAX_RENDERBUFFER_SIZE_EXT", DAO_DOUBLE, GL_MAX_RENDERBUFFER_SIZE_EXT},
  {  "GL_MAX_SAMPLES_EXT", DAO_DOUBLE, GL_MAX_SAMPLES_EXT},
  {  "GL_MAX_SHININESS_NV", DAO_DOUBLE, GL_MAX_SHININESS_NV},
  {  "GL_MAX_SPOT_EXPONENT_NV", DAO_DOUBLE, GL_MAX_SPOT_EXPONENT_NV},
  {  "GL_MAX_TEXTURE_COORDS", DAO_DOUBLE, GL_MAX_TEXTURE_COORDS},
  {  "GL_MAX_TEXTURE_COORDS_ARB", DAO_DOUBLE, GL_MAX_TEXTURE_COORDS_ARB},
  {  "GL_MAX_TEXTURE_IMAGE_UNITS", DAO_DOUBLE, GL_MAX_TEXTURE_IMAGE_UNITS},
  {  "GL_MAX_TEXTURE_IMAGE_UNITS_ARB", DAO_DOUBLE, GL_MAX_TEXTURE_IMAGE_UNITS_ARB},
  {  "GL_MAX_TEXTURE_LOD_BIAS", DAO_DOUBLE, GL_MAX_TEXTURE_LOD_BIAS},
  {  "GL_MAX_TEXTURE_LOD_BIAS_EXT", DAO_DOUBLE, GL_MAX_TEXTURE_LOD_BIAS_EXT},
  {  "GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT", DAO_DOUBLE, GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT},
  ...
  {  "GL_MAX_TEXTURE_UNITS_ARB", DAO_DOUBLE, GL_MAX_TEXTURE_UNITS_ARB},
  {  "GL_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS_EXT},
  {  "GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS_EXT", DAO_DOUBLE, GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS_EXT},
  {  "GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS_EXT},
  {  "GL_MAX_VARYING_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_VARYING_COMPONENTS_EXT},
  {  "GL_MAX_VARYING_FLOATS", DAO_DOUBLE, GL_MAX_VARYING_FLOATS},
  {  "GL_MAX_VARYING_FLOATS_ARB", DAO_DOUBLE, GL_MAX_VARYING_FLOATS_ARB},
  {  "GL_MAX_VERTEX_ARRAY_RANGE_ELEMENT_APPLE", DAO_DOUBLE, GL_MAX_VERTEX_ARRAY_RANGE_ELEMENT_APPLE},
  {  "GL_MAX_VERTEX_ATTRIBS", DAO_DOUBLE, GL_MAX_VERTEX_ATTRIBS},
  {  "GL_MAX_VERTEX_ATTRIBS_ARB", DAO_DOUBLE, GL_MAX_VERTEX_ATTRIBS_ARB},
  {  "GL_MAX_VERTEX_BINDABLE_UNIFORMS_EXT", DAO_DOUBLE, GL_MAX_VERTEX_BINDABLE_UNIFORMS_EXT},
  {  "GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS", DAO_DOUBLE, GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS},
  {  "GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS_ARB", DAO_DOUBLE, GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS_ARB},
  {  "GL_MAX_VERTEX_UNIFORM_COMPONENTS", DAO_DOUBLE, GL_MAX_VERTEX_UNIFORM_COMPONENTS},
  {  "GL_MAX_VERTEX_UNIFORM_COMPONENTS_ARB", DAO_DOUBLE, GL_MAX_VERTEX_UNIFORM_COMPONENTS_ARB},
  {  "GL_MAX_VERTEX_UNITS_ARB", DAO_DOUBLE, GL_MAX_VERTEX_UNITS_ARB},
  {  "GL_MAX_VERTEX_VARYING_COMPONENTS_EXT", DAO_DOUBLE, GL_MAX_VERTEX_VARYING_COMPONENTS_EXT},
  {  "GL_MAX_VIEWPORT_DIMS", DAO_DOUBLE, GL_MAX_VIEWPORT_DIMS},
  {  "GL_MAX_WEIGHTED_ATI", DAO_DOUBLE, GL_MAX_WEIGHTED_ATI},
  ...
  {  "GL_MIN_EXT", DAO_DOUBLE, GL_MIN_EXT},
  {  "GL_MIN_PBUFFER_VIEWPORT_DIMS_APPLE", DAO_DOUBLE, GL_MIN_PBUFFER_VIEWPORT_DIMS_APPLE},
  {  "GL_MIN_PROGRAM_TEXEL_OFFSET_EXT", DAO_DOUBLE, GL_MIN_PROGRAM_TEXEL_OFFSET_EXT},
  {  "GL_MIN_WEIGHTED_ATI", DAO_DOUBLE, GL_MIN_WEIGHTED_ATI},
  {  "GL_MIRRORED_REPEAT", DAO_DOUBLE, GL_MIRRORED_REPEAT},
  {  "GL_MIRRORED_REPEAT_ARB", DAO_DOUBLE, GL_MIRRORED_REPEAT_ARB},
  {  "GL_MIRROR_CLAMP_ATI", DAO_DOUBLE, GL_MIRROR_CLAMP_ATI},
  {  "GL_MIRROR_CLAMP_EXT", DAO_DOUBLE, GL_MIRROR_CLAMP_EXT},
  {  "GL_MIRROR_CLAMP_TO_BORDER_EXT", DAO_DOUBLE, GL_MIRROR_CLAMP_TO_BORDER_EXT},
  {  "GL_MIRROR_CLAMP_TO_EDGE_ATI", DAO_DOUBLE, GL_MIRROR_CLAMP_TO_EDGE_ATI},
  {  "GL_MIRROR_CLAMP_TO_EDGE_EXT", DAO_DOUBLE, GL_MIRROR_CLAMP_TO_EDGE_EXT},
  {  "GL_MODELVIEW", DAO_DOUBLE, GL_MODELVIEW},
  {  "GL_MODELVIEW0_ARB", DAO_DOUBLE, GL_MODELVIEW0_ARB},
  {  "GL_MODELVIEW10_ARB", DAO_DOUBLE, GL_MODELVIEW10_ARB},
  {  "GL_MODELVIEW11_ARB", DAO_DOUBLE, GL_MODELVIEW11_ARB},
  {  "GL_MODELVIEW12_ARB", DAO_DOUBLE, GL_MODELVIEW12_ARB},
  {  "GL_MODELVIEW13_ARB", DAO_DOUBLE, GL_MODELVIEW13_ARB},
  {  "GL_MODELVIEW14_ARB", DAO_DOUBLE, GL_MODELVIEW14_ARB},
  {  "GL_MODELVIEW15_ARB", DAO_DOUBLE, GL_MODELVIEW15_ARB},
  {  "GL_MODELVIEW16_ARB", DAO_DOUBLE, GL_MODELVIEW16_ARB},
  {  "GL_MODELVIEW17_ARB", DAO_DOUBLE, GL_MODELVIEW17_ARB},
  {  "GL_MODELVIEW18_ARB", DAO_DOUBLE, GL_MODELVIEW18_ARB},
  {  "GL_MODELVIEW19_ARB", DAO_DOUBLE, GL_MODELVIEW19_ARB},
  {  "GL_MODELVIEW1_ARB", DAO_DOUBLE, GL_MODELVIEW1_ARB},
  {  "GL_MODELVIEW20_ARB", DAO_DOUBLE, GL_MODELVIEW20_ARB},
  {  "GL_MODELVIEW21_ARB", DAO_DOUBLE, GL_MODELVIEW21_ARB},
  {  "GL_MODELVIEW22_ARB", DAO_DOUBLE, GL_MODELVIEW22_ARB},
  {  "GL_MODELVIEW23_ARB", DAO_DOUBLE, GL_MODELVIEW23_ARB},
  {  "GL_MODELVIEW24_ARB", DAO_DOUBLE, GL_MODELVIEW24_ARB},
  {  "GL_MODELVIEW25_ARB", DAO_DOUBLE, GL_MODELVIEW25_ARB},
  {  "GL_MODELVIEW26_ARB", DAO_DOUBLE, GL_MODELVIEW26_ARB},
  {  "GL_MODELVIEW27_ARB", DAO_DOUBLE, GL_MODELVIEW27_ARB},
  {  "GL_MODELVIEW28_ARB", DAO_DOUBLE, GL_MODELVIEW28_ARB},
  {  "GL_MODELVIEW29_ARB", DAO_DOUBLE, GL_MODELVIEW29_ARB},
  {  "GL_MODELVIEW2_ARB", DAO_DOUBLE, GL_MODELVIEW2_ARB},
  {  "GL_MODELVIEW30_ARB", DAO_DOUBLE, GL_MODELVIEW30_ARB},
  {  "GL_MODELVIEW31_ARB", DAO_DOUBLE, GL_MODELVIEW31_ARB},
  {  "GL_MODELVIEW3_ARB", DAO_DOUBLE, GL_MODELVIEW3_ARB},
  {  "GL_MODELVIEW4_ARB", DAO_DOUBLE, GL_MODELVIEW4_ARB},
  {  "GL_MODELVIEW5_ARB", DAO_DOUBLE, GL_MODELVIEW5_ARB},
  {  "GL_MODELVIEW6_ARB", DAO_DOUBLE, GL_MODELVIEW6_ARB},
  {  "GL_MODELVIEW7_ARB", DAO_DOUBLE, GL_MODELVIEW7_ARB},
  {  "GL_MODELVIEW8_ARB", DAO_DOUBLE, GL_MODELVIEW8_ARB},
  {  "GL_MODELVIEW9_ARB", DAO_DOUBLE, GL_MODELVIEW9_ARB},
  ...
  {  "GL_MODULATE_ADD_ATI", DAO_DOUBLE, GL_MODULATE_ADD_ATI},
  {  "GL_MODULATE_SIGNED_ADD_ATI", DAO_DOUBLE, GL_MODULATE_SIGNED_ADD_ATI},
  {  "GL_MODULATE_SUBTRACT_ATI", DAO_DOUBLE, GL_MODULATE_SUBTRACT_ATI},
  {  "GL_MULT", DAO_DOUBLE, GL_MULT},
  {  "GL_MULTISAMPLE", DAO_DOUBLE, GL_MULTISAMPLE},
  {  "GL_MULTISAMPLE_ARB", DAO_DOUBLE, GL_MULTISAMPLE_ARB},
  {  "GL_MULTISAMPLE_BIT", DAO_DOUBLE, GL_MULTISAMPLE_BIT},
  {  "GL_MULTISAMPLE_BIT_ARB", DAO_DOUBLE, GL_MULTISAMPLE_BIT_ARB},
  {  "GL_MULTISAMPLE_FILTER_HINT_NV", DAO_DOUBLE, GL_MULTISAMPLE_FILTER_HINT_NV},
  ...
  {  "GL_NORMAL_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_NORMAL_ARRAY_BUFFER_BINDING_ARB},
  ...
  {  "GL_NORMAL_MAP_ARB", DAO_DOUBLE, GL_NORMAL_MAP_ARB},
  {  "GL_NORMAL_MAP_NV", DAO_DOUBLE, GL_NORMAL_MAP_NV},
  ...
  {  "GL_NUM_COMPRESSED_TEXTURE_FORMATS_ARB", DAO_DOUBLE, GL_NUM_COMPRESSED_TEXTURE_FORMATS_ARB},
  {  "GL_NUM_GENERAL_COMBINERS_NV", DAO_DOUBLE, GL_NUM_GENERAL_COMBINERS_NV},
  {  "GL_NV_blend_square", DAO_DOUBLE, GL_NV_blend_square},
  {  "GL_NV_depth_clamp", DAO_DOUBLE, GL_NV_depth_clamp},
  {  "GL_NV_fog_distance", DAO_DOUBLE, GL_NV_fog_distance},
  {  "GL_NV_fragment_program2", DAO_DOUBLE, GL_NV_fragment_program2},
  {  "GL_NV_fragment_program_option", DAO_DOUBLE, GL_NV_fragment_program_option},
  {  "GL_NV_light_max_exponent", DAO_DOUBLE, GL_NV_light_max_exponent},
  {  "GL_NV_multisample_filter_hint", DAO_DOUBLE, GL_NV_multisample_filter_hint},
  {  "GL_NV_point_sprite", DAO_DOUBLE, GL_NV_point_sprite},
  {  "GL_NV_register_combiners", DAO_DOUBLE, GL_NV_register_combiners},
  {  "GL_NV_register_combiners2", DAO_DOUBLE, GL_NV_register_combiners2},
  {  "GL_NV_texgen_reflection", DAO_DOUBLE, GL_NV_texgen_reflection},
  {  "GL_NV_texture_shader", DAO_DOUBLE, GL_NV_texture_shader},
  {  "GL_NV_texture_shader2", DAO_DOUBLE, GL_NV_texture_shader2},
  {  "GL_NV_texture_shader3", DAO_DOUBLE, GL_NV_texture_shader3},
  {  "GL_NV_vertex_program2_option", DAO_DOUBLE, GL_NV_vertex_program2_option},
  {  "GL_NV_vertex_program3", DAO_DOUBLE, GL_NV_vertex_program3},
  {  "GL_OBJECT_ACTIVE_ATTRIBUTES_ARB", DAO_DOUBLE, GL_OBJECT_ACTIVE_ATTRIBUTES_ARB},
  {  "GL_OBJECT_ACTIVE_ATTRIBUTE_MAX_LENGTH_ARB", DAO_DOUBLE, GL_OBJECT_ACTIVE_ATTRIBUTE_MAX_LENGTH_ARB},
  {  "GL_OBJECT_ACTIVE_UNIFORMS_ARB", DAO_DOUBLE, GL_OBJECT_ACTIVE_UNIFORMS_ARB},
  {  "GL_OBJECT_ACTIVE_UNIFORM_MAX_LENGTH_ARB", DAO_DOUBLE, GL_OBJECT_ACTIVE_UNIFORM_MAX_LENGTH_ARB},
  {  "GL_OBJECT_ATTACHED_OBJECTS_ARB", DAO_DOUBLE, GL_OBJECT_ATTACHED_OBJECTS_ARB},
  {  "GL_OBJECT_COMPILE_STATUS_ARB", DAO_DOUBLE, GL_OBJECT_COMPILE_STATUS_ARB},
  {  "GL_OBJECT_DELETE_STATUS_ARB", DAO_DOUBLE, GL_OBJECT_DELETE_STATUS_ARB},
  {  "GL_OBJECT_INFO_LOG_LENGTH_ARB", DAO_DOUBLE, GL_OBJECT_INFO_LOG_LENGTH_ARB},
  {  "GL_OBJECT_LINEAR", DAO_DOUBLE, GL_OBJECT_LINEAR},
  {  "GL_OBJECT_LINK_STATUS_ARB", DAO_DOUBLE, GL_OBJECT_LINK_STATUS_ARB},
  {  "GL_OBJECT_PLANE", DAO_DOUBLE, GL_OBJECT_PLANE},
  {  "GL_OBJECT_SHADER_SOURCE_LENGTH_ARB", DAO_DOUBLE, GL_OBJECT_SHADER_SOURCE_LENGTH_ARB},
  {  "GL_OBJECT_SUBTYPE_ARB", DAO_DOUBLE, GL_OBJECT_SUBTYPE_ARB},
  {  "GL_OBJECT_TYPE_ARB", DAO_DOUBLE, GL_OBJECT_TYPE_ARB},
  {  "GL_OBJECT_VALIDATE_STATUS_ARB", DAO_DOUBLE, GL_OBJECT_VALIDATE_STATUS_ARB},
  {  "GL_OFFSET_HILO_PROJECTIVE_TEXTURE_2D_NV", DAO_DOUBLE, GL_OFFSET_HILO_PROJECTIVE_TEXTURE_2D_NV},
  {  "GL_OFFSET_HILO_PROJECTIVE_TEXTURE_RECTANGLE_NV", DAO_DOUBLE, GL_OFFSET_HILO_PROJECTIVE_TEXTURE_RECTANGLE_NV},
  {  "GL_OFFSET_HILO_TEXTURE_2D_NV", DAO_DOUBLE, GL_OFFSET_HILO_TEXTURE_2D_NV},
  {  "GL_OFFSET_HILO_TEXTURE_RECTANGLE_NV", DAO_DOUBLE, GL_OFFSET_HILO_TEXTURE_RECTANGLE_NV},
  {  "GL_OFFSET_PROJECTIVE_TEXTURE_2D_NV", DAO_DOUBLE, GL_OFFSET_PROJECTIVE_TEXTURE_2D_NV},
  {  "GL_OFFSET_PROJECTIVE_TEXTURE_2D_SCALE_NV", DAO_DOUBLE, GL_OFFSET_PROJECTIVE_TEXTURE_2D_SCALE_NV},
  {  "GL_OFFSET_PROJECTIVE_TEXTURE_RECTANGLE_NV", DAO_DOUBLE, GL_OFFSET_PROJECTIVE_TEXTURE_RECTANGLE_NV},
  {  "GL_OFFSET_PROJECTIVE_TEXTURE_RECTANGLE_SCALE_NV", DAO_DOUBLE, GL_OFFSET_PROJECTIVE_TEXTURE_RECTANGLE_SCALE_NV},
  {  "GL_OFFSET_TEXTURE_2D_NV", DAO_DOUBLE, GL_OFFSET_TEXTURE_2D_NV},
  {  "GL_OFFSET_TEXTURE_BIAS_NV", DAO_DOUBLE, GL_OFFSET_TEXTURE_BIAS_NV},
  {  "GL_OFFSET_TEXTURE_MATRIX_NV", DAO_DOUBLE, GL_OFFSET_TEXTURE_MATRIX_NV},
  {  "GL_OFFSET_TEXTURE_RECTANGLE_NV", DAO_DOUBLE, GL_OFFSET_TEXTURE_RECTANGLE_NV},
  {  "GL_OFFSET_TEXTURE_RECTANGLE_SCALE_NV", DAO_DOUBLE, GL_OFFSET_TEXTURE_RECTANGLE_SCALE_NV},
  {  "GL_OFFSET_TEXTURE_SCALE_NV", DAO_DOUBLE, GL_OFFSET_TEXTURE_SCALE_NV},
  {  "GL_ONE", DAO_DOUBLE, GL_ONE},
  {  "GL_ONE_MINUS_CONSTANT_ALPHA", DAO_DOUBLE, GL_ONE_MINUS_CONSTANT_ALPHA},
  {  "GL_ONE_MINUS_CONSTANT_ALPHA_EXT", DAO_DOUBLE, GL_ONE_MINUS_CONSTANT_ALPHA_EXT},
  {  "GL_ONE_MINUS_CONSTANT_COLOR", DAO_DOUBLE, GL_ONE_MINUS_CONSTANT_COLOR},
  {  "GL_ONE_MINUS_CONSTANT_COLOR_EXT", DAO_DOUBLE, GL_ONE_MINUS_CONSTANT_COLOR_EXT},
  ...
  {  "GL_OPERAND0_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND0_ALPHA_ARB},
  {  "GL_OPERAND0_RGB", DAO_DOUBLE, GL_OPERAND0_RGB},
  {  "GL_OPERAND0_RGB_ARB", DAO_DOUBLE, GL_OPERAND0_RGB_ARB},
  {  "GL_OPERAND1_ALPHA", DAO_DOUBLE, GL_OPERAND1_ALPHA},
  {  "GL_OPERAND1_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND1_ALPHA_ARB},
  {  "GL_OPERAND1_RGB", DAO_DOUBLE, GL_OPERAND1_RGB},
  {  "GL_OPERAND1_RGB_ARB", DAO_DOUBLE, GL_OPERAND1_RGB_ARB},
  {  "GL_OPERAND2_ALPHA", DAO_DOUBLE, GL_OPERAND2_ALPHA},
  {  "GL_OPERAND2_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND2_ALPHA_ARB},
  {  "GL_OPERAND2_RGB", DAO_DOUBLE, GL_OPERAND2_RGB},
  {  "GL_OPERAND2_RGB_ARB", DAO_DOUBLE, GL_OPERAND2_RGB_ARB},
  {  "GL_OPERAND3_ALPHA", DAO_DOUBLE, GL_OPERAND3_ALPHA},
  {  "GL_OPERAND3_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND3_ALPHA_ARB},
  {  "GL_OPERAND3_RGB", DAO_DOUBLE, GL_OPERAND3_RGB},
  {  "GL_OPERAND3_RGB_ARB", DAO_DOUBLE, GL_OPERAND3_RGB_ARB},
  {  "GL_OPERAND4_ALPHA", DAO_DOUBLE, GL_OPERAND4_ALPHA},
  {  "GL_OPERAND4_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND4_ALPHA_ARB},
  {  "GL_OPERAND4_RGB", DAO_DOUBLE, GL_OPERAND4_RGB},
  {  "GL_OPERAND4_RGB_ARB", DAO_DOUBLE, GL_OPERAND4_RGB_ARB},
  {  "GL_OPERAND5_ALPHA", DAO_DOUBLE, GL_OPERAND5_ALPHA},
  {  "GL_OPERAND5_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND5_ALPHA_ARB},
  {  "GL_OPERAND5_RGB", DAO_DOUBLE, GL_OPERAND5_RGB},
  {  "GL_OPERAND5_RGB_ARB", DAO_DOUBLE, GL_OPERAND5_RGB_ARB},
  {  "GL_OPERAND6_ALPHA", DAO_DOUBLE, GL_OPERAND6_ALPHA},
  {  "GL_OPERAND6_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND6_ALPHA_ARB},
  {  "GL_OPERAND6_RGB", DAO_DOUBLE, GL_OPERAND6_RGB},
  {  "GL_OPERAND6_RGB_ARB", DAO_DOUBLE, GL_OPERAND6_RGB_ARB},
  {  "GL_OPERAND7_ALPHA", DAO_DOUBLE, GL_OPERAND7_ALPHA},
  {  "GL_OPERAND7_ALPHA_ARB", DAO_DOUBLE, GL_OPERAND7_ALPHA_ARB},
  {  "GL_OPERAND7_RGB", DAO_DOUBLE, GL_OPERAND7_RGB},
  {  "GL_OPERAND7_RGB_ARB", DAO_DOUBLE, GL_OPERAND7_RGB_ARB},
  ...
  {  "GL_PACK_IMAGE_BYTES_APPLE", DAO_DOUBLE, GL_PACK_IMAGE_BYTES_APPLE},
  {  "GL_PACK_IMAGE_HEIGHT", DAO_DOUBLE, GL_PACK_IMAGE_HEIGHT},
  {  "GL_PACK_LSB_FIRST", DAO_DOUBLE, GL_PACK_LSB_FIRST},
  {  "GL_PACK_ROW_BYTES_APPLE", DAO_DOUBLE, GL_PACK_ROW_BYTES_APPLE},
  ...
  {  "GL_PASS_THROUGH_NV", DAO_DOUBLE, GL_PASS_THROUGH_NV},
  ...
  {  "GL_PER_STAGE_CONSTANTS_NV", DAO_DOUBLE, GL_PER_STAGE_CONSTANTS_NV},
  ...
  {  "GL_PIXEL_PACK_BUFFER_ARB", DAO_DOUBLE, GL_PIXEL_PACK_BUFFER_ARB},
  {  "GL_PIXEL_PACK_BUFFER_BINDING", DAO_DOUBLE, GL_PIXEL_PACK_BUFFER_BINDING},
  {  "GL_PIXEL_PACK_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_PIXEL_PACK_BUFFER_BINDING_ARB},
  {  "GL_PIXEL_UNPACK_BUFFER", DAO_DOUBLE, GL_PIXEL_UNPACK_BUFFER},
  {  "GL_PIXEL_UNPACK_BUFFER_ARB", DAO_DOUBLE, GL_PIXEL_UNPACK_BUFFER_ARB},
  {  "GL_PIXEL_UNPACK_BUFFER_BINDING", DAO_DOUBLE, GL_PIXEL_UNPACK_BUFFER_BINDING},
  {  "GL_PIXEL_UNPACK_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_PIXEL_UNPACK_BUFFER_BINDING_ARB},
  {  "GL_PN_TRIANGLES_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_ATI},
  {  "GL_PN_TRIANGLES_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_ATIX},
  {  "GL_PN_TRIANGLES_NORMAL_MODE_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_NORMAL_MODE_ATI},
  {  "GL_PN_TRIANGLES_NORMAL_MODE_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_NORMAL_MODE_ATIX},
  {  "GL_PN_TRIANGLES_NORMAL_MODE_LINEAR_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_NORMAL_MODE_LINEAR_ATI},
  {  "GL_PN_TRIANGLES_NORMAL_MODE_LINEAR_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_NORMAL_MODE_LINEAR_ATIX},
  {  "GL_PN_TRIANGLES_NORMAL_MODE_QUADRATIC_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_NORMAL_MODE_QUADRATIC_ATI},
  {  "GL_PN_TRIANGLES_NORMAL_MODE_QUADRATIC_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_NORMAL_MODE_QUADRATIC_ATIX},
  {  "GL_PN_TRIANGLES_POINT_MODE_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_POINT_MODE_ATI},
  {  "GL_PN_TRIANGLES_POINT_MODE_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_POINT_MODE_ATIX},
  {  "GL_PN_TRIANGLES_POINT_MODE_CUBIC_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_POINT_MODE_CUBIC_ATI},
  {  "GL_PN_TRIANGLES_POINT_MODE_CUBIC_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_POINT_MODE_CUBIC_ATIX},
  {  "GL_PN_TRIANGLES_POINT_MODE_LINEAR_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_POINT_MODE_LINEAR_ATI},
  {  "GL_PN_TRIANGLES_POINT_MODE_LINEAR_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_POINT_MODE_LINEAR_ATIX},
  {  "GL_PN_TRIANGLES_TESSELATION_LEVEL_ATI", DAO_DOUBLE, GL_PN_TRIANGLES_TESSELATION_LEVEL_ATI},
  {  "GL_PN_TRIANGLES_TESSELATION_LEVEL_ATIX", DAO_DOUBLE, GL_PN_TRIANGLES_TESSELATION_LEVEL_ATIX},
  {  "GL_POINT", DAO_DOUBLE, GL_POINT},
  {  "GL_POINTS", DAO_DOUBLE, GL_POINTS},
  {  "GL_POINT_BIT", DAO_DOUBLE, GL_POINT_BIT},
  {  "GL_POINT_CULL_CENTER_ATI", DAO_DOUBLE, GL_POINT_CULL_CENTER_ATI},
  {  "GL_POINT_CULL_CLIP_ATI", DAO_DOUBLE, GL_POINT_CULL_CLIP_ATI},
  {  "GL_POINT_CULL_MODE_ATI", DAO_DOUBLE, GL_POINT_CULL_MODE_ATI},
  {  "GL_POINT_DISTANCE_ATTENUATION", DAO_DOUBLE, GL_POINT_DISTANCE_ATTENUATION},
  {  "GL_POINT_DISTANCE_ATTENUATION_ARB", DAO_DOUBLE, GL_POINT_DISTANCE_ATTENUATION_ARB},
  {  "GL_POINT_FADE_THRESHOLD_SIZE", DAO_DOUBLE, GL_POINT_FADE_THRESHOLD_SIZE},
  {  "GL_POINT_FADE_THRESHOLD_SIZE_ARB", DAO_DOUBLE, GL_POINT_FADE_THRESHOLD_SIZE_ARB},
  ...
  {  "GL_POINT_SIZE_MAX_ARB", DAO_DOUBLE, GL_POINT_SIZE_MAX_ARB},
  {  "GL_POINT_SIZE_MIN", DAO_DOUBLE, GL_POINT_SIZE_MIN},
  {  "GL_POINT_SIZE_MIN_ARB", DAO_DOUBLE, GL_POINT_SIZE_MIN_ARB},
  ...
  {  "GL_POINT_SPRITE_ARB", DAO_DOUBLE, GL_POINT_SPRITE_ARB},
  {  "GL_POINT_SPRITE_COORD_ORIGIN", DAO_DOUBLE, GL_POINT_SPRITE_COORD_ORIGIN},
  {  "GL_POINT_SPRITE_NV", DAO_DOUBLE, GL_POINT_SPRITE_NV},
  {  "GL_POINT_SPRITE_R_MODE_NV", DAO_DOUBLE, GL_POINT_SPRITE_R_MODE_NV},
  ...
  {  "GL_POST_COLOR_MATRIX_ALPHA_BIAS_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_ALPHA_BIAS_SGI},
  {  "GL_POST_COLOR_MATRIX_ALPHA_SCALE", DAO_DOUBLE, GL_POST_COLOR_MATRIX_ALPHA_SCALE},
  {  "GL_POST_COLOR_MATRIX_ALPHA_SCALE_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_ALPHA_SCALE_SGI},
  {  "GL_POST_COLOR_MATRIX_BLUE_BIAS", DAO_DOUBLE, GL_POST_COLOR_MATRIX_BLUE_BIAS},
  {  "GL_POST_COLOR_MATRIX_BLUE_BIAS_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_BLUE_BIAS_SGI},
  {  "GL_POST_COLOR_MATRIX_BLUE_SCALE", DAO_DOUBLE, GL_POST_COLOR_MATRIX_BLUE_SCALE},
  {  "GL_POST_COLOR_MATRIX_BLUE_SCALE_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_BLUE_SCALE_SGI},
  ...
  {  "GL_POST_COLOR_MATRIX_GREEN_BIAS_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_GREEN_BIAS_SGI},
  {  "GL_POST_COLOR_MATRIX_GREEN_SCALE", DAO_DOUBLE, GL_POST_COLOR_MATRIX_GREEN_SCALE},
  {  "GL_POST_COLOR_MATRIX_GREEN_SCALE_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_GREEN_SCALE_SGI},
  {  "GL_POST_COLOR_MATRIX_RED_BIAS", DAO_DOUBLE, GL_POST_COLOR_MATRIX_RED_BIAS},
  {  "GL_POST_COLOR_MATRIX_RED_BIAS_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_RED_BIAS_SGI},
  {  "GL_POST_COLOR_MATRIX_RED_SCALE", DAO_DOUBLE, GL_POST_COLOR_MATRIX_RED_SCALE},
  {  "GL_POST_COLOR_MATRIX_RED_SCALE_SGI", DAO_DOUBLE, GL_POST_COLOR_MATRIX_RED_SCALE_SGI},
  ...
  {  "GL_PREVIOUS_ARB", DAO_DOUBLE, GL_PREVIOUS_ARB},
  {  "GL_PREVIOUS_TEXTURE_INPUT_NV", DAO_DOUBLE, GL_PREVIOUS_TEXTURE_INPUT_NV},
  {  "GL_PRIMARY_COLOR", DAO_DOUBLE, GL_PRIMARY_COLOR},
  {  "GL_PRIMARY_COLOR_ARB", DAO_DOUBLE, GL_PRIMARY_COLOR_ARB},
  {  "GL_PRIMARY_COLOR_NV", DAO_DOUBLE, GL_PRIMARY_COLOR_NV},
  {  "GL_PRIMITIVES_GENERATED_EXT", DAO_DOUBLE, GL_PRIMITIVES_GENERATED_EXT},
  {  "GL_PROGRAM_ADDRESS_REGISTERS_ARB", DAO_DOUBLE, GL_PROGRAM_ADDRESS_REGISTERS_ARB},
  {  "GL_PROGRAM_ALU_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_ALU_INSTRUCTIONS_ARB},
  {  "GL_PROGRAM_ATTRIBS_ARB", DAO_DOUBLE, GL_PROGRAM_ATTRIBS_ARB},
  {  "GL_PROGRAM_BINDING_ARB", DAO_DOUBLE, GL_PROGRAM_BINDING_ARB},
  {  "GL_PROGRAM_ERROR_POSITION_ARB", DAO_DOUBLE, GL_PROGRAM_ERROR_POSITION_ARB},
  {  "GL_PROGRAM_ERROR_STRING_ARB", DAO_DOUBLE, GL_PROGRAM_ERROR_STRING_ARB},
  {  "GL_PROGRAM_FORMAT_ARB", DAO_DOUBLE, GL_PROGRAM_FORMAT_ARB},
  {  "GL_PROGRAM_FORMAT_ASCII_ARB", DAO_DOUBLE, GL_PROGRAM_FORMAT_ASCII_ARB},
  {  "GL_PROGRAM_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_INSTRUCTIONS_ARB},
  {  "GL_PROGRAM_LENGTH_ARB", DAO_DOUBLE, GL_PROGRAM_LENGTH_ARB},
  {  "GL_PROGRAM_NAME_ARB", DAO_DOUBLE, GL_PROGRAM_NAME_ARB},
  {  "GL_PROGRAM_NATIVE_ADDRESS_REGISTERS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_ADDRESS_REGISTERS_ARB},
  {  "GL_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_ALU_INSTRUCTIONS_ARB},
  {  "GL_PROGRAM_NATIVE_ATTRIBS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_ATTRIBS_ARB},
  {  "GL_PROGRAM_NATIVE_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_INSTRUCTIONS_ARB},
  {  "GL_PROGRAM_NATIVE_PARAMETERS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_PARAMETERS_ARB},
  {  "GL_PROGRAM_NATIVE_TEMPORARIES_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_TEMPORARIES_ARB},
  {  "GL_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_TEX_INDIRECTIONS_ARB},
  {  "GL_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_NATIVE_TEX_INSTRUCTIONS_ARB},
  {  "GL_PROGRAM_OBJECT_ARB", DAO_DOUBLE, GL_PROGRAM_OBJECT_ARB},
  {  "GL_PROGRAM_PARAMETERS_ARB", DAO_DOUBLE, GL_PROGRAM_PARAMETERS_ARB},
  {  "GL_PROGRAM_POINT_SIZE_EXT", DAO_DOUBLE, GL_PROGRAM_POINT_SIZE_EXT},
  {  "GL_PROGRAM_STRING_ARB", DAO_DOUBLE, GL_PROGRAM_STRING_ARB},
  {  "GL_PROGRAM_TEMPORARIES_ARB", DAO_DOUBLE, GL_PROGRAM_TEMPORARIES_ARB},
  {  "GL_PROGRAM_TEX_INDIRECTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_TEX_INDIRECTIONS_ARB},
  {  "GL_PROGRAM_TEX_INSTRUCTIONS_ARB", DAO_DOUBLE, GL_PROGRAM_TEX_INSTRUCTIONS_ARB},
  {  "GL_PROGRAM_UNDER_NATIVE_LIMITS_ARB", DAO_DOUBLE, GL_PROGRAM_UNDER_NATIVE_LIMITS_ARB},
  ...
  {  "GL_PROXY_TEXTURE_CUBE_MAP_ARB", DAO_DOUBLE, GL_PROXY_TEXTURE_CUBE_MAP_ARB},
  {  "GL_PROXY_TEXTURE_RECTANGLE_ARB", DAO_DOUBLE, GL_PROXY_TEXTURE_RECTANGLE_ARB},
  {  "GL_PROXY_TEXTURE_RECTANGLE_EXT", DAO_DOUBLE, GL_PROXY_TEXTURE_RECTANGLE_EXT},
  {  "GL_PURGEABLE_APPLE", DAO_DOUBLE, GL_PURGEABLE_APPLE},
  ...
  {  "GL_QUERY_COUNTER_BITS_ARB", DAO_DOUBLE, GL_QUERY_COUNTER_BITS_ARB},
  {  "GL_QUERY_RESULT", DAO_DOUBLE, GL_QUERY_RESULT},
  {  "GL_QUERY_RESULT_ARB", DAO_DOUBLE, GL_QUERY_RESULT_ARB},
  {  "GL_QUERY_RESULT_AVAILABLE", DAO_DOUBLE, GL_QUERY_RESULT_AVAILABLE},
  {  "GL_QUERY_RESULT_AVAILABLE_ARB", DAO_DOUBLE, GL_QUERY_RESULT_AVAILABLE_ARB},
  {  "GL_R", DAO_DOUBLE, GL_R},
  {  "GL_R3_G3_B2", DAO_DOUBLE, GL_R3_G3_B2},
  {  "GL_RASTERIZER_DISCARD_EXT", DAO_DOUBLE, GL_RASTERIZER_DISCARD_EXT},
  {  "GL_RASTER_POSITION_UNCLIPPED_IBM", DAO_DOUBLE, GL_RASTER_POSITION_UNCLIPPED_IBM},
  {  "GL_READ_BUFFER", DAO_DOUBLE, GL_READ_BUFFER},
  {  "GL_READ_FRAMEBUFFER_BINDING_EXT", DAO_DOUBLE, GL_READ_FRAMEBUFFER_BINDING_EXT},
  {  "GL_READ_FRAMEBUFFER_EXT", DAO_DOUBLE, GL_READ_FRAMEBUFFER_EXT},
  {  "GL_READ_ONLY", DAO_DOUBLE, GL_READ_ONLY},
  {  "GL_READ_ONLY_ARB", DAO_DOUBLE, GL_READ_ONLY_ARB},
  {  "GL_READ_WRITE", DAO_DOUBLE, GL_READ_WRITE},
  {  "GL_READ_WRITE_ARB", DAO_DOUBLE, GL_READ_WRITE_ARB},
  ...
  {  "GL_RED_INTEGER_EXT", DAO_DOUBLE, GL_RED_INTEGER_EXT},
  {  "GL_RED_SCALE", DAO_DOUBLE, GL_RED_SCALE},
  {  "GL_REFLECTION_MAP", DAO_DOUBLE, GL_REFLECTION_MAP},
  {  "GL_REFLECTION_MAP_ARB", DAO_DOUBLE, GL_REFLECTION_MAP_ARB},
  {  "GL_REFLECTION_MAP_NV", DAO_DOUBLE, GL_REFLECTION_MAP_NV},
  {  "GL_REGISTER_COMBINERS_NV", DAO_DOUBLE, GL_REGISTER_COMBINERS_NV},
  {  "GL_RELEASED_APPLE", DAO_DOUBLE, GL_RELEASED_APPLE},
  {  "GL_RENDER", DAO_DOUBLE, GL_RENDER},
  {  "GL_RENDERBUFFER_ALPHA_SIZE_EXT", DAO_DOUBLE, GL_RENDERBUFFER_ALPHA_SIZE_EXT},
  {  "GL_RENDERBUFFER_BINDING_EXT", DAO_DOUBLE, GL_RENDERBUFFER_BINDING_EXT},
  {  "GL_RENDERBUFFER_BLUE_SIZE_EXT", DAO_DOUBLE, GL_RENDERBUFFER_BLUE_SIZE_EXT},
  {  "GL_RENDERBUFFER_DEPTH_SIZE_EXT", DAO_DOUBLE, GL_RENDERBUFFER_DEPTH_SIZE_EXT},
  {  "GL_RENDERBUFFER_EXT", DAO_DOUBLE, GL_RENDERBUFFER_EXT},
  {  "GL_RENDERBUFFER_GREEN_SIZE_EXT", DAO_DOUBLE, GL_RENDERBUFFER_GREEN_SIZE_EXT},
  {  "GL_RENDERBUFFER_HEIGHT_EXT", DAO_DOUBLE, GL_RENDERBUFFER_HEIGHT_EXT},
  {  "GL_RENDERBUFFER_INTERNAL_FORMAT_EXT", DAO_DOUBLE, GL_RENDERBUFFER_INTERNAL_FORMAT_EXT},
  {  "GL_RENDERBUFFER_RED_SIZE_EXT", DAO_DOUBLE, GL_RENDERBUFFER_RED_SIZE_EXT},
  {  "GL_RENDERBUFFER_SAMPLES_EXT", DAO_DOUBLE, GL_RENDERBUFFER_SAMPLES_EXT},
  {  "GL_RENDERBUFFER_STENCIL_SIZE_EXT", DAO_DOUBLE, GL_RENDERBUFFER_STENCIL_SIZE_EXT},
  {  "GL_RENDERBUFFER_WIDTH_EXT", DAO_DOUBLE, GL_RENDERBUFFER_WIDTH_EXT},
  ...
  {  "GL_RESCALE_NORMAL_EXT", DAO_DOUBLE, GL_RESCALE_NORMAL_EXT},
  {  "GL_RETAINED_APPLE", DAO_DOUBLE, GL_RETAINED_APPLE},
  ...
  {  "GL_RGB16F_ARB", DAO_DOUBLE, GL_RGB16F_ARB},
  {  "GL_RGB16I_EXT", DAO_DOUBLE, GL_RGB16I_EXT},
  {  "GL_RGB16UI_EXT", DAO_DOUBLE, GL_RGB16UI_EXT},
  {  "GL_RGB32F_ARB", DAO_DOUBLE, GL_RGB32F_ARB},
  {  "GL_RGB32I_EXT", DAO_DOUBLE, GL_RGB32I_EXT},
  {  "GL_RGB32UI_EXT", DAO_DOUBLE, GL_RGB32UI_EXT},
  {  "GL_RGB4", DAO_DOUBLE, GL_RGB4},
  {  "GL_RGB5", DAO_DOUBLE, GL_RGB5},
  {  "GL_RGB5_A1", DAO_DOUBLE, GL_RGB5_A1},
  {  "GL_RGB8", DAO_DOUBLE, GL_RGB8},
  {  "GL_RGB8I_EXT", DAO_DOUBLE, GL_RGB8I_EXT},
  {  "GL_RGB8UI_EXT", DAO_DOUBLE, GL_RGB8UI_EXT},
  {  "GL_RGBA", DAO_DOUBLE, GL_RGBA},
  {  "GL_RGBA12", DAO_DOUBLE, GL_RGBA12},
  {  "GL_RGBA16", DAO_DOUBLE, GL_RGBA16},
  {  "GL_RGBA16F_ARB", DAO_DOUBLE, GL_RGBA16F_ARB},
  {  "GL_RGBA16I_EXT", DAO_DOUBLE, GL_RGBA16I_EXT},
  {  "GL_RGBA16UI_EXT", DAO_DOUBLE, GL_RGBA16UI_EXT},
  {  "GL_RGBA2", DAO_DOUBLE, GL_RGBA2},
  {  "GL_RGBA32F_ARB", DAO_DOUBLE, GL_RGBA32F_ARB},
  {  "GL_RGBA32I_EXT", DAO_DOUBLE, GL_RGBA32I_EXT},
  {  "GL_RGBA32UI_EXT", DAO_DOUBLE, GL_RGBA32UI_EXT},
  {  "GL_RGBA4", DAO_DOUBLE, GL_RGBA4},
  {  "GL_RGBA8", DAO_DOUBLE, GL_RGBA8},
  {  "GL_RGBA8I_EXT", DAO_DOUBLE, GL_RGBA8I_EXT},
  {  "GL_RGBA8UI_EXT", DAO_DOUBLE, GL_RGBA8UI_EXT},
  {  "GL_RGBA_FLOAT16_APPLE", DAO_DOUBLE, GL_RGBA_FLOAT16_APPLE},
  {  "GL_RGBA_FLOAT16_ATI", DAO_DOUBLE, GL_RGBA_FLOAT16_ATI},
  {  "GL_RGBA_FLOAT32_APPLE", DAO_DOUBLE, GL_RGBA_FLOAT32_APPLE},
  {  "GL_RGBA_FLOAT32_ATI", DAO_DOUBLE, GL_RGBA_FLOAT32_ATI},
  {  "GL_RGBA_INTEGER_EXT", DAO_DOUBLE, GL_RGBA_INTEGER_EXT},
  {  "GL_RGBA_INTEGER_MODE_EXT", DAO_DOUBLE, GL_RGBA_INTEGER_MODE_EXT},
  {  "GL_RGBA_MODE", DAO_DOUBLE, GL_RGBA_MODE},
  {  "GL_RGBA_UNSIGNED_DOT_PRODUCT_MAPPING_NV", DAO_DOUBLE, GL_RGBA_UNSIGNED_DOT_PRODUCT_MAPPING_NV},
  {  "GL_RGB_FLOAT16_APPLE", DAO_DOUBLE, GL_RGB_FLOAT16_APPLE},
  {  "GL_RGB_FLOAT16_ATI", DAO_DOUBLE, GL_RGB_FLOAT16_ATI},
  {  "GL_RGB_FLOAT32_APPLE", DAO_DOUBLE, GL_RGB_FLOAT32_APPLE},
  {  "GL_RGB_FLOAT32_ATI", DAO_DOUBLE, GL_RGB_FLOAT32_ATI},
  {  "GL_RGB_INTEGER_EXT", DAO_DOUBLE, GL_RGB_INTEGER_EXT},
  {  "GL_RGB_SCALE", DAO_DOUBLE, GL_RGB_SCALE},
  {  "GL_RGB_SCALE_ARB", DAO_DOUBLE, GL_RGB_SCALE_ARB},
  {  "GL_RIGHT", DAO_DOUBLE, GL_RIGHT},
  {  "GL_S", DAO_DOUBLE, GL_S},
  {  "GL_SAMPLER_1D", DAO_DOUBLE, GL_SAMPLER_1D},
  {  "GL_SAMPLER_1D_ARB", DAO_DOUBLE, GL_SAMPLER_1D_ARB},
  {  "GL_SAMPLER_1D_ARRAY_EXT", DAO_DOUBLE, GL_SAMPLER_1D_ARRAY_EXT},
  {  "GL_SAMPLER_1D_ARRAY_SHADOW_EXT", DAO_DOUBLE, GL_SAMPLER_1D_ARRAY_SHADOW_EXT},
  {  "GL_SAMPLER_1D_SHADOW", DAO_DOUBLE, GL_SAMPLER_1D_SHADOW},
  {  "GL_SAMPLER_1D_SHADOW_ARB", DAO_DOUBLE, GL_SAMPLER_1D_SHADOW_ARB},
  {  "GL_SAMPLER_2D", DAO_DOUBLE, GL_SAMPLER_2D},
  {  "GL_SAMPLER_2D_ARB", DAO_DOUBLE, GL_SAMPLER_2D_ARB},
  {  "GL_SAMPLER_2D_ARRAY_EXT", DAO_DOUBLE, GL_SAMPLER_2D_ARRAY_EXT},
  {  "GL_SAMPLER_2D_ARRAY_SHADOW_EXT", DAO_DOUBLE, GL_SAMPLER_2D_ARRAY_SHADOW_EXT},
  {  "GL_SAMPLER_2D_RECT_ARB", DAO_DOUBLE, GL_SAMPLER_2D_RECT_ARB},
  {  "GL_SAMPLER_2D_RECT_SHADOW_ARB", DAO_DOUBLE, GL_SAMPLER_2D_RECT_SHADOW_ARB},
  {  "GL_SAMPLER_2D_SHADOW", DAO_DOUBLE, GL_SAMPLER_2D_SHADOW},
  {  "GL_SAMPLER_2D_SHADOW_ARB", DAO_DOUBLE, GL_SAMPLER_2D_SHADOW_ARB},
  {  "GL_SAMPLER_3D", DAO_DOUBLE, GL_SAMPLER_3D},
  {  "GL_SAMPLER_3D_ARB", DAO_DOUBLE, GL_SAMPLER_3D_ARB},
  {  "GL_SAMPLER_BUFFER_EXT", DAO_DOUBLE, GL_SAMPLER_BUFFER_EXT},
  {  "GL_SAMPLER_CUBE", DAO_DOUBLE, GL_SAMPLER_CUBE},
  {  "GL_SAMPLER_CUBE_ARB", DAO_DOUBLE, GL_SAMPLER_CUBE_ARB},
  {  "GL_SAMPLER_CUBE_SHADOW_EXT", DAO_DOUBLE, GL_SAMPLER_CUBE_SHADOW_EXT},
  {  "GL_SAMPLES", DAO_DOUBLE, GL_SAMPLES},
  {  "GL_SAMPLES_ARB", DAO_DOUBLE, GL_SAMPLES_ARB},
  {  "GL_SAMPLES_PASSED", DAO_DOUBLE, GL_SAMPLES_PASSED},
  {  "GL_SAMPLES_PASSED_ARB", DAO_DOUBLE, GL_SAMPLES_PASSED_ARB},
  {  "GL_SAMPLE_ALPHA_TO_COVERAGE", DAO_DOUBLE, GL_SAMPLE_ALPHA_TO_COVERAGE},
  {  "GL_SAMPLE_ALPHA_TO_COVERAGE_ARB", DAO_DOUBLE, GL_SAMPLE_ALPHA_TO_COVERAGE_ARB},
  {  "GL_SAMPLE_ALPHA_TO_ONE", DAO_DOUBLE, GL_SAMPLE_ALPHA_TO_ONE},
  {  "GL_SAMPLE_ALPHA_TO_ONE_ARB", DAO_DOUBLE, GL_SAMPLE_ALPHA_TO_ONE_ARB},
  {  "GL_SAMPLE_BUFFERS", DAO_DOUBLE, GL_SAMPLE_BUFFERS},
  {  "GL_SAMPLE_BUFFERS_ARB", DAO_DOUBLE, GL_SAMPLE_BUFFERS_ARB},
  {  "GL_SAMPLE_COVERAGE", DAO_DOUBLE, GL_SAMPLE_COVERAGE},
  {  "GL_SAMPLE_COVERAGE_ARB", DAO_DOUBLE, GL_SAMPLE_COVERAGE_ARB},
  {  "GL_SAMPLE_COVERAGE_INVERT", DAO_DOUBLE, GL_SAMPLE_COVERAGE_INVERT},
  {  "GL_SAMPLE_COVERAGE_INVERT_ARB", DAO_DOUBLE, GL_SAMPLE_COVERAGE_INVERT_ARB},
  {  "GL_SAMPLE_COVERAGE_VALUE", DAO_DOUBLE, GL_SAMPLE_COVERAGE_VALUE},
  {  "GL_SAMPLE_COVERAGE_VALUE_ARB", DAO_DOUBLE, GL_SAMPLE_COVERAGE_VALUE_ARB},
  {  "GL_SCALE_BY_FOUR_NV", DAO_DOUBLE, GL_SCALE_BY_FOUR_NV},
  {  "GL_SCALE_BY_ONE_HALF_NV", DAO_DOUBLE, GL_SCALE_BY_ONE_HALF_NV},
  {  "GL_SCALE_BY_TWO_NV", DAO_DOUBLE, GL_SCALE_BY_TWO_NV},
  ...
  {  "GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_SECONDARY_COLOR_ARRAY_EXT", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_EXT},
  {  "GL_SECONDARY_COLOR_ARRAY_POINTER", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_POINTER},
  {  "GL_SECONDARY_COLOR_ARRAY_POINTER_EXT", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_POINTER_EXT},
  {  "GL_SECONDARY_COLOR_ARRAY_SIZE", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_SIZE},
  {  "GL_SECONDARY_COLOR_ARRAY_SIZE_EXT", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_SIZE_EXT},
  {  "GL_SECONDARY_COLOR_ARRAY_STRIDE", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_STRIDE},
  {  "GL_SECONDARY_COLOR_ARRAY_STRIDE_EXT", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_STRIDE_EXT},
  {  "GL_SECONDARY_COLOR_ARRAY_TYPE", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_TYPE},
  {  "GL_SECONDARY_COLOR_ARRAY_TYPE_EXT", DAO_DOUBLE, GL_SECONDARY_COLOR_ARRAY_TYPE_EXT},
  {  "GL_SECONDARY_COLOR_NV", DAO_DOUBLE, GL_SECONDARY_COLOR_NV},
  ...
  {  "GL_SEPARATE_ATTRIBS_EXT", DAO_DOUBLE, GL_SEPARATE_ATTRIBS_EXT},
  {  "GL_SEPARATE_SPECULAR_COLOR", DAO_DOUBLE, GL_SEPARATE_SPECULAR_COLOR},
  {  "GL_SEPARATE_SPECULAR_COLOR_EXT", DAO_DOUBLE, GL_SEPARATE_SPECULAR_COLOR_EXT},
  {  "GL_SET", DAO_DOUBLE, GL_SET},
  {  "GL_SGIS_generate_mipmap", DAO_DOUBLE, GL_SGIS_generate_mipmap},
  {  "GL_SGIS_texture_edge_clamp", DAO_DOUBLE, GL_SGIS_texture_edge_clamp},
  {  "GL_SGIS_texture_lod", DAO_DOUBLE, GL_SGIS_texture_lod},
  {  "GL_SGI_color_matrix", DAO_DOUBLE, GL_SGI_color_matrix},
  {  "GL_SHADER_CONSISTENT_NV", DAO_DOUBLE, GL_SHADER_CONSISTENT_NV},
  {  "GL_SHADER_OBJECT_ARB", DAO_DOUBLE, GL_SHADER_OBJECT_ARB},
  {  "GL_SHADER_OPERATION_NV", DAO_DOUBLE, GL_SHADER_OPERATION_NV},
  ...
  {  "GL_SHADING_LANGUAGE_VERSION_ARB", DAO_DOUBLE, GL_SHADING_LANGUAGE_VERSION_ARB},
  {  "GL_SHININESS", DAO_DOUBLE, GL_SHININESS},
  {  "GL_SHORT", DAO_DOUBLE, GL_SHORT},
  {  "GL_SIGNED_ALPHA8_NV", DAO_DOUBLE, GL_SIGNED_ALPHA8_NV},
  {  "GL_SIGNED_ALPHA_NV", DAO_DOUBLE, GL_SIGNED_ALPHA_NV},
  {  "GL_SIGNED_HILO16_NV", DAO_DOUBLE, GL_SIGNED_HILO16_NV},
  {  "GL_SIGNED_HILO8_NV", DAO_DOUBLE, GL_SIGNED_HILO8_NV},
  {  "GL_SIGNED_HILO_NV", DAO_DOUBLE, GL_SIGNED_HILO_NV},
  {  "GL_SIGNED_IDENTITY_NV", DAO_DOUBLE, GL_SIGNED_IDENTITY_NV},
  {  "GL_SIGNED_INTENSITY8_NV", DAO_DOUBLE, GL_SIGNED_INTENSITY8_NV},
  {  "GL_SIGNED_INTENSITY_NV", DAO_DOUBLE, GL_SIGNED_INTENSITY_NV},
  {  "GL_SIGNED_LUMINANCE8_ALPHA8_NV", DAO_DOUBLE, GL_SIGNED_LUMINANCE8_ALPHA8_NV},
  {  "GL_SIGNED_LUMINANCE8_NV", DAO_DOUBLE, GL_SIGNED_LUMINANCE8_NV},
  {  "GL_SIGNED_LUMINANCE_ALPHA_NV", DAO_DOUBLE, GL_SIGNED_LUMINANCE_ALPHA_NV},
  {  "GL_SIGNED_LUMINANCE_NV", DAO_DOUBLE, GL_SIGNED_LUMINANCE_NV},
  {  "GL_SIGNED_NEGATE_NV", DAO_DOUBLE, GL_SIGNED_NEGATE_NV},
  {  "GL_SIGNED_RGB8_NV", DAO_DOUBLE, GL_SIGNED_RGB8_NV},
  {  "GL_SIGNED_RGB8_UNSIGNED_ALPHA8_NV", DAO_DOUBLE, GL_SIGNED_RGB8_UNSIGNED_ALPHA8_NV},
  {  "GL_SIGNED_RGBA8_NV", DAO_DOUBLE, GL_SIGNED_RGBA8_NV},
  {  "GL_SIGNED_RGBA_NV", DAO_DOUBLE, GL_SIGNED_RGBA_NV},
  {  "GL_SIGNED_RGB_NV", DAO_DOUBLE, GL_SIGNED_RGB_NV},
  {  "GL_SIGNED_RGB_UNSIGNED_ALPHA_NV", DAO_DOUBLE, GL_SIGNED_RGB_UNSIGNED_ALPHA_NV},
  {  "GL_SINGLE_COLOR", DAO_DOUBLE, GL_SINGLE_COLOR},
  {  "GL_SINGLE_COLOR_EXT", DAO_DOUBLE, GL_SINGLE_COLOR_EXT},
  ...
  {  "GL_SLUMINANCE8_ALPHA8_EXT", DAO_DOUBLE, GL_SLUMINANCE8_ALPHA8_EXT},
  {  "GL_SLUMINANCE8_EXT", DAO_DOUBLE, GL_SLUMINANCE8_EXT},
  {  "GL_SLUMINANCE_ALPHA", DAO_DOUBLE, GL_SLUMINANCE_ALPHA},
  {  "GL_SLUMINANCE_ALPHA_EXT", DAO_DOUBLE, GL_SLUMINANCE_ALPHA_EXT},
  {  "GL_SLUMINANCE_EXT", DAO_DOUBLE, GL_SLUMINANCE_EXT},
  ...
  {  "GL_SOURCE0_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE0_ALPHA_ARB},
  {  "GL_SOURCE0_RGB", DAO_DOUBLE, GL_SOURCE0_RGB},
  {  "GL_SOURCE0_RGB_ARB", DAO_DOUBLE, GL_SOURCE0_RGB_ARB},
  {  "GL_SOURCE1_ALPHA", DAO_DOUBLE, GL_SOURCE1_ALPHA},
  {  "GL_SOURCE1_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE1_ALPHA_ARB},
  {  "GL_SOURCE1_RGB", DAO_DOUBLE, GL_SOURCE1_RGB},
  {  "GL_SOURCE1_RGB_ARB", DAO_DOUBLE, GL_SOURCE1_RGB_ARB},
  {  "GL_SOURCE2_ALPHA", DAO_DOUBLE, GL_SOURCE2_ALPHA},
  {  "GL_SOURCE2_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE2_ALPHA_ARB},
  {  "GL_SOURCE2_RGB", DAO_DOUBLE, GL_SOURCE2_RGB},
  {  "GL_SOURCE2_RGB_ARB", DAO_DOUBLE, GL_SOURCE2_RGB_ARB},
  {  "GL_SOURCE3_ALPHA", DAO_DOUBLE, GL_SOURCE3_ALPHA},
  {  "GL_SOURCE3_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE3_ALPHA_ARB},
  {  "GL_SOURCE3_RGB", DAO_DOUBLE, GL_SOURCE3_RGB},
  {  "GL_SOURCE3_RGB_ARB", DAO_DOUBLE, GL_SOURCE3_RGB_ARB},
  {  "GL_SOURCE4_ALPHA", DAO_DOUBLE, GL_SOURCE4_ALPHA},
  {  "GL_SOURCE4_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE4_ALPHA_ARB},
  {  "GL_SOURCE4_RGB", DAO_DOUBLE, GL_SOURCE4_RGB},
  {  "GL_SOURCE4_RGB_ARB", DAO_DOUBLE, GL_SOURCE4_RGB_ARB},
  {  "GL_SOURCE5_ALPHA", DAO_DOUBLE, GL_SOURCE5_ALPHA},
  {  "GL_SOURCE5_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE5_ALPHA_ARB},
  {  "GL_SOURCE5_RGB", DAO_DOUBLE, GL_SOURCE5_RGB},
  {  "GL_SOURCE5_RGB_ARB", DAO_DOUBLE, GL_SOURCE5_RGB_ARB},
  {  "GL_SOURCE6_ALPHA", DAO_DOUBLE, GL_SOURCE6_ALPHA},
  {  "GL_SOURCE6_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE6_ALPHA_ARB},
  {  "GL_SOURCE6_RGB", DAO_DOUBLE, GL_SOURCE6_RGB},
  {  "GL_SOURCE6_RGB_ARB", DAO_DOUBLE, GL_SOURCE6_RGB_ARB},
  {  "GL_SOURCE7_ALPHA", DAO_DOUBLE, GL_SOURCE7_ALPHA},
  {  "GL_SOURCE7_ALPHA_ARB", DAO_DOUBLE, GL_SOURCE7_ALPHA_ARB},
  {  "GL_SOURCE7_RGB", DAO_DOUBLE, GL_SOURCE7_RGB},
  {  "GL_SOURCE7_RGB_ARB", DAO_DOUBLE, GL_SOURCE7_RGB_ARB},
  {  "GL_SPARE0_NV", DAO_DOUBLE, GL_SPARE0_NV},
  {  "GL_SPARE0_PLUS_SECONDARY_COLOR_NV", DAO_DOUBLE, GL_SPARE0_PLUS_SECONDARY_COLOR_NV},
  {  "GL_SPARE1_NV", DAO_DOUBLE, GL_SPARE1_NV},
  ...
  {  "GL_SRC3_ALPHA", DAO_DOUBLE, GL_SRC3_ALPHA},
  {  "GL_SRC3_RGB", DAO_DOUBLE, GL_SRC3_RGB},
  {  "GL_SRC4_ALPHA", DAO_DOUBLE, GL_SRC4_ALPHA},
  {  "GL_SRC4_RGB", DAO_DOUBLE, GL_SRC4_RGB},
  {  "GL_SRC5_ALPHA", DAO_DOUBLE, GL_SRC5_ALPHA},
  {  "GL_SRC5_RGB", DAO_DOUBLE, GL_SRC5_RGB},
  {  "GL_SRC6_ALPHA", DAO_DOUBLE, GL_SRC6_ALPHA},
  {  "GL_SRC6_RGB", DAO_DOUBLE, GL_SRC6_RGB},
  {  "GL_SRC7_ALPHA", DAO_DOUBLE, GL_SRC7_ALPHA},
  {  "GL_SRC7_RGB", DAO_DOUBLE, GL_SRC7_RGB},
  ...
  {  "GL_SRGB8_ALPHA8_EXT", DAO_DOUBLE, GL_SRGB8_ALPHA8_EXT},
  {  "GL_SRGB8_EXT", DAO_DOUBLE, GL_SRGB8_EXT},
  {  "GL_SRGB_ALPHA", DAO_DOUBLE, GL_SRGB_ALPHA},
  {  "GL_SRGB_ALPHA_EXT", DAO_DOUBLE, GL_SRGB_ALPHA_EXT},
  {  "GL_SRGB_EXT", DAO_DOUBLE, GL_SRGB_EXT},
  ...
  {  "GL_STATIC_COPY_ARB", DAO_DOUBLE, GL_STATIC_COPY_ARB},
  {  "GL_STATIC_DRAW", DAO_DOUBLE, GL_STATIC_DRAW},
  {  "GL_STATIC_DRAW_ARB", DAO_DOUBLE, GL_STATIC_DRAW_ARB},
  {  "GL_STATIC_READ", DAO_DOUBLE, GL_STATIC_READ},
  {  "GL_STATIC_READ_ARB", DAO_DOUBLE, GL_STATIC_READ_ARB},
  {  "GL_STENCIL", DAO_DOUBLE, GL_STENCIL},
  {  "GL_STENCIL_ATTACHMENT_EXT", DAO_DOUBLE, GL_STENCIL_ATTACHMENT_EXT},
  {  "GL_STENCIL_BACK_FAIL", DAO_DOUBLE, GL_STENCIL_BACK_FAIL},
  {  "GL_STENCIL_BACK_FAIL_ATI", DAO_DOUBLE, GL_STENCIL_BACK_FAIL_ATI},
  {  "GL_STENCIL_BACK_FUNC", DAO_DOUBLE, GL_STENCIL_BACK_FUNC},
  {  "GL_STENCIL_BACK_FUNC_ATI", DAO_DOUBLE, GL_STENCIL_BACK_FUNC_ATI},
  {  "GL_STENCIL_BACK_PASS_DEPTH_FAIL", DAO_DOUBLE, GL_STENCIL_BACK_PASS_DEPTH_FAIL},
  {  "GL_STENCIL_BACK_PASS_DEPTH_FAIL_ATI", DAO_DOUBLE, GL_STENCIL_BACK_PASS_DEPTH_FAIL_ATI},
  {  "GL_STENCIL_BACK_PASS_DEPTH_PASS", DAO_DOUBLE, GL_STENCIL_BACK_PASS_DEPTH_PASS},
  {  "GL_STENCIL_BACK_PASS_DEPTH_PASS_ATI", DAO_DOUBLE, GL_STENCIL_BACK_PASS_DEPTH_PASS_ATI},
  ...
  {  "GL_STENCIL_INDEX16_EXT", DAO_DOUBLE, GL_STENCIL_INDEX16_EXT},
  {  "GL_STENCIL_INDEX1_EXT", DAO_DOUBLE, GL_STENCIL_INDEX1_EXT},
  {  "GL_STENCIL_INDEX4_EXT", DAO_DOUBLE, GL_STENCIL_INDEX4_EXT},
  {  "GL_STENCIL_INDEX8_EXT", DAO_DOUBLE, GL_STENCIL_INDEX8_EXT},
  ...
  {  "GL_STENCIL_TEST_TWO_SIDE_EXT", DAO_DOUBLE, GL_STENCIL_TEST_TWO_SIDE_EXT},
  ...
  {  "GL_STORAGE_CACHED_APPLE", DAO_DOUBLE, GL_STORAGE_CACHED_APPLE},
  {  "GL_STORAGE_CLIENT_APPLE", DAO_DOUBLE, GL_STORAGE_CLIENT_APPLE},
  {  "GL_STORAGE_PRIVATE_APPLE", DAO_DOUBLE, GL_STORAGE_PRIVATE_APPLE},
  {  "GL_STORAGE_SHARED_APPLE", DAO_DOUBLE, GL_STORAGE_SHARED_APPLE},
  {  "GL_STREAM_COPY", DAO_DOUBLE, GL_STREAM_COPY},
  {  "GL_STREAM_COPY_ARB", DAO_DOUBLE, GL_STREAM_COPY_ARB},
  {  "GL_STREAM_DRAW", DAO_DOUBLE, GL_STREAM_DRAW},
  {  "GL_STREAM_DRAW_ARB", DAO_DOUBLE, GL_STREAM_DRAW_ARB},
  {  "GL_STREAM_READ", DAO_DOUBLE, GL_STREAM_READ},
  {  "GL_STREAM_READ_ARB", DAO_DOUBLE, GL_STREAM_READ_ARB},
  {  "GL_SUBPIXEL_BITS", DAO_DOUBLE, GL_SUBPIXEL_BITS},
  {  "GL_SUBTRACT", DAO_DOUBLE, GL_SUBTRACT},
  {  "GL_SUBTRACT_ARB", DAO_DOUBLE, GL_SUBTRACT_ARB},
  ...
  {  "GL_TEXTURE0_ARB", DAO_DOUBLE, GL_TEXTURE0_ARB},
  {  "GL_TEXTURE1", DAO_DOUBLE, GL_TEXTURE1},
  {  "GL_TEXTURE10", DAO_DOUBLE, GL_TEXTURE10},
  {  "GL_TEXTURE10_ARB", DAO_DOUBLE, GL_TEXTURE10_ARB},
  {  "GL_TEXTURE11", DAO_DOUBLE, GL_TEXTURE11},
  {  "GL_TEXTURE11_ARB", DAO_DOUBLE, GL_TEXTURE11_ARB},
  {  "GL_TEXTURE12", DAO_DOUBLE, GL_TEXTURE12},
  {  "GL_TEXTURE12_ARB", DAO_DOUBLE, GL_TEXTURE12_ARB},
  {  "GL_TEXTURE13", DAO_DOUBLE, GL_TEXTURE13},
  {  "GL_TEXTURE13_ARB", DAO_DOUBLE, GL_TEXTURE13_ARB},
  {  "GL_TEXTURE14", DAO_DOUBLE, GL_TEXTURE14},
  {  "GL_TEXTURE14_ARB", DAO_DOUBLE, GL_TEXTURE14_ARB},
  {  "GL_TEXTURE15", DAO_DOUBLE, GL_TEXTURE15},
  {  "GL_TEXTURE15_ARB", DAO_DOUBLE, GL_TEXTURE15_ARB},
  {  "GL_TEXTURE16", DAO_DOUBLE, GL_TEXTURE16},
  {  "GL_TEXTURE16_ARB", DAO_DOUBLE, GL_TEXTURE16_ARB},
  {  "GL_TEXTURE17", DAO_DOUBLE, GL_TEXTURE17},
  {  "GL_TEXTURE17_ARB", DAO_DOUBLE, GL_TEXTURE17_ARB},
  {  "GL_TEXTURE18", DAO_DOUBLE, GL_TEXTURE18},
  {  "GL_TEXTURE18_ARB", DAO_DOUBLE, GL_TEXTURE18_ARB},
  {  "GL_TEXTURE19", DAO_DOUBLE, GL_TEXTURE19},
  {  "GL_TEXTURE19_ARB", DAO_DOUBLE, GL_TEXTURE19_ARB},
  {  "GL_TEXTURE1_ARB", DAO_DOUBLE, GL_TEXTURE1_ARB},
  {  "GL_TEXTURE2", DAO_DOUBLE, GL_TEXTURE2},
  {  "GL_TEXTURE20", DAO_DOUBLE, GL_TEXTURE20},
  {  "GL_TEXTURE20_ARB", DAO_DOUBLE, GL_TEXTURE20_ARB},
  {  "GL_TEXTURE21", DAO_DOUBLE, GL_TEXTURE21},
  {  "GL_TEXTURE21_ARB", DAO_DOUBLE, GL_TEXTURE21_ARB},
  {  "GL_TEXTURE22", DAO_DOUBLE, GL_TEXTURE22},
  {  "GL_TEXTURE22_ARB", DAO_DOUBLE, GL_TEXTURE22_ARB},
  {  "GL_TEXTURE23", DAO_DOUBLE, GL_TEXTURE23},
  {  "GL_TEXTURE23_ARB", DAO_DOUBLE, GL_TEXTURE23_ARB},
  {  "GL_TEXTURE24", DAO_DOUBLE, GL_TEXTURE24},
  {  "GL_TEXTURE24_ARB", DAO_DOUBLE, GL_TEXTURE24_ARB},
  {  "GL_TEXTURE25", DAO_DOUBLE, GL_TEXTURE25},
  {  "GL_TEXTURE25_ARB", DAO_DOUBLE, GL_TEXTURE25_ARB},
  {  "GL_TEXTURE26", DAO_DOUBLE, GL_TEXTURE26},
  {  "GL_TEXTURE26_ARB", DAO_DOUBLE, GL_TEXTURE26_ARB},
  {  "GL_TEXTURE27", DAO_DOUBLE, GL_TEXTURE27},
  {  "GL_TEXTURE27_ARB", DAO_DOUBLE, GL_TEXTURE27_ARB},
  {  "GL_TEXTURE28", DAO_DOUBLE, GL_TEXTURE28},
  {  "GL_TEXTURE28_ARB", DAO_DOUBLE, GL_TEXTURE28_ARB},
  {  "GL_TEXTURE29", DAO_DOUBLE, GL_TEXTURE29},
  {  "GL_TEXTURE29_ARB", DAO_DOUBLE, GL_TEXTURE29_ARB},
  {  "GL_TEXTURE2_ARB", DAO_DOUBLE, GL_TEXTURE2_ARB},
  {  "GL_TEXTURE3", DAO_DOUBLE, GL_TEXTURE3},
  {  "GL_TEXTURE30", DAO_DOUBLE, GL_TEXTURE30},
  {  "GL_TEXTURE30_ARB", DAO_DOUBLE, GL_TEXTURE30_ARB},
  {  "GL_TEXTURE31", DAO_DOUBLE, GL_TEXTURE31},
  {  "GL_TEXTURE31_ARB", DAO_DOUBLE, GL_TEXTURE31_ARB},
  {  "GL_TEXTURE3_ARB", DAO_DOUBLE, GL_TEXTURE3_ARB},
  {  "GL_TEXTURE4", DAO_DOUBLE, GL_TEXTURE4},
  {  "GL_TEXTURE4_ARB", DAO_DOUBLE, GL_TEXTURE4_ARB},
  {  "GL_TEXTURE5", DAO_DOUBLE, GL_TEXTURE5},
  {  "GL_TEXTURE5_ARB", DAO_DOUBLE, GL_TEXTURE5_ARB},
  {  "GL_TEXTURE6", DAO_DOUBLE, GL_TEXTURE6},
  {  "GL_TEXTURE6_ARB", DAO_DOUBLE, GL_TEXTURE6_ARB},
  {  "GL_TEXTURE7", DAO_DOUBLE, GL_TEXTURE7},
  {  "GL_TEXTURE7_ARB", DAO_DOUBLE, GL_TEXTURE7_ARB},
  {  "GL_TEXTURE8", DAO_DOUBLE, GL_TEXTURE8},
  {  "GL_TEXTURE8_ARB", DAO_DOUBLE, GL_TEXTURE8_ARB},
  {  "GL_TEXTURE9", DAO_DOUBLE, GL_TEXTURE9},
  {  "GL_TEXTURE9_ARB", DAO_DOUBLE, GL_TEXTURE9_ARB},
  ...
  {  "GL_TEXTURE_ALPHA_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_ALPHA_TYPE_ARB},
  {  "GL_TEXTURE_BASE_LEVEL", DAO_DOUBLE, GL_TEXTURE_BASE_LEVEL},
  {  "GL_TEXTURE_BASE_LEVEL_SGIS", DAO_DOUBLE, GL_TEXTURE_BASE_LEVEL_SGIS},
  ...
  {  "GL_TEXTURE_BINDING_CUBE_MAP_ARB", DAO_DOUBLE, GL_TEXTURE_BINDING_CUBE_MAP_ARB},
  {  "GL_TEXTURE_BINDING_RECTANGLE_ARB", DAO_DOUBLE, GL_TEXTURE_BINDING_RECTANGLE_ARB},
  {  "GL_TEXTURE_BINDING_RECTANGLE_EXT", DAO_DOUBLE, GL_TEXTURE_BINDING_RECTANGLE_EXT},
  {  "GL_TEXTURE_BIT", DAO_DOUBLE, GL_TEXTURE_BIT},
  {  "GL_TEXTURE_BLUE_SIZE", DAO_DOUBLE, GL_TEXTURE_BLUE_SIZE},
  {  "GL_TEXTURE_BLUE_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_BLUE_TYPE_ARB},
  {  "GL_TEXTURE_BORDER", DAO_DOUBLE, GL_TEXTURE_BORDER},
  {  "GL_TEXTURE_BORDER_COLOR", DAO_DOUBLE, GL_TEXTURE_BORDER_COLOR},
  {  "GL_TEXTURE_BORDER_VALUES_NV", DAO_DOUBLE, GL_TEXTURE_BORDER_VALUES_NV},
  {  "GL_TEXTURE_COMPARE_FAIL_VALUE_ARB", DAO_DOUBLE, GL_TEXTURE_COMPARE_FAIL_VALUE_ARB},
  {  "GL_TEXTURE_COMPARE_FUNC", DAO_DOUBLE, GL_TEXTURE_COMPARE_FUNC},
  {  "GL_TEXTURE_COMPARE_FUNC_ARB", DAO_DOUBLE, GL_TEXTURE_COMPARE_FUNC_ARB},
  {  "GL_TEXTURE_COMPARE_MODE", DAO_DOUBLE, GL_TEXTURE_COMPARE_MODE},
  {  "GL_TEXTURE_COMPARE_MODE_ARB", DAO_DOUBLE, GL_TEXTURE_COMPARE_MODE_ARB},
  {  "GL_TEXTURE_COMPRESSED", DAO_DOUBLE, GL_TEXTURE_COMPRESSED},
  {  "GL_TEXTURE_COMPRESSED_ARB", DAO_DOUBLE, GL_TEXTURE_COMPRESSED_ARB},
  {  "GL_TEXTURE_COMPRESSED_IMAGE_SIZE", DAO_DOUBLE, GL_TEXTURE_COMPRESSED_IMAGE_SIZE},
  {  "GL_TEXTURE_COMPRESSED_IMAGE_SIZE_ARB", DAO_DOUBLE, GL_TEXTURE_COMPRESSED_IMAGE_SIZE_ARB},
  {  "GL_TEXTURE_COMPRESSION_HINT", DAO_DOUBLE, GL_TEXTURE_COMPRESSION_HINT},
  {  "GL_TEXTURE_COMPRESSION_HINT_ARB", DAO_DOUBLE, GL_TEXTURE_COMPRESSION_HINT_ARB},
  ...
  {  "GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING_ARB},
  ...
  {  "GL_TEXTURE_CUBE_MAP_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_ARB},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_X", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_NEGATIVE_X},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_X_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_NEGATIVE_X_ARB},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_Y", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_NEGATIVE_Y},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_ARB},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_Z", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_NEGATIVE_Z},
  {  "GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_ARB},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_X", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_POSITIVE_X},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_X_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_POSITIVE_X_ARB},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_Y", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_POSITIVE_Y},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_Y_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_POSITIVE_Y_ARB},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_Z", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_POSITIVE_Z},
  {  "GL_TEXTURE_CUBE_MAP_POSITIVE_Z_ARB", DAO_DOUBLE, GL_TEXTURE_CUBE_MAP_POSITIVE_Z_ARB},
  {  "GL_TEXTURE_DEPTH", DAO_DOUBLE, GL_TEXTURE_DEPTH},
  {  "GL_TEXTURE_DEPTH_SIZE", DAO_DOUBLE, GL_TEXTURE_DEPTH_SIZE},
  {  "GL_TEXTURE_DEPTH_SIZE_ARB", DAO_DOUBLE, GL_TEXTURE_DEPTH_SIZE_ARB},
  {  "GL_TEXTURE_DEPTH_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_DEPTH_TYPE_ARB},
  {  "GL_TEXTURE_DS_SIZE_NV", DAO_DOUBLE, GL_TEXTURE_DS_SIZE_NV},
  {  "GL_TEXTURE_DT_SIZE_NV", DAO_DOUBLE, GL_TEXTURE_DT_SIZE_NV},
  ...
  {  "GL_TEXTURE_FILTER_CONTROL_EXT", DAO_DOUBLE, GL_TEXTURE_FILTER_CONTROL_EXT},
  ...
  {  "GL_TEXTURE_GREEN_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_GREEN_TYPE_ARB},
  {  "GL_TEXTURE_HEIGHT", DAO_DOUBLE, GL_TEXTURE_HEIGHT},
  {  "GL_TEXTURE_HI_SIZE_NV", DAO_DOUBLE, GL_TEXTURE_HI_SIZE_NV},
  {  "GL_TEXTURE_INDEX_SIZE_EXT", DAO_DOUBLE, GL_TEXTURE_INDEX_SIZE_EXT},
  {  "GL_TEXTURE_INTENSITY_SIZE", DAO_DOUBLE, GL_TEXTURE_INTENSITY_SIZE},
  {  "GL_TEXTURE_INTENSITY_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_INTENSITY_TYPE_ARB},
  {  "GL_TEXTURE_INTERNAL_FORMAT", DAO_DOUBLE, GL_TEXTURE_INTERNAL_FORMAT},
  {  "GL_TEXTURE_LOD_BIAS", DAO_DOUBLE, GL_TEXTURE_LOD_BIAS},
  {  "GL_TEXTURE_LOD_BIAS_EXT", DAO_DOUBLE, GL_TEXTURE_LOD_BIAS_EXT},
  {  "GL_TEXTURE_LO_SIZE_NV", DAO_DOUBLE, GL_TEXTURE_LO_SIZE_NV},
  {  "GL_TEXTURE_LUMINANCE_SIZE", DAO_DOUBLE, GL_TEXTURE_LUMINANCE_SIZE},
  {  "GL_TEXTURE_LUMINANCE_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_LUMINANCE_TYPE_ARB},
  {  "GL_TEXTURE_MAG_FILTER", DAO_DOUBLE, GL_TEXTURE_MAG_FILTER},
  {  "GL_TEXTURE_MAG_SIZE_NV", DAO_DOUBLE, GL_TEXTURE_MAG_SIZE_NV},
  {  "GL_TEXTURE_MATRIX", DAO_DOUBLE, GL_TEXTURE_MATRIX},
  {  "GL_TEXTURE_MAX_ANISOTROPY_EXT", DAO_DOUBLE, GL_TEXTURE_MAX_ANISOTROPY_EXT},
  {  "GL_TEXTURE_MAX_LEVEL", DAO_DOUBLE, GL_TEXTURE_MAX_LEVEL},
  {  "GL_TEXTURE_MAX_LEVEL_SGIS", DAO_DOUBLE, GL_TEXTURE_MAX_LEVEL_SGIS},
  {  "GL_TEXTURE_MAX_LOD", DAO_DOUBLE, GL_TEXTURE_MAX_LOD},
  {  "GL_TEXTURE_MAX_LOD_SGIS", DAO_DOUBLE, GL_TEXTURE_MAX_LOD_SGIS},
  {  "GL_TEXTURE_MINIMIZE_STORAGE_APPLE", DAO_DOUBLE, GL_TEXTURE_MINIMIZE_STORAGE_APPLE},
  {  "GL_TEXTURE_MIN_FILTER", DAO_DOUBLE, GL_TEXTURE_MIN_FILTER},
  {  "GL_TEXTURE_MIN_LOD", DAO_DOUBLE, GL_TEXTURE_MIN_LOD},
  {  "GL_TEXTURE_MIN_LOD_SGIS", DAO_DOUBLE, GL_TEXTURE_MIN_LOD_SGIS},
  {  "GL_TEXTURE_PRIORITY", DAO_DOUBLE, GL_TEXTURE_PRIORITY},
  {  "GL_TEXTURE_RANGE_LENGTH_APPLE", DAO_DOUBLE, GL_TEXTURE_RANGE_LENGTH_APPLE},
  {  "GL_TEXTURE_RANGE_POINTER_APPLE", DAO_DOUBLE, GL_TEXTURE_RANGE_POINTER_APPLE},
  {  "GL_TEXTURE_RECTANGLE_ARB", DAO_DOUBLE, GL_TEXTURE_RECTANGLE_ARB},
  {  "GL_TEXTURE_RECTANGLE_EXT", DAO_DOUBLE, GL_TEXTURE_RECTANGLE_EXT},
  {  "GL_TEXTURE_RED_SIZE", DAO_DOUBLE, GL_TEXTURE_RED_SIZE},
  {  "GL_TEXTURE_RED_TYPE_ARB", DAO_DOUBLE, GL_TEXTURE_RED_TYPE_ARB},
  {  "GL_TEXTURE_RESIDENT", DAO_DOUBLE, GL_TEXTURE_RESIDENT},
  {  "GL_TEXTURE_SHADER_NV", DAO_DOUBLE, GL_TEXTURE_SHADER_NV},
  {  "GL_TEXTURE_STACK_DEPTH", DAO_DOUBLE, GL_TEXTURE_STACK_DEPTH},
  {  "GL_TEXTURE_STENCIL_SIZE_EXT", DAO_DOUBLE, GL_TEXTURE_STENCIL_SIZE_EXT},
  {  "GL_TEXTURE_STORAGE_HINT_APPLE", DAO_DOUBLE, GL_TEXTURE_STORAGE_HINT_APPLE},
  ...
  {  "GL_TEXT_FRAGMENT_SHADER_ATI", DAO_DOUBLE, GL_TEXT_FRAGMENT_SHADER_ATI},
  {  "GL_TRANSFORM_BIT", DAO_DOUBLE, GL_TRANSFORM_BIT},
  {  "GL_TRANSFORM_FEEDBACK_BUFFER_BINDING_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING_EXT},
  {  "GL_TRANSFORM_FEEDBACK_BUFFER_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_BUFFER_EXT},
  {  "GL_TRANSFORM_FEEDBACK_BUFFER_MODE_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_BUFFER_MODE_EXT},
  {  "GL_TRANSFORM_FEEDBACK_BUFFER_SIZE_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_BUFFER_SIZE_EXT},
  {  "GL_TRANSFORM_FEEDBACK_BUFFER_START_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_BUFFER_START_EXT},
  {  "GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN_EXT},
  {  "GL_TRANSFORM_FEEDBACK_VARYINGS_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_VARYINGS_EXT},
  {  "GL_TRANSFORM_FEEDBACK_VARYING_MAX_LENGTH_EXT", DAO_DOUBLE, GL_TRANSFORM_FEEDBACK_VARYING_MAX_LENGTH_EXT},
  {  "GL_TRANSFORM_HINT_APPLE", DAO_DOUBLE, GL_TRANSFORM_HINT_APPLE},
  {  "GL_TRANSPOSE_COLOR_MATRIX", DAO_DOUBLE, GL_TRANSPOSE_COLOR_MATRIX},
  {  "GL_TRANSPOSE_COLOR_MATRIX_ARB", DAO_DOUBLE, GL_TRANSPOSE_COLOR_MATRIX_ARB},
  {  "GL_TRANSPOSE_CURRENT_MATRIX_ARB", DAO_DOUBLE, GL_TRANSPOSE_CURRENT_MATRIX_ARB},
  {  "GL_TRANSPOSE_MODELVIEW_MATRIX", DAO_DOUBLE, GL_TRANSPOSE_MODELVIEW_MATRIX},
  {  "GL_TRANSPOSE_MODELVIEW_MATRIX_ARB", DAO_DOUBLE, GL_TRANSPOSE_MODELVIEW_MATRIX_ARB},
  {  "GL_TRANSPOSE_PROJECTION_MATRIX", DAO_DOUBLE, GL_TRANSPOSE_PROJECTION_MATRIX},
  {  "GL_TRANSPOSE_PROJECTION_MATRIX_ARB", DAO_DOUBLE, GL_TRANSPOSE_PROJECTION_MATRIX_ARB},
  {  "GL_TRANSPOSE_TEXTURE_MATRIX", DAO_DOUBLE, GL_TRANSPOSE_TEXTURE_MATRIX},
  {  "GL_TRANSPOSE_TEXTURE_MATRIX_ARB", DAO_DOUBLE, GL_TRANSPOSE_TEXTURE_MATRIX_ARB},
  {  "GL_TRIANGLES", DAO_DOUBLE, GL_TRIANGLES},
  {  "GL_TRIANGLES_ADJACENCY_EXT", DAO_DOUBLE, GL_TRIANGLES_ADJACENCY_EXT},
  {  "GL_TRIANGLE_FAN", DAO_DOUBLE, GL_TRIANGLE_FAN},
  {  "GL_TRIANGLE_STRIP", DAO_DOUBLE, GL_TRIANGLE_STRIP},
  {  "GL_TRIANGLE_STRIP_ADJACENCY_EXT", DAO_DOUBLE, GL_TRIANGLE_STRIP_ADJACENCY_EXT},
  {  "GL_TRUE", DAO_DOUBLE, GL_TRUE},
  {  "GL_UNDEFINED_APPLE", DAO_DOUBLE, GL_UNDEFINED_APPLE},
  {  "GL_UNIFORM_BUFFER_BINDING_EXT", DAO_DOUBLE, GL_UNIFORM_BUFFER_BINDING_EXT},
  {  "GL_UNIFORM_BUFFER_EXT", DAO_DOUBLE, GL_UNIFORM_BUFFER_EXT},
  {  "GL_UNPACK_ALIGNMENT", DAO_DOUBLE, GL_UNPACK_ALIGNMENT},
  {  "GL_UNPACK_CLIENT_STORAGE_APPLE", DAO_DOUBLE, GL_UNPACK_CLIENT_STORAGE_APPLE},
  {  "GL_UNPACK_IMAGE_BYTES_APPLE", DAO_DOUBLE, GL_UNPACK_IMAGE_BYTES_APPLE},
  {  "GL_UNPACK_IMAGE_HEIGHT", DAO_DOUBLE, GL_UNPACK_IMAGE_HEIGHT},
  {  "GL_UNPACK_LSB_FIRST", DAO_DOUBLE, GL_UNPACK_LSB_FIRST},
  {  "GL_UNPACK_ROW_BYTES_APPLE", DAO_DOUBLE, GL_UNPACK_ROW_BYTES_APPLE},
  ...
  {  "GL_UNSIGNED_IDENTITY_NV", DAO_DOUBLE, GL_UNSIGNED_IDENTITY_NV},
  {  "GL_UNSIGNED_INT", DAO_DOUBLE, GL_UNSIGNED_INT},
  {  "GL_UNSIGNED_INT_10_10_10_2", DAO_DOUBLE, GL_UNSIGNED_INT_10_10_10_2},
  {  "GL_UNSIGNED_INT_24_8_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_24_8_EXT},
  ...
  {  "GL_UNSIGNED_INT_8_8_S8_S8_REV_NV", DAO_DOUBLE, GL_UNSIGNED_INT_8_8_S8_S8_REV_NV},
  {  "GL_UNSIGNED_INT_S8_S8_8_8_NV", DAO_DOUBLE, GL_UNSIGNED_INT_S8_S8_8_8_NV},
  {  "GL_UNSIGNED_INT_SAMPLER_1D_ARRAY_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_1D_ARRAY_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_1D_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_1D_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_2D_ARRAY_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_2D_ARRAY_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_2D_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_2D_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_2D_RECT_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_2D_RECT_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_3D_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_3D_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_BUFFER_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_BUFFER_EXT},
  {  "GL_UNSIGNED_INT_SAMPLER_CUBE_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_SAMPLER_CUBE_EXT},
  {  "GL_UNSIGNED_INT_VEC2_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_VEC2_EXT},
  {  "GL_UNSIGNED_INT_VEC3_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_VEC3_EXT},
  {  "GL_UNSIGNED_INT_VEC4_EXT", DAO_DOUBLE, GL_UNSIGNED_INT_VEC4_EXT},
  {  "GL_UNSIGNED_INVERT_NV", DAO_DOUBLE, GL_UNSIGNED_INVERT_NV},
  {  "GL_UNSIGNED_NORMALIZED_ARB", DAO_DOUBLE, GL_UNSIGNED_NORMALIZED_ARB},
  ...
  {  "GL_UNSIGNED_SHORT_8_8_APPLE", DAO_DOUBLE, GL_UNSIGNED_SHORT_8_8_APPLE},
  {  "GL_UNSIGNED_SHORT_8_8_REV_APPLE", DAO_DOUBLE, GL_UNSIGNED_SHORT_8_8_REV_APPLE},
  ...
  {  "GL_VARIABLE_A_NV", DAO_DOUBLE, GL_VARIABLE_A_NV},
  {  "GL_VARIABLE_B_NV", DAO_DOUBLE, GL_VARIABLE_B_NV},
  {  "GL_VARIABLE_C_NV", DAO_DOUBLE, GL_VARIABLE_C_NV},
  {  "GL_VARIABLE_D_NV", DAO_DOUBLE, GL_VARIABLE_D_NV},
  {  "GL_VARIABLE_E_NV", DAO_DOUBLE, GL_VARIABLE_E_NV},
  {  "GL_VARIABLE_F_NV", DAO_DOUBLE, GL_VARIABLE_F_NV},
  {  "GL_VARIABLE_G_NV", DAO_DOUBLE, GL_VARIABLE_G_NV},
  ...
  {  "GL_VERTEX_ARRAY_BINDING_APPLE", DAO_DOUBLE, GL_VERTEX_ARRAY_BINDING_APPLE},
  {  "GL_VERTEX_ARRAY_BUFFER_BINDING", DAO_DOUBLE, GL_VERTEX_ARRAY_BUFFER_BINDING},
  {  "GL_VERTEX_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_VERTEX_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_VERTEX_ARRAY_POINTER", DAO_DOUBLE, GL_VERTEX_ARRAY_POINTER},
  {  "GL_VERTEX_ARRAY_RANGE_APPLE", DAO_DOUBLE, GL_VERTEX_ARRAY_RANGE_APPLE},
  {  "GL_VERTEX_ARRAY_RANGE_LENGTH_APPLE", DAO_DOUBLE, GL_VERTEX_ARRAY_RANGE_LENGTH_APPLE},
  {  "GL_VERTEX_ARRAY_RANGE_POINTER_APPLE", DAO_DOUBLE, GL_VERTEX_ARRAY_RANGE_POINTER_APPLE},
  {  "GL_VERTEX_ARRAY_SIZE", DAO_DOUBLE, GL_VERTEX_ARRAY_SIZE},
  {  "GL_VERTEX_ARRAY_STORAGE_HINT_APPLE", DAO_DOUBLE, GL_VERTEX_ARRAY_STORAGE_HINT_APPLE},
  ...
  {  "GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_VERTEX_ATTRIB_ARRAY_ENABLED", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_ENABLED},
  {  "GL_VERTEX_ATTRIB_ARRAY_ENABLED_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_ENABLED_ARB},
  {  "GL_VERTEX_ATTRIB_ARRAY_INTEGER_EXT", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_INTEGER_EXT},
  {  "GL_VERTEX_ATTRIB_ARRAY_NORMALIZED", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED},
  {  "GL_VERTEX_ATTRIB_ARRAY_NORMALIZED_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED_ARB},
  {  "GL_VERTEX_ATTRIB_ARRAY_POINTER", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_POINTER},
  {  "GL_VERTEX_ATTRIB_ARRAY_POINTER_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_POINTER_ARB},
  {  "GL_VERTEX_ATTRIB_ARRAY_SIZE", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_SIZE},
  {  "GL_VERTEX_ATTRIB_ARRAY_SIZE_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_SIZE_ARB},
  {  "GL_VERTEX_ATTRIB_ARRAY_STRIDE", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_STRIDE},
  {  "GL_VERTEX_ATTRIB_ARRAY_STRIDE_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_STRIDE_ARB},
  {  "GL_VERTEX_ATTRIB_ARRAY_TYPE", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_TYPE},
  {  "GL_VERTEX_ATTRIB_ARRAY_TYPE_ARB", DAO_DOUBLE, GL_VERTEX_ATTRIB_ARRAY_TYPE_ARB},
  {  "GL_VERTEX_ATTRIB_MAP1_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP1_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP1_COEFF_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP1_COEFF_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP1_DOMAIN_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP1_DOMAIN_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP1_ORDER_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP1_ORDER_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP1_SIZE_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP1_SIZE_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP2_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP2_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP2_COEFF_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP2_COEFF_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP2_DOMAIN_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP2_DOMAIN_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP2_ORDER_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP2_ORDER_APPLE},
  {  "GL_VERTEX_ATTRIB_MAP2_SIZE_APPLE", DAO_DOUBLE, GL_VERTEX_ATTRIB_MAP2_SIZE_APPLE},
  {  "GL_VERTEX_BLEND_ARB", DAO_DOUBLE, GL_VERTEX_BLEND_ARB},
  {  "GL_VERTEX_PROGRAM_ARB", DAO_DOUBLE, GL_VERTEX_PROGRAM_ARB},
  {  "GL_VERTEX_PROGRAM_POINT_SIZE", DAO_DOUBLE, GL_VERTEX_PROGRAM_POINT_SIZE},
  {  "GL_VERTEX_PROGRAM_POINT_SIZE_ARB", DAO_DOUBLE, GL_VERTEX_PROGRAM_POINT_SIZE_ARB},
  {  "GL_VERTEX_PROGRAM_TWO_SIDE", DAO_DOUBLE, GL_VERTEX_PROGRAM_TWO_SIDE},
  {  "GL_VERTEX_PROGRAM_TWO_SIDE_ARB", DAO_DOUBLE, GL_VERTEX_PROGRAM_TWO_SIDE_ARB},
  {  "GL_VERTEX_SHADER", DAO_DOUBLE, GL_VERTEX_SHADER},
  {  "GL_VERTEX_SHADER_ARB", DAO_DOUBLE, GL_VERTEX_SHADER_ARB},
  {  "GL_VIBRANCE_BIAS_NV", DAO_DOUBLE, GL_VIBRANCE_BIAS_NV},
  {  "GL_VIBRANCE_SCALE_NV", DAO_DOUBLE, GL_VIBRANCE_SCALE_NV},
  {  "GL_VIEWPORT", DAO_DOUBLE, GL_VIEWPORT},
  {  "GL_VIEWPORT_BIT", DAO_DOUBLE, GL_VIEWPORT_BIT},
  {  "GL_VOLATILE_APPLE", DAO_DOUBLE, GL_VOLATILE_APPLE},
  {  "GL_WEIGHT_ARRAY_ARB", DAO_DOUBLE, GL_WEIGHT_ARRAY_ARB},
  {  "GL_WEIGHT_ARRAY_BUFFER_BINDING", DAO_DOUBLE, GL_WEIGHT_ARRAY_BUFFER_BINDING},
  {  "GL_WEIGHT_ARRAY_BUFFER_BINDING_ARB", DAO_DOUBLE, GL_WEIGHT_ARRAY_BUFFER_BINDING_ARB},
  {  "GL_WEIGHT_ARRAY_POINTER_ARB", DAO_DOUBLE, GL_WEIGHT_ARRAY_POINTER_ARB},
  {  "GL_WEIGHT_ARRAY_SIZE_ARB", DAO_DOUBLE, GL_WEIGHT_ARRAY_SIZE_ARB},
  {  "GL_WEIGHT_ARRAY_STRIDE_ARB", DAO_DOUBLE, GL_WEIGHT_ARRAY_STRIDE_ARB},
  {  "GL_WEIGHT_ARRAY_TYPE_ARB", DAO_DOUBLE, GL_WEIGHT_ARRAY_TYPE_ARB},
  {  "GL_WEIGHT_SUM_UNITY_ARB", DAO_DOUBLE, GL_WEIGHT_SUM_UNITY_ARB},
  {  "GL_WRITE_ONLY", DAO_DOUBLE, GL_WRITE_ONLY},
  {  "GL_WRITE_ONLY_ARB", DAO_DOUBLE, GL_WRITE_ONLY_ARB},
  {  "GL_XOR", DAO_DOUBLE, GL_XOR},
  {  "GL_YCBCR_422_APPLE", DAO_DOUBLE, GL_YCBCR_422_APPLE},
